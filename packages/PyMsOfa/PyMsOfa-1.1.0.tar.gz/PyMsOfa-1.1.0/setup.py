...
(1) *PyMsOfa_ctypes* : a python wrapper package based on a foreign function library for Python , 

(2) *PyMsOfa_cffi* : a python wrapper package with the foreign function interface for Python calling C code ,

(3) *PyMsOfa_python* : a python package directly written in pure python codes from SOFA subroutines. 

*Attition* : In Microsoft windouws, the *PyMsOfa_ctypes* module and the *PyMsOfa_cffi* module can't be used after installing them in pypi, but they can be installed and used by `github <https://github.com/CHES2023/PyMsOfa>`_.  
