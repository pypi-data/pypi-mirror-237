...
_sofalib_filename = _glob.glob(str(_pathlib.Path(__file__).parent)+'/libsofa*')
if len(_sofalib_filename) == 0:
    raise ImportError('Unable to find the shared C library "libsofa_c".')
    
lib=ffi.dlopen(_sofalib_filename[0])
