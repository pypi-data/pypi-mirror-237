...
class BuildSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["git_model_source", b"git_model_source", "resource", b"resource"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["assumed_iam_role", b"assumed_iam_role", "base_image", b"base_image", "dependency_file_path", b"dependency_file_path", "env_vars", b"env_vars", "git_model_source", b"git_model_source", "main_dir", b"main_dir", "parameters", b"parameters", "resource", b"resource", "tags", b"tags"]) -> None: ...
...
class GitModelSource(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["git_branch", b"git_branch", "git_credentials_secret_name", b"git_credentials_secret_name", "git_uri", b"git_uri"]) -> None: ...
