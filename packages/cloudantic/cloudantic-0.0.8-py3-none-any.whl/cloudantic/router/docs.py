"""Automatically generate OpenAPI documentation for your Cloudantic API."""
...
from ..schema.json import parse_json_hook as parse_json
...
def html_string(base_url: str):
    ...
    return f"""<!DOCTYPE html>
            ...
            <head>
                <meta charset="UTF-8">
                <title>Cloudantic</title>
                <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/swagger-ui-dist@5/swagger-ui.css" >
                <link rel="icon" type="image/png" href="https://obahamonde.netlify.app/logo.png" sizes="32x32" />
                <style>
                .swagger-ui .topbar {{
                    display: none;
                }}
