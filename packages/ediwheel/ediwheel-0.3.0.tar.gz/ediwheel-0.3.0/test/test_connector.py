...
conti = EdiConnectorConfig( # job aborted
...
class TestConnector(unittest.TestCase):
    ...
    def test_michelin(self):
        ...
        res = connector.enquiry("", "")

        print(res)

    def test_conti(self):
        connector = EdiConnector(conti)
        print("Testing continental")
        res = connector.enquiry("4019238030891", "3110000000")
    ...
    def test_conti_batch(self):
        print("Testing continental batch")
        connector = EdiConnector(conti)
        eans = ["4019238030891", "4019238030891"]
        sup_codes = ["3110000000", "3110000000"]
        lg = self.Logger()
        connector.batch_inquiry(eans, sup_codes, debug=True, debug_logger=lg)