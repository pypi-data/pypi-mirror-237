...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, hidden=False, base_url=None, pulp_labels=None, pulp_href=None, pulp_created=None, name=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
