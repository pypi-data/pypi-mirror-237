...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, pulp_created=None, base_path=None, name=None, pulp_href=None, content_guard=None, hidden=False, base_url=None, local_vars_configuration=None):  # noqa: E501
