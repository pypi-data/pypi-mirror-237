...
class analyzer(QWidget):
    ...
    def __init__(self, centralwidget, gridLayout_centralwidget, displaygui=None):
...
#         self.SpotareaminLbl.setGeometry(QtCore.QRect(3, 35, 80, 20))
...
#         self.SpotareamaxLbl.setGeometry(QtCore.QRect(3, 35, 80, 20))
...
#         self.SpotIntegratedIntensitySliderValue = QtWidgets.QLabel(self.SpotAnalysis)
# #         self.NucFirstThreshSliderValue.setGeometry(QtCore.QRect(10, 60, 61, 31))
#         self.gridLayout_SpotAnalysis.addWidget(self.SpotIntegratedIntensitySliderValue, 7, 1, 1, 1)
#         font = QtGui.QFont()
#         font.setPointSize(12)
#         self.SpotIntegratedIntensitySliderValue.setFont(font)
#         self.SpotIntegratedIntensitySliderValue.setObjectName("SpotThreshSliderValue")
#         self.SpotIntegratedIntensitySliderValue.setText(QtCore.QCoreApplication.translate("MainWindow", str(self.SpotIntegratedIntensitySliderValue.value()))) 
