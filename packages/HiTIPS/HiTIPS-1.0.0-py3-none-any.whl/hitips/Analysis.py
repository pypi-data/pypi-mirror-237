...
#                 print(props_df)
    ...
    def INITIALIZE_SPOT_ANALYSIS_PARAMS(self):
        ...
        self.spot_params_dict={
            ...
            "Ch1": np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
            ...
            "Ch2": np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                             self.AnalysisGui.thresholdmethod.currentIndex(),
                             self.AnalysisGui.ThresholdSlider.value(), 
                             self.AnalysisGui.SensitivitySpinBox.value(),
                             self.AnalysisGui.SpotPerChSpinBox.value(),
            ...
            "Ch3": np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                             self.AnalysisGui.thresholdmethod.currentIndex(),
                             self.AnalysisGui.ThresholdSlider.value(), 
                             self.AnalysisGui.SensitivitySpinBox.value(),
                             self.AnalysisGui.SpotPerChSpinBox.value(),
            ...
            "Ch4": np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                             self.AnalysisGui.thresholdmethod.currentIndex(),
                             self.AnalysisGui.ThresholdSlider.value(), 
                             self.AnalysisGui.SensitivitySpinBox.value(),
                             self.AnalysisGui.SpotPerChSpinBox.value(),
            ...
            "Ch5": np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                             self.AnalysisGui.thresholdmethod.currentIndex(),
                             self.AnalysisGui.ThresholdSlider.value(), 
                             self.AnalysisGui.SensitivitySpinBox.value(),
                             self.AnalysisGui.SpotPerChSpinBox.value(),
    ...
    def UPDATE_SPOT_ANALYSIS_PARAMS(self):
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch1':
            ...
            self.spot_params_dict["Ch1"] =    np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                                                        self.AnalysisGui.thresholdmethod.currentIndex(),
                                                        self.AnalysisGui.ThresholdSlider.value(), 
                                                        self.AnalysisGui.SensitivitySpinBox.value(),
                                                        self.AnalysisGui.SpotPerChSpinBox.value(),
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch2':
            ...
            self.spot_params_dict["Ch2"] =    np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                                                        self.AnalysisGui.thresholdmethod.currentIndex(),
                                                        self.AnalysisGui.ThresholdSlider.value(), 
                                                        self.AnalysisGui.SensitivitySpinBox.value(),
                                                        self.AnalysisGui.SpotPerChSpinBox.value(),
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch3':
            ...
            self.spot_params_dict["Ch3"] =    np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                                                        self.AnalysisGui.thresholdmethod.currentIndex(),
                                                        self.AnalysisGui.ThresholdSlider.value(), 
                                                        self.AnalysisGui.SensitivitySpinBox.value(),
                                                        self.AnalysisGui.SpotPerChSpinBox.value(),
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch4':
            ...
            self.spot_params_dict["Ch4"] =    np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                                                        self.AnalysisGui.thresholdmethod.currentIndex(),
                                                        self.AnalysisGui.ThresholdSlider.value(), 
                                                        self.AnalysisGui.SensitivitySpinBox.value(),
                                                        self.AnalysisGui.SpotPerChSpinBox.value(),
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch5':
            ...
            self.spot_params_dict["Ch5"] =    np.array([self.AnalysisGui.spotanalysismethod.currentIndex(),
                                                        self.AnalysisGui.thresholdmethod.currentIndex(),
                                                        self.AnalysisGui.ThresholdSlider.value(), 
                                                        self.AnalysisGui.SensitivitySpinBox.value(),
                                                        self.AnalysisGui.SpotPerChSpinBox.value(),
    ...
    def UPDATE_SPOT_ANALYSIS_GUI_PARAMS(self):
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch1':
            ...
            self.AnalysisGui.SpotareaminSpinBox.setValue(np.array(self.spot_params_dict["Ch1"][5]).astype(int))
            self.AnalysisGui.SpotareamaxSpinBox.setValue(np.array(self.spot_params_dict["Ch1"][6]).astype(int))
            self.AnalysisGui.SpotIntegratedIntensitySpinBox.setValue(np.array(self.spot_params_dict["Ch1"][7]).astype(int))
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch2':
            ...
            self.AnalysisGui.SpotareaminSpinBox.setValue(np.array(self.spot_params_dict["Ch2"][5]).astype(int))
            self.AnalysisGui.SpotareamaxSpinBox.setValue(np.array(self.spot_params_dict["Ch2"][6]).astype(int))
            self.AnalysisGui.SpotIntegratedIntensitySpinBox.setValue(np.array(self.spot_params_dict["Ch2"][7]).astype(int))
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch3':
            ...
            self.AnalysisGui.SpotareaminSpinBox.setValue(np.array(self.spot_params_dict["Ch3"][5]).astype(int))
            self.AnalysisGui.SpotareamaxSpinBox.setValue(np.array(self.spot_params_dict["Ch3"][6]).astype(int))
            self.AnalysisGui.SpotIntegratedIntensitySpinBox.setValue(np.array(self.spot_params_dict["Ch3"][7]).astype(int))
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch4':
            ...
            self.AnalysisGui.SpotareaminSpinBox.setValue(np.array(self.spot_params_dict["Ch4"][5]).astype(int))
            self.AnalysisGui.SpotareamaxSpinBox.setValue(np.array(self.spot_params_dict["Ch4"][6]).astype(int))
            self.AnalysisGui.SpotIntegratedIntensitySpinBox.setValue(np.array(self.spot_params_dict["Ch4"][7]).astype(int))
        ...
        if self.AnalysisGui.spotchannelselect.currentText()=='Ch5':
            ...
            self.AnalysisGui.SpotareaminSpinBox.setValue(np.array(self.spot_params_dict["Ch5"][5]).astype(int))
            self.AnalysisGui.SpotareamaxSpinBox.setValue(np.array(self.spot_params_dict["Ch5"][6]).astype(int))
            self.AnalysisGui.SpotIntegratedIntensitySpinBox.setValue(np.array(self.spot_params_dict["Ch5"][7]).astype(int))