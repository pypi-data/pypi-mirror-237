...
setup(
    ...
    package_dir={'': 'src'},
    packages=['openi','openi.dataset','openi.model','openi.services','openi.cloudbrain','openi.cloudbrain.path','openi.cloudbrain.minio','openi.cloudbrain.obs','openi.cloudbrain.download','openi.cloudbrain.upload','openi.utils','openi.context'],
