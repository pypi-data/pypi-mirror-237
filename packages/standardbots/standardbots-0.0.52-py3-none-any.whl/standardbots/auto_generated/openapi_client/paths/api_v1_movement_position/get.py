...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = CombinedArmPosition
...
class GetArmPosition(BaseApi):
    ...
    def get_arm_position(
        ...
        return self._get_arm_position_oapg(
