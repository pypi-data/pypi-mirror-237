...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = MoveRequest


request_body_move_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = MoveRobotEvent
SchemaFor200ResponseBodyApplicationXNdjson = schemas.AnyTypeSchema
...
class BaseApi(api_client.Api):
    ...
    def _set_arm_position_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_move_request.serialize(body, content_type)
...
class SetArmPosition(BaseApi):
    ...
    def set_arm_position(
        ...
        return self._set_arm_position_oapg(
            body=body,
