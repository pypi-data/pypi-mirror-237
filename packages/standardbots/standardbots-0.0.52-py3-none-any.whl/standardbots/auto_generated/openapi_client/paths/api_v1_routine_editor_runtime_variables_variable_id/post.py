...
# Path params
VariableIdSchema = schemas.AnyTypeSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'variableId': typing.Union[VariableIdSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = RuntimeVariable


request_body_runtime_variable = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = RuntimeVariable
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_runtime_variable_oapg(
        self,
    ...
    def _update_runtime_variable_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_runtime_variable.serialize(body, content_type)
...
class UpdateRuntimeVariable(BaseApi):
    ...
    def update_runtime_variable(
        ...
        return self._update_runtime_variable_oapg(
            body=body,
