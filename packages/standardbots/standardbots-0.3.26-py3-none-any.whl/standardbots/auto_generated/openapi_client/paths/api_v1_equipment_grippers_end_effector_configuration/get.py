...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = GripperConfiguration
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_configuration_gripper_oapg(
        self,
...
class GetConfigurationGripper(BaseApi):
    ...
    def get_configuration_gripper(
        ...
        return self._get_configuration_gripper_oapg(
