...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = RobotControlMode


request_body_robot_control_mode = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = RobotControlMode
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_configuration_control_state_oapg(
        self,
    ...
    def _set_configuration_control_state_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_robot_control_mode.serialize(body, content_type)
...
class SetConfigurationControlState(BaseApi):
    ...
    def set_configuration_control_state(
        ...
        return self._set_configuration_control_state_oapg(
            body=body,
