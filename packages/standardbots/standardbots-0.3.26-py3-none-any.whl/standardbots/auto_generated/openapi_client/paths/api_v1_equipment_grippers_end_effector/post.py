...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = GripperCommandRequest


request_body_gripper_command_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _control_gripper_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_gripper_command_request.serialize(body, content_type)
...
class ControlGripper(BaseApi):
    ...
    def control_gripper(
        ...
        return self._control_gripper_oapg(
            body=body,
