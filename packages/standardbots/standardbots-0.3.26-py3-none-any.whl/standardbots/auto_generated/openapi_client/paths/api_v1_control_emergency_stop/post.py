...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = EngageEmergencyStopRequest


request_body_engage_emergency_stop_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _engage_emergency_stop_oapg(
        self,
    ...
    def _engage_emergency_stop_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_engage_emergency_stop_request.serialize(body, content_type)
...
class EngageEmergencyStop(BaseApi):
    ...
    def engage_emergency_stop(
        ...
        return self._engage_emergency_stop_oapg(
            body=body,
