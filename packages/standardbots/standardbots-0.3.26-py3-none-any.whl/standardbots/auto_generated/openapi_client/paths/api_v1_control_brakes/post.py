...
# body param
SchemaForRequestBodyApplicationJsonCharsetutf8 = SetBrakeStateRequest


request_body_set_brake_state_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = BrakesState
...
class BaseApi(api_client.Api):
    ...
    def _set_brakes_state_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_set_brake_state_request.serialize(body, content_type)
...
class SetBrakesState(BaseApi):
    ...
    def set_brakes_state(
        ...
        return self._set_brakes_state_oapg(
            body=body,
