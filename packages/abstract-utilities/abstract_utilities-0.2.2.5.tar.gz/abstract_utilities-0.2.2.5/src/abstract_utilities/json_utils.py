...
def unified_json_loader(file_path, default_value=None, encoding='utf-8'):
    ...
    with open(file_path, 'r', encoding=encoding) as file:
        content = all_try(data=file, function=safe_json_load, error_value=json.JSONDecodeError, error=False)
    ...
    with open(file_path, 'r', encoding=encoding) as file:
        ...
        content = all_try(data=content_str, function=safe_json_loads, error_value=json.JSONDecodeError, error=False)
