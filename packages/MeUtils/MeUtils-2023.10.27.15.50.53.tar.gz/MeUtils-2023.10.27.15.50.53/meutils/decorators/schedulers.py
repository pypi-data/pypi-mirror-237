...
@decorator
def scheduled_job(func, trigger='interval', trigger_kwargs: Optional[Dict[str, Any]] = None, *args, **kwargs):
    trigger_kwargs = trigger_kwargs or {}

    from apscheduler.schedulers.asyncio import AsyncIOScheduler as Scheduler
    # from apscheduler.schedulers.asyncio import BackgroundScheduler as Scheduler
