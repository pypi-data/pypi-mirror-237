...
AGGREGATION_PLANS = {
    ...
    afpb.AGGREGATION_FUNCTION_FIRST_DISTINCT_N: lambda time_key, params: AggregationPlan(
        partial_aggregation_query_terms=lambda col: [
    ...
    afpb.AGGREGATION_FUNCTION_LAST_DISTINCT_N: lambda time_key, params: AggregationPlan(
        partial_aggregation_query_terms=lambda col: [
    ...
    afpb.AGGREGATION_FUNCTION_APPROX_COUNT_DISTINCT: lambda time_key, params: AggregationPlan(
        partial_aggregation_query_terms=lambda col: [
