...
class ApiClient:
    ...
    def _get_api_endpoint(self) -> str:
        ...
        def _walrus_wrapper_api_endpoint_d761f8678500450b94856e451a4019c8(expr):
            """Wrapper function for assignment expression."""
            nonlocal api_endpoint
            api_endpoint = expr
            return api_endpoint

        if (_walrus_wrapper_api_endpoint_d761f8678500450b94856e451a4019c8(get_value(OPTION_API_ENDPOINT))):
            return api_endpoint
