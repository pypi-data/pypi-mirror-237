...
def get_config_path(check: bool = False) -> Optional[Path]:
    ...
    def _walrus_wrapper_curr_file_501ce2d0b63d471bba70be8aa9964067(expr):
        """Wrapper function for assignment expression."""
        nonlocal curr_file
        curr_file = expr
        return curr_file

    if (_walrus_wrapper_curr_file_501ce2d0b63d471bba70be8aa9964067(curr_dir / CFG_DIR / CFG_FILE)).is_file():
        return curr_file
    ...
    with contextlib.suppress(RuntimeError):
        ...
        def _walrus_wrapper_curr_file_0209b5252d9940a689e5562dfd494a60(expr):
            """Wrapper function for assignment expression."""
            nonlocal curr_file
            curr_file = expr
            return curr_file

        if (_walrus_wrapper_curr_file_0209b5252d9940a689e5562dfd494a60(Path.home() / CFG_DIR / CFG_FILE)).is_file():
            return curr_file
    ...
    for _dir in curr_dir.parents:
        ...
        def _walrus_wrapper_curr_file_081c2318da234d289121546a1709ee3d(expr):
            """Wrapper function for assignment expression."""
            nonlocal curr_file
            curr_file = expr
            return curr_file

        if (_walrus_wrapper_curr_file_081c2318da234d289121546a1709ee3d(_dir / CFG_DIR / CFG_FILE)).is_file():
            return curr_file
