...
class OpenapiFormats(SyncAPIResource):
    with_raw_response: OpenapiFormatsWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = OpenapiFormatsWithRawResponse(self)
...
class AsyncOpenapiFormats(AsyncAPIResource):
    with_raw_response: AsyncOpenapiFormatsWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncOpenapiFormatsWithRawResponse(self)
...
class OpenapiFormatsWithRawResponse:
    def __init__(self, openapi_formats: OpenapiFormats) -> None:
...
class AsyncOpenapiFormatsWithRawResponse:
    def __init__(self, openapi_formats: AsyncOpenapiFormats) -> None:
