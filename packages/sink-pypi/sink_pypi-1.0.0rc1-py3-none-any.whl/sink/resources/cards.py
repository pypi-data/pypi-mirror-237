...
from ..pagination import SyncCardPage, AsyncCardPage
...
class Cards(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          not: Used to test the PythonSDKs ability to handle reserved keywords as parameters
    ...
    @typing_extensions.deprecated(
        "This method will be removed in the next release. Please use `client.get_auth_url()` instead."
    )
    def deprecated_get_auth_url(
        self,
        *,
        print_data: bool,
        redirect_uri: str,
        ...
        return self._get_api_list(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    card_list_non_get_params.CardListNonGetParams,
                ),
            ),
            model=Card,
            method="post",
    ...
    def reissue(
        ...
        *,
        ...
        Args:
          ...
          shippingAddress: If omitted, the previous shipping address will be used.
...
class AsyncCards(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[Card, AsyncCardPage[Card]]:
        """List cards.
...
class CardsWithRawResponse:
    def __init__(self, cards: Cards) -> None:
        ...
        self.create_aliased = to_raw_response_wrapper(
            cards.create_aliased,
        )
        self.create_aliased_deprecated = to_raw_response_wrapper(  # pyright: ignore[reportDeprecated]
            cards.create_aliased_deprecated  # pyright: ignore[reportDeprecated],
        )
        self.deprecated_all_but_go_diff_message = to_raw_response_wrapper(  # pyright: ignore[reportDeprecated]
            cards.deprecated_all_but_go_diff_message  # pyright: ignore[reportDeprecated],
        )
        self.deprecated_all_diff_message = to_raw_response_wrapper(  # pyright: ignore[reportDeprecated]
            cards.deprecated_all_diff_message  # pyright: ignore[reportDeprecated],
        )
        self.deprecated_method = to_raw_response_wrapper(  # pyright: ignore[reportDeprecated]
            cards.deprecated_method  # pyright: ignore[reportDeprecated],
        )
        self.deprecated_only_go = to_raw_response_wrapper(
            cards.deprecated_only_go,
        )
        self.list_non_get = to_raw_response_wrapper(
            cards.list_non_get,
        )
        self.list_not_paginated = to_raw_response_wrapper(
            cards.list_not_paginated,
        )
        self.provision_foo = to_raw_response_wrapper(
            cards.provision_foo,
        )
...
class AsyncCardsWithRawResponse:
    def __init__(self, cards: AsyncCards) -> None:
        ...
        self.create_aliased = async_to_raw_response_wrapper(
            cards.create_aliased,
        )
        self.create_aliased_deprecated = async_to_raw_response_wrapper(  # pyright: ignore[reportDeprecated]
            cards.create_aliased_deprecated  # pyright: ignore[reportDeprecated],
        )
        self.deprecated_all_but_go_diff_message = async_to_raw_response_wrapper(  # pyright: ignore[reportDeprecated]
            cards.deprecated_all_but_go_diff_message  # pyright: ignore[reportDeprecated],
        )
        self.deprecated_all_diff_message = async_to_raw_response_wrapper(  # pyright: ignore[reportDeprecated]
            cards.deprecated_all_diff_message  # pyright: ignore[reportDeprecated],
        )
        self.deprecated_method = async_to_raw_response_wrapper(  # pyright: ignore[reportDeprecated]
            cards.deprecated_method  # pyright: ignore[reportDeprecated],
        )
        self.deprecated_only_go = async_to_raw_response_wrapper(
            cards.deprecated_only_go,
        )
        self.list_non_get = async_to_raw_response_wrapper(
            cards.list_non_get,
        )
        self.list_not_paginated = async_to_raw_response_wrapper(
            cards.list_not_paginated,
        )
        self.provision_foo = async_to_raw_response_wrapper(
            cards.provision_foo,
        )
