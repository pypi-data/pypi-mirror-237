...
class MakeAmbiguousSchemasLooser(SyncAPIResource):
    with_raw_response: MakeAmbiguousSchemasLooserWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = MakeAmbiguousSchemasLooserWithRawResponse(self)
...
class AsyncMakeAmbiguousSchemasLooser(AsyncAPIResource):
    with_raw_response: AsyncMakeAmbiguousSchemasLooserWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncMakeAmbiguousSchemasLooserWithRawResponse(self)
