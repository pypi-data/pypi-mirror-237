...
__all__ = ["PositionalParams", "AsyncPositionalParams"]


class PositionalParams(SyncAPIResource):
    with_raw_response: PositionalParamsWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = PositionalParamsWithRawResponse(self)
    ...
    def kitchen_sink(
        ...
        *,
        ...
        option1: bool,
        camel_case: str,
        option2: str | NotGiven = NOT_GIVEN,
        really_cool_snake: str | NotGiven = NOT_GIVEN,
        bar: float | NotGiven = NOT_GIVEN,
        options: str | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
...
class AsyncPositionalParams(AsyncAPIResource):
    with_raw_response: AsyncPositionalParamsWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncPositionalParamsWithRawResponse(self)
...
class PositionalParamsWithRawResponse:
    def __init__(self, positional_params: PositionalParams) -> None:
        self.basic_body = to_raw_response_wrapper(
            positional_params.basic_body,
        )
        self.basic_query = to_raw_response_wrapper(
            positional_params.basic_query,
        )
        self.body = to_raw_response_wrapper(
            positional_params.body,
        )
        self.body_extra_param = to_raw_response_wrapper(
            positional_params.body_extra_param,
        )
        self.kitchen_sink = to_raw_response_wrapper(
            positional_params.kitchen_sink,
        )
        self.multiple_path_params = to_raw_response_wrapper(
            positional_params.multiple_path_params,
        )
        self.query = to_raw_response_wrapper(
            positional_params.query,
        )
        self.query_and_path = to_raw_response_wrapper(
            positional_params.query_and_path,
        )
        self.query_multiple = to_raw_response_wrapper(
            positional_params.query_multiple,
        )
        self.single = to_raw_response_wrapper(
            positional_params.single,
        )
        self.union_body_and_path = to_raw_response_wrapper(
            positional_params.union_body_and_path,
        )


class AsyncPositionalParamsWithRawResponse:
    def __init__(self, positional_params: AsyncPositionalParams) -> None:
        self.basic_body = async_to_raw_response_wrapper(
            positional_params.basic_body,
        )
        self.basic_query = async_to_raw_response_wrapper(
            positional_params.basic_query,
        )
        self.body = async_to_raw_response_wrapper(
            positional_params.body,
        )
        self.body_extra_param = async_to_raw_response_wrapper(
            positional_params.body_extra_param,
        )
        self.kitchen_sink = async_to_raw_response_wrapper(
            positional_params.kitchen_sink,
        )
        self.multiple_path_params = async_to_raw_response_wrapper(
            positional_params.multiple_path_params,
        )
        self.query = async_to_raw_response_wrapper(
            positional_params.query,
        )
        self.query_and_path = async_to_raw_response_wrapper(
            positional_params.query_and_path,
        )
        self.query_multiple = async_to_raw_response_wrapper(
            positional_params.query_multiple,
        )
        self.single = async_to_raw_response_wrapper(
            positional_params.single,
        )
        self.union_body_and_path = async_to_raw_response_wrapper(
            positional_params.union_body_and_path,
        )
