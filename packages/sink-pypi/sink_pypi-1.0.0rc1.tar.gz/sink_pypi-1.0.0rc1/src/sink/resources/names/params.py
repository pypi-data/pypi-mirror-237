...
__all__ = ["Params", "AsyncParams"]


class Params(SyncAPIResource):
    with_raw_response: ParamsWithRawResponse

    def __init__(self, client: Sink) -> None:
        super().__init__(client)
        self.with_raw_response = ParamsWithRawResponse(self)
    ...
    def timeout_param(
        ...
        *,
        ...
        Args:
          timeout: my timeout request parameter
...
class AsyncParams(AsyncAPIResource):
    with_raw_response: AsyncParamsWithRawResponse

    def __init__(self, client: AsyncSink) -> None:
        super().__init__(client)
        self.with_raw_response = AsyncParamsWithRawResponse(self)
...
class AsyncParamsWithRawResponse:
    def __init__(self, params: AsyncParams) -> None:
