...
__all__ = ["CardCreateAliasedDeprecatedParams"]


class CardCreateAliasedDeprecatedParams(TypedDict, total=False):
    ...
    shipping_address: Annotated[shared_params.ShippingAddress, PropertyInfo(alias="shippingAddress")]
