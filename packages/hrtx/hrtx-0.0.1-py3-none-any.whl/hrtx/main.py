...
class RTX1(nn.Module):
    ...
    def __init__(
        ...
        self.dynamic_input_channels = DynamicInputChannels(num_robots, 2 * dim, dim)
        self.output_decoders = OutputDecoders(num_robots, dim, dim)
...
if __name__ == "__main__":
    ...
    instructions = torch.randn(2, 128)
    logits = model(video, instructions)
    print(logits.shape)
