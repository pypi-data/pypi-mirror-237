...
class StableDiffusionXL(Engine):
    ...
    def transform(self, **params):
        return super()._apost(url=f"{self.base}/sdxl/transform", body=params, api_key=self.api_key)

    def inpainting(self, **params):
        return super()._apost(url=f"{self.base}/sdxl/inpainting", body=params, api_key=self.api_key)
