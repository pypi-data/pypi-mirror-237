...
class IdentityVerification:
    ...
    def common_dates(self, extract_no_space):
        dob = ''
        expiry_date = ''
        try:
    ...
    def dob(self, extract):
        extract_no_space = extract.replace(' ','')
        dob, expiry_date = common_dates(extract_no_space)
        if dob == '':  
