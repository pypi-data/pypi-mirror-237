...
class Clickup(BaseService):
    def __init__(self) -> None:
        self.clickup_api_key = getattr(settings, "CLICKUP_PERSONAL_API_KEY", None)
        self.shops_list_id = getattr(settings, "CLICKUP_SHOPS_LIST_ID", None)
        self.app_shops_list_id = getattr(settings, "CLICKUP_APP_SHOPS_LIST_ID", None)
        self.contacts_list_id = getattr(settings, "CLICKUP_CONTACTS_LIST_ID", None)
