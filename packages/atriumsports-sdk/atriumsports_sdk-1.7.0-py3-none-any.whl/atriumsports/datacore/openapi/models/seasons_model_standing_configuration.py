...
class SeasonsModelStandingConfiguration(BaseModel):
    """
    The ~standingConfiguration~ that this season belongs to  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonsModelStandingConfiguration:
        """Create an instance of SeasonsModelStandingConfiguration from a JSON string"""
