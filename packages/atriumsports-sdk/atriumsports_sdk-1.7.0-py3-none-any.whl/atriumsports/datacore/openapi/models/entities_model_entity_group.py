...
class EntitiesModelEntityGroup(BaseModel):
    """
    The entity group that this entity belongs to  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntitiesModelEntityGroup:
        """Create an instance of EntitiesModelEntityGroup from a JSON string"""
