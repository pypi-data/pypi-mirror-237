...
foreach(_cmake_expected_target IN ITEMS mindquantum::C_mindquantum mindquantum::CXX_mindquantum mindquantum::CUDA_mindquantum mindquantum::libm mindquantum::intrin_flag_C mindquantum::intrin_flag_CXX mindquantum::cxx20_compat mindquantum::cuda20_compat mindquantum::cmake_config mindquantum::mindquantum_setup mindquantum::mq_base mindquantum::include_lib mindquantum::mqsim_common mindquantum::mqsim_vector_cpu mindquantum::mqrt mindquantum::mqsim_vector_gpu mindquantum::mqsim_densitymatrix_cpu mindquantum::mq_math mindquantum::mq_python_core mindquantum::mqbackend_python_interface mindquantum::bind_lib mindquantum::mq_python_device mindquantum::_math_python_interface)
...
set_target_properties(mindquantum::C_mindquantum PROPERTIES
  ...
  INTERFACE_LINK_OPTIONS "\$<\$<AND:\$<BOOL:LINKER_STRIP_ALL>,\$<AND:\$<LINK_LANGUAGE:C>,\$<CONFIG:RELEASE>>>:LINKER:--strip-all>;\$<\$<AND:\$<BOOL:LINKER_NOW>,\$<LINK_LANGUAGE:C>>:LINKER:-z,now>;\$<\$<AND:\$<BOOL:LINKER_NOEXECSTACK>,\$<LINK_LANGUAGE:C>>:LINKER:-z,noexecstack>;\$<\$<AND:\$<BOOL:LINKER_RELRO>,\$<LINK_LANGUAGE:C>>:LINKER:-z,relro>;\$<\$<AND:\$<BOOL:ENABLE_SANITIZER_ADDRESS>,\$<AND:\$<LINK_LANGUAGE:C>,\$<CONFIG:SANITIZER>>>:-fsanitize=address>;\$<\$<AND:\$<BOOL:ENABLE_SANITIZER_UNDEFINED>,\$<AND:\$<LINK_LANGUAGE:C>,\$<CONFIG:SANITIZER>>>:-fsanitize=undefined>;\$<\$<AND:\$<BOOL:ENABLE_STACK_PROTECTION>,\$<LINK_LANGUAGE:C>>:-fstack-protector-all>;\$<\$<LINK_LANGUAGE:C>:LINKER:--enable-new-dtags>"
)
...
set_target_properties(mindquantum::CXX_mindquantum PROPERTIES
  ...
  INTERFACE_LINK_OPTIONS "\$<\$<AND:\$<BOOL:LINKER_STRIP_ALL>,\$<AND:\$<LINK_LANGUAGE:CXX>,\$<CONFIG:RELEASE>>>:LINKER:--strip-all>;\$<\$<AND:\$<BOOL:LINKER_NOW>,\$<LINK_LANGUAGE:CXX>>:LINKER:-z,now>;\$<\$<AND:\$<BOOL:LINKER_NOEXECSTACK>,\$<LINK_LANGUAGE:CXX>>:LINKER:-z,noexecstack>;\$<\$<AND:\$<BOOL:LINKER_RELRO>,\$<LINK_LANGUAGE:CXX>>:LINKER:-z,relro>;\$<\$<AND:\$<BOOL:ENABLE_SANITIZER_ADDRESS>,\$<AND:\$<LINK_LANGUAGE:CXX>,\$<CONFIG:SANITIZER>>>:-fsanitize=address>;\$<\$<AND:\$<BOOL:ENABLE_SANITIZER_UNDEFINED>,\$<AND:\$<LINK_LANGUAGE:CXX>,\$<CONFIG:SANITIZER>>>:-fsanitize=undefined>;\$<\$<AND:\$<BOOL:ENABLE_STACK_PROTECTION>,\$<LINK_LANGUAGE:CXX>>:-fstack-protector-all>;\$<\$<LINK_LANGUAGE:CXX>:LINKER:--enable-new-dtags>"
)

# Create imported target mindquantum::CUDA_mindquantum
add_library(mindquantum::CUDA_mindquantum INTERFACE IMPORTED)

set_target_properties(mindquantum::CUDA_mindquantum PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<\$<COMPILE_LANGUAGE:CUDA>:\$<\$<BOOL:ON>:MQ_MINDSPORE_CI>;\$<\$<BOOL:ON>:USE_OPENMP>;\$<\$<BOOL:OFF>:USE_PARALLEL_STL>;\$<\$<BOOL:OFF>:MQ_LOG_ACTIVE_LEVEL=SPDLOG_LEVEL_DEBUG>;\$<\$<BOOL:OFF>:MQ_LOG_ACTIVE_LEVEL=SPDLOG_LEVEL_TRACE>;\$<\$<BOOL:OFF>:ENABLE_LOGGING>;\$<\$<AND:\$<BOOL:OFF>,\$<BOOL:1>>:_GLIBCXX_DEBUG>;\$<\$<AND:\$<CONFIG:RELEASE>,\$<COMPILE_LANGUAGE:CXX>>:_FORTIFY_SOURCE=2>>"
  INTERFACE_COMPILE_FEATURES "cuda_std_17"
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CUDA>:--extended-lambda>"
  INTERFACE_LINK_OPTIONS "\$<\$<AND:\$<BOOL:LINKER_STRIP_ALL>,\$<AND:\$<LINK_LANGUAGE:CUDA>,\$<CONFIG:RELEASE>>>:LINKER:--strip-all>;\$<\$<AND:\$<BOOL:LINKER_NOW>,\$<LINK_LANGUAGE:CUDA>>:LINKER:-z,now>;\$<\$<AND:\$<BOOL:LINKER_NOEXECSTACK>,\$<LINK_LANGUAGE:CUDA>>:LINKER:-z,noexecstack>;\$<\$<AND:\$<BOOL:LINKER_RELRO>,\$<LINK_LANGUAGE:CUDA>>:LINKER:-z,relro>;\$<\$<LINK_LANGUAGE:CUDA>:LINKER:--enable-new-dtags>"
)
...
# Create imported target mindquantum::cuda20_compat
add_library(mindquantum::cuda20_compat INTERFACE IMPORTED)
...
set_target_properties(mindquantum::mq_base PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GPUACCELERATED"
  ...
  INTERFACE_LINK_LIBRARIES "OpenMP::OpenMP_CXX;mindquantum::cxx20_compat;mindquantum::cmake_config;mindquantum::mq_math;Eigen3::Eigen;fmt::fmt-header-only;nlohmann_json::nlohmann_json;mindquantum::mindquantum_setup;\$<\$<BOOL:OFF>:mindquantum::spdlog>"
)
...
# Create imported target mindquantum::mqsim_vector_gpu
add_library(mindquantum::mqsim_vector_gpu STATIC IMPORTED)

set_target_properties(mindquantum::mqsim_vector_gpu PROPERTIES
  INTERFACE_LINK_LIBRARIES "mindquantum::mqsim_common;mindquantum::CUDA_mindquantum"
)
