...
set_target_properties(mindquantum::C_mindquantum PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<\$<COMPILE_LANGUAGE:C>:\$<\$<BOOL:ON>:MQ_MINDSPORE_CI>;\$<\$<BOOL:FALSE>:USE_OPENMP>;\$<\$<BOOL:OFF>:USE_PARALLEL_STL>;\$<\$<BOOL:OFF>:MQ_LOG_ACTIVE_LEVEL=SPDLOG_LEVEL_DEBUG>;\$<\$<BOOL:OFF>:MQ_LOG_ACTIVE_LEVEL=SPDLOG_LEVEL_TRACE>;\$<\$<BOOL:OFF>:ENABLE_LOGGING>;\$<\$<AND:\$<BOOL:OFF>,\$<BOOL:>>:_GLIBCXX_DEBUG>;\$<\$<AND:\$<CONFIG:RELEASE>,\$<COMPILE_LANGUAGE:CXX>>:_FORTIFY_SOURCE=2>>"
...
set_target_properties(mindquantum::CXX_mindquantum PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<\$<COMPILE_LANGUAGE:CXX>:\$<\$<BOOL:ON>:MQ_MINDSPORE_CI>;\$<\$<BOOL:FALSE>:USE_OPENMP>;\$<\$<BOOL:OFF>:USE_PARALLEL_STL>;\$<\$<BOOL:OFF>:MQ_LOG_ACTIVE_LEVEL=SPDLOG_LEVEL_DEBUG>;\$<\$<BOOL:OFF>:MQ_LOG_ACTIVE_LEVEL=SPDLOG_LEVEL_TRACE>;\$<\$<BOOL:OFF>:ENABLE_LOGGING>;\$<\$<AND:\$<BOOL:OFF>,\$<BOOL:>>:_GLIBCXX_DEBUG>;\$<\$<AND:\$<CONFIG:RELEASE>,\$<COMPILE_LANGUAGE:CXX>>:_FORTIFY_SOURCE=2>>"
...
set_target_properties(mindquantum::mq_base PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "mindquantum::cxx20_compat;mindquantum::cmake_config;mindquantum::mq_math;Eigen3::Eigen;fmt::fmt-header-only;nlohmann_json::nlohmann_json;mindquantum::mindquantum_setup;\$<\$<BOOL:OFF>:mindquantum::spdlog>"
)
...
set_target_properties(mindquantum::mq_math PROPERTIES
  INTERFACE_LINK_LIBRARIES "mindquantum::include_lib;mindquantum::cmake_config;mindquantum::cxx20_compat;mindquantum::mq_base"
)
