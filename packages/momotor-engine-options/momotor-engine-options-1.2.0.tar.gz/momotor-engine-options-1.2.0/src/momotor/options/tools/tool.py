...
ToolVersions: TypeAlias = typing.Tuple[ToolVersion, ...]
...
class ToolName:
    ...
    @classmethod
    @typing.overload
    def factory(cls: typing.Type[TN], name: "StrPathOrToolName") -> TN:
        ...

    @classmethod
    @typing.overload
    def factory(cls: typing.Type[TN], name: typing.Union[str, ToolVersion],
                *parts: typing.Union[str, ToolVersion]) -> TN:
        ...

    @classmethod
    def factory(cls: typing.Type[TN], name: typing.Union["StrPathOrToolName", ToolVersion],
                *parts: typing.Union[str, ToolVersion]) -> TN:
    ...
    def __pad_versions(self, other: "StrPathOrToolName") -> typing.Tuple[ToolVersions, ToolVersions]:
...
def match_tool_requirements(
        ...
        toolset: "ToolSet"
) -> typing.Dict[str, "StrPathOrToolName"]:
    """
    ...
    """
    matches: typing.Dict[str, "StrPathOrToolName"] = {}
