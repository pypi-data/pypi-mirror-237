    ...
    def vectorize(
        ...
        Args:
            ...
            processing_max_colors (int, optional): The maximum number of colors to use in the output image.
                Defaults to 0.
            output_file_format (str, optional): The file format of the output image.
                Defaults to 'svg'.
            output_svg_version (str, optional): The SVG version of the output image.
                Defaults to 'svg_1_1'.
            output_svg_fixed_size (bool, optional): Whether or not the output SVG should have a fixed size.
                Defaults to False.
            output_svg_adobe_compatibility_mode (bool, optional): Whether or not the output SVG should be in Adobe compatibility mode.
                Defaults to False.
            output_dxf_compatibility_level (str, optional): The DXF compatibility level of the output image.
                Defaults to 'lines_and_arcs'.
            output_bitmap_anti_aliasing_mode (str, optional): The anti-aliasing mode of the output image.
                Defaults to 'anti_aliased'.
            output_draw_style (str, optional): The draw style of the output image.
                Defaults to 'fill_shapes'.
            output_shape_stacking (str, optional): The shape stacking of the output image.
                Defaults to 'cutouts'.
            output_group_by (str, optional): The grouping of the output image.
                Defaults to 'none'.
            output_parameterized_shapes_flatten (bool, optional): Whether or not the output parameterized shapes should be flattened.
                Defaults to False.
            output_curves_allowed_quadratic_bezier (bool, optional): Whether or not quadratic bezier curves are allowed in the output image.
                Defaults to True.
            output_curves_allowed_cubic_bezier (bool, optional): Whether or not cubic bezier curves are allowed in the output image.
                Defaults to True.
            output_curves_allowed_circular_arc (bool, optional): Whether or not circular arcs are allowed in the output image.
                Defaults to True.
            output_curves_allowed_elliptical_arc (bool, optional): Whether or not elliptical arcs are allowed in the output image.
                Defaults to True.
            output_curves_line_fit_tolerance (float, optional): The line fit tolerance of the output image.
                Defaults to 0.1.
            output_gap_filler_enabled (bool, optional): Whether or not the output gap filler is enabled.
                Defaults to True.
            output_gap_filler_clip (bool, optional): Whether or not the output gap filler should clip.
                Defaults to False.
            output_gap_filler_non_scaling_stroke (bool, optional): Whether or not the output gap filler should have a non-scaling stroke.
                Defaults to True.
            output_gap_filler_stroke_width (float, optional): The stroke width of the output gap filler.
                Defaults to 2.0.
            output_strokes_non_scaling_stroke (bool, optional): Whether or not the output strokes should have a non-scaling stroke.
                Defaults to True.
            output_strokes_use_override_color (bool, optional): Whether or not the output strokes should use an override color.
                Defaults to False.
            output_strokes_override_color (str, optional): The override color of the output strokes.
                Defaults to '#000000'.
            output_strokes_stroke_width (float, optional): The stroke width of the output strokes.
                Defaults to 1.0.
            output_size_scale (Union[float, None], optional): The scale of the output image.
                Defaults to None.
            output_size_width (Union[float, None], optional): The width of the output image.
                Defaults to None.
            output_size_height (Union[float, None], optional): The height of the output image.
                Defaults to None.
            output_size_unit (str, optional): The unit of the output image.
                Defaults to 'none'.
            output_size_aspect_ratio (str, optional): The aspect ratio of the output image.
                Defaults to 'preserve_inset'.
            output_size_align_x (float, optional): The x alignment of the output image.
                Defaults to 0.5.
            output_size_align_y (float, optional): The y alignment of the output image.
                Defaults to 0.5.
            output_size_input_dpi (Union[float, None], optional): The input DPI of the output image.
                Defaults to None.
