...
class DatasetsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDatasets = channel.unary_unary(
                ...
                request_serializer=finazon__grpc__python_dot_datasets__pb2.DatasetsRequest.SerializeToString,
                response_deserializer=finazon__grpc__python_dot_datasets__pb2.DatasetsResponse.FromString,
                )
...
def add_DatasetsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetDatasets': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=finazon__grpc__python_dot_datasets__pb2.DatasetsRequest.FromString,
                    response_serializer=finazon__grpc__python_dot_datasets__pb2.DatasetsResponse.SerializeToString,
            ),
    }
...
class DatasetsService(object):
    ...
    def GetDatasets(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/finazon.DatasetsService/GetDatasets',
            finazon__grpc__python_dot_datasets__pb2.DatasetsRequest.SerializeToString,
            finazon__grpc__python_dot_datasets__pb2.DatasetsResponse.FromString,
