...
class SnapshotServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSnapshot = channel.unary_unary(
                ...
                request_serializer=finazon__grpc__python_dot_snapshot__pb2.SnapshotRequest.SerializeToString,
                response_deserializer=finazon__grpc__python_dot_snapshot__pb2.SnapshotResponse.FromString,
                )
...
def add_SnapshotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSnapshot': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=finazon__grpc__python_dot_snapshot__pb2.SnapshotRequest.FromString,
                    response_serializer=finazon__grpc__python_dot_snapshot__pb2.SnapshotResponse.SerializeToString,
            ),
    }
...
class SnapshotService(object):
    ...
    def GetSnapshot(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/finazon.SnapshotService/GetSnapshot',
            finazon__grpc__python_dot_snapshot__pb2.SnapshotRequest.SerializeToString,
            finazon__grpc__python_dot_snapshot__pb2.SnapshotResponse.FromString,
