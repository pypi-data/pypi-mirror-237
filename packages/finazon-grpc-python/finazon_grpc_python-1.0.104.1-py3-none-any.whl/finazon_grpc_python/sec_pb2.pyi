...
class SecFillingsRequest(google.protobuf.message.Message):
...
global___SecFillingsRequest = SecFillingsRequest

@typing_extensions.final
class SecFillingsResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___SecFillingsResponse = SecFillingsResponse
