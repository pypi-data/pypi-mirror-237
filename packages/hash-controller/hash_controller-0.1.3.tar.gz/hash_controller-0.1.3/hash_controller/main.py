...
class HashClient:
    __db_user = os.environ["HASH_DB_USER"]
    __db_password = os.environ["HASH_DB_PASS"]
    __db_host = os.environ["HASH_DB_HOST"]
    __db_port = os.environ["HASH_DB_PORT"]
    __db_name = os.environ["HASH_DB_NAME"]
    __db_collection = os.environ["HASH_DB_COLLECTION"]
