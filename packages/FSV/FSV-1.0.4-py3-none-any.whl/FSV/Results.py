...
def refmols2xyz(mols,name='',list=None):
    ...
    if list != None:
        fragid = [bf.list2str(x) for x in list]
    else:
        fragid = [str(i) for i in range(len(mols))]
...
def confsmols2xyz(confsmols,name='',list=None):
    if list != None:
        ...
        fragid = [str(i) for i in range(len(confsmols[0]))]
