...
TASK_TYPE = {
    "Task000_Example_clf": ProblemType.ORDINAL_MULTI_CLASS_CLASSIFICATION,
    "Task001_Example_reg": ProblemType.REGRESSION,
    "Task002_Example_reg_multi": ProblemType.REGRESSION,
    "Task003_Example_mednli": ProblemType.ORDINAL_MULTI_CLASS_CLASSIFICATION,
    "Task004_Example_ner": ProblemType.NER,
    "Task005_Example_clf_multi": ProblemType.NONORDINAL_MULTI_CLASS_CLASSIFICATION,
    "Task006_Example_clf_binary": ProblemType.BINARY_CLASSIFICATION,
    "Task007_Example_clf_multi_binary": ProblemType.BINARY_CLASSIFICATION,
    "Task100_adhesion_clf": ProblemType.BINARY_CLASSIFICATION,
    "Task101_anonymisation_ner": ProblemType.NER,
    "Task102_colon_pathology_clf": ProblemType.BINARY_CLASSIFICATION,
    "Task103_hip_clf": ProblemType.NONORDINAL_MULTI_CLASS_CLASSIFICATION,
    "Task104_kidney_clf": ProblemType.BINARY_CLASSIFICATION,
    "Task105_medical_terminology_ner": ProblemType.NER,
    "Task110_pathology_tumor_origin_clf": ProblemType.BINARY_CLASSIFICATION,
    "Task111_pathology_tissue_modality_clf": ProblemType.NONORDINAL_MULTI_CLASS_CLASSIFICATION,
    "Task112_pathology_tissue_type_clf": ProblemType.NONORDINAL_MULTI_CLASS_CLASSIFICATION,
    "Task113_prostate_pathology_clf": ProblemType.ORDINAL_MULTI_CLASS_CLASSIFICATION,
    "Task114_prostate_radiology_clf": ProblemType.ORDINAL_MULTI_CLASS_CLASSIFICATION,
    "Task115_prostate_radiology_prostate_volume_reg": ProblemType.REGRESSION,
    "Task116_prostate_radiology_psa_reg": ProblemType.REGRESSION,
    "Task117_prostate_radiology_psad_reg": ProblemType.REGRESSION,
    "Task118_nodules_clf": ProblemType.BINARY_CLASSIFICATION,
    "Task119_nodules_diameter_clf": ProblemType.BINARY_CLASSIFICATION,
    "Task120_nodules_diameter_reg": ProblemType.REGRESSION,
    "Task121_recist_baseline_followup_clf": ProblemType.BINARY_CLASSIFICATION,
    "Task122_recist_lesion_size_clf": ProblemType.BINARY_CLASSIFICATION,
    "Task123_recist_lesion_size_reg": ProblemType.REGRESSION,
    "Task124_textual_entailment_clf": ProblemType.ORDINAL_MULTI_CLASS_CLASSIFICATION,
}
...
class DragonEval(ClassificationEvaluation):
    ...
    def load(self, *, task_name: str, job_name: str):
        ...
        self._predictions_cases = self._file_loader.load(
            self._predictions_path / job_name / "nlp-test-predictions.json"
        )
    ...
    def score(self, *, task_name: str, job_name: str):
        ...
        if TASK_TYPE[task_name] == ProblemType.ORDINAL_MULTI_CLASS_CLASSIFICATION:
        ...
        elif TASK_TYPE[task_name] == ProblemType.NONORDINAL_MULTI_CLASS_CLASSIFICATION:
        ...
        elif TASK_TYPE[task_name] == ProblemType.BINARY_CLASSIFICATION:
            # evaluate (multi-label) binary classification tasks
            # note: each subtask is the same, so we pool the labels and predictions
            # metric: AUC
            score = roc_auc_score(
                y_true=y_true.explode().values.astype(int),
                y_score=y_pred.explode().values.astype(float),
            )

        elif TASK_TYPE[task_name] == ProblemType.REGRESSION:
        ...
        elif TASK_TYPE[task_name] == ProblemType.NER:
