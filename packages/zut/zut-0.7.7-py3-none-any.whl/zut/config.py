...
def get_config(prog: str, *, list_delimiter: str = ',') -> ExtendedConfigParser:
    """
    ...
    parser = ExtendedConfigParser(list_delimiter=list_delimiter)
...
class ExtendedConfigParser(ConfigParser):
    def __init__(self, *, list_delimiter: str = ','):
        super().__init__()
    ...
    def getlist(self, section: str, option: str, *, raw=False, vars=None, fallback: list[str] = _UNSET) -> list[str]:
