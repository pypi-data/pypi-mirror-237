...
def get_deployment_folder_content(
    ...
    # Avoid logging content of virtual environments
    delete_keys = []
    for helper_model_venv in helper_model_venvs:
        for key in content.keys():
            if helper_model_venv in key:
...
def do_deploy(
    ...
    **kwargs,
    ...
    if setup_venv:
        ...
        test_payload = run_tests(c, setup_venv=setup_venv)
    # Get helper model venvs
    helper_model_venvs = kwargs.get("helper_model_venvs", [])
