...
def parse(deal_type, accommodation_type, location, rooms="all", start_page=1, end_page=100, is_saving_csv=False, is_latin=False, is_express_mode=True, is_by_homeowner=False):
    """
    ...
    :param is_express_mode:  is it necessary to speed up data collection (but without some fields, details are on Readme), default True
