...
class CustomMenu(Chips, ButtonCard, CustomTeleResponse, Usersays):
    ...
    def createMainMenu(listOfMainTopics):
    ...
    def createSubMenu(df):
        ...
        for i in df["Main Topic"].unique():
            ...
            reutrnChips = CustomMenu.getReturnChipsPayload()
            ...
            if(layers == 3):
                ...
                # Return to Main Menu                
                reutrnChips["payload"]["richContent"][0][0]["options"].append(CustomMenu.getReturnMainChips())
                ...
                CustomMenu.create2LayerMenu(df=df)
    ...
    def createIntentsMenu(df):
        ...
        for s in subTopics:
            if(s != ''):
                ...
                reutrnChips["payload"]["richContent"][0][0]["options"].append(CustomMenu.getReturnMainChips())
                reutrnChips["payload"]["richContent"][0][0]["options"].append(CustomMenu.getReturnSubChips(mainTopicName))
