...
def get_data_split(data_root, corn_name, normal=True, rgb=False, semantic=False):
    ...
    return point_set, point_rgb, point_sem_label, point_ins_label
...
def generate_one(data_root, veg_root, corn_name, leaf_num, voxel_size=0.02, normal=True, rgb=False, semantic=False,
    ...
    hole_corn_cloud, hole_corn_rgb, hole_corn_sem_l, hole_corn_label = get_data_split(data_root, corn_name, leaf_num, normal=normal, rgb=rgb, semantic=semantic)
    # 获取叶鞘
