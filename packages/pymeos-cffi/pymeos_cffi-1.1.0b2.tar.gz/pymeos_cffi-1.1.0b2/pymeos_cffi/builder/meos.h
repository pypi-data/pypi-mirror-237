...
/* extern const char *meostype_name(meosType temptype);  (undefined type meosType) */
/* extern meosType temptype_basetype(meosType temptype);  (undefined type meosType) */
/* extern meosType settype_basetype(meosType settype);  (undefined type meosType) */
/* extern meosType spantype_basetype(meosType spantype);  (undefined type meosType) */
/* extern meosType spantype_spansettype(meosType spantype);  (undefined type meosType) */
/* extern meosType spansettype_spantype(meosType spansettype);  (undefined type meosType) */
/* extern meosType basetype_spantype(meosType basetype);  (undefined type meosType) */
/* extern meosType basetype_settype(meosType basetype);  (undefined type meosType) */
...
/* extern bool geo_basetype(meosType basetype);  (undefined type meosType) */
/* extern bool spatial_basetype(meosType basetype);  (undefined type meosType) */

/* extern bool time_type(meosType timetype);  (undefined type meosType) */
/* extern bool set_basetype(meosType basetype);  (undefined) */

/* extern bool set_type(meosType type);  (undefined type meosType) */
/* extern bool numset_type(meosType type);  (undefined type meosType) */
/* extern bool ensure_numset_type(meosType type);  (undefined type meosType) */
/* extern bool timeset_type(meosType type);  (undefined type meosType) */
/* extern bool set_spantype(meosType type);  (undefined type meosType) */
/* extern bool ensure_set_spantype(meosType type);  (undefined type meosType) */
/* extern bool alphanumset_type(meosType settype);  (undefined type meosType) */
/* extern bool geoset_type(meosType type);  (undefined type meosType) */
/* extern bool ensure_geoset_type(meosType type);  (undefined type meosType) */
/* extern bool spatialset_type(meosType type);  (undefined type meosType) */
/* extern bool ensure_spatialset_type(meosType type);  (undefined type meosType) */

/* extern bool span_basetype(meosType type);  (undefined type meosType) */
/* extern bool span_canon_basetype(meosType type);  (undefined type meosType) */
/* extern bool span_type(meosType type);  (undefined type meosType) */
/* extern bool span_bbox_type(meosType type);  (undefined) */
/* extern bool numspan_basetype(meosType type);  (undefined type meosType) */
/* extern bool numspan_type(meosType type);  (undefined type meosType) */
/* extern bool ensure_numspan_type(meosType type);  (undefined type meosType) */
/* extern bool timespan_basetype(meosType type);  (undefined type meosType) */
/* extern bool timespan_type(meosType type);  (undefined type meosType) */

/* extern bool spanset_type(meosType type);  (undefined type meosType) */
/* extern bool numspanset_type(meosType type);  (undefined) */
/* extern bool timespanset_type(meosType type);  (undefined type meosType) */

/* extern bool temporal_type(meosType temptype);  (undefined type meosType) */
/* extern bool temporal_basetype(meosType basetype);  (undefined) */
/* extern bool temptype_continuous(meosType temptype);  (undefined type meosType) */
/* extern bool basetype_byvalue(meosType type);  (undefined type meosType) */
/* extern bool basetype_varlength(meosType type);  (undefined type meosType) */
/* extern int16 basetype_length(meosType basetype);  (undefined type meosType) */
/* extern bool talphanum_type(meosType type);  (undefined) */
/* extern bool talpha_type(meosType temptype);  (undefined type meosType) */
/* extern bool tnumber_type(meosType temptype);  (undefined type meosType) */
/* extern bool ensure_tnumber_type(meosType temptype);  (undefined type meosType) */
/* extern bool tnumber_basetype(meosType basetype);  (undefined type meosType) */
/* extern bool tnumber_settype(meosType settype);  (undefined) */
/* extern bool tnumber_spantype(meosType settype);  (undefined type meosType) */
/* extern bool tnumber_spansettype(meosType spansettype);  (undefined type meosType) */
/* extern bool tspatial_type(meosType temptype);  (undefined type meosType) */
/* extern bool ensure_tspatial_type(meosType temptype);  (undefined type meosType) */
/* extern bool tspatial_basetype(meosType basetype);  (undefined type meosType) */
/* extern bool tgeo_type(meosType type);  (undefined type meosType) */
/* extern bool ensure_tgeo_type(meosType type);  (undefined type meosType) */
/* extern bool ensure_tnumber_tgeo_type(meosType type);  (undefined type meosType) */
...
/* extern uint32 datum_hash(Datum d, meosType basetype);  (undefined type meosType) */
/* extern uint64 datum_hash_extended(Datum d, meosType basetype, uint64 seed);  (undefined type meosType) */

/* extern Set *set_in(const char *str, meosType basetype);  (undefined type meosType) */
extern char *set_out(const Set *s, int maxdd);
/* extern Span *span_in(const char *str, meosType spantype);  (undefined type meosType) */
extern char *span_out(const Span *s, int maxdd);
/* extern SpanSet *spanset_in(const char *str, meosType spantype);  (undefined type meosType) */
extern char *spanset_out(const SpanSet *ss, int maxdd);

extern Set *set_compact(const Set *s);
/* extern Set *set_make(const Datum *values, int count, meosType basetype, bool ordered);  (undefined type meosType) */
/* extern Set *set_make_exp(const Datum *values, int count, int maxcount, meosType basetype, bool ordered);  (undefined type meosType) */
/* extern Set *set_make_free(Datum *values, int count, meosType basetype, bool ordered);  (undefined type meosType) */
/* extern char *set_out(const Set *s, int maxdd);  (repeated) */
/* extern Span *span_make(Datum lower, Datum upper, bool lower_inc, bool upper_inc, meosType basetype);  (undefined type meosType) */
/* extern char *span_out(const Span *s, int maxdd);  (repeated) */
/* extern void span_set(Datum lower, Datum upper, bool lower_inc, bool upper_inc, meosType basetype, Span *s);  (undefined type meosType) */
...
/* extern Set *value_to_set(Datum d, meosType basetype);  (undefined type meosType) */
/* extern Span *value_to_span(Datum d, meosType basetype);  (undefined type meosType) */
/* extern SpanSet *value_to_spanset(Datum d, meosType basetype);  (undefined type meosType) */
...
/* extern void value_set_span(Datum d, meosType basetype, Span *s);  (undefined type meosType) */
...
/* extern Span *spanbase_extent_transfn(Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern Set *value_union_transfn(Set *state, Datum d, meosType basetype);  (undefined type meosType) */

/* extern bool adjacent_span_value(const Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool adjacent_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool contains_span_value(const Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool contains_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool contains_set_value(const Set *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool contains_set_set(const Set *s1, const Set *s2);  (repeated) */
/* extern bool contained_value_span(Datum d, meosType basetype, const Span *s);  (undefined type meosType) */
/* extern bool contained_value_set(Datum d, meosType basetype, const Set *s);  (undefined type meosType) */
/* extern bool contained_set_set(const Set *s1, const Set *s2);  (repeated) */
/* extern bool contained_value_spanset(Datum d, meosType basetype, const SpanSet *ss);  (undefined type meosType) */
...
/* extern bool left_set_value(const Set *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool left_span_value(const Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool left_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool left_value_set(Datum d, meosType basetype, const Set *s);  (undefined type meosType) */
/* extern bool left_value_span(Datum d, meosType basetype, const Span *s);  (undefined type meosType) */
/* extern bool left_value_spanset(Datum d, meosType basetype, const SpanSet *ss);  (undefined type meosType) */
/* extern bool right_value_set(Datum d, meosType basetype, const Set *s);  (undefined type meosType) */
/* extern bool right_set_value(const Set *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool right_set_set(const Set *s1, const Set *s2);  (repeated) */
/* extern bool right_value_span(Datum d, meosType basetype, const Span *s);  (undefined type meosType) */
/* extern bool right_value_spanset(Datum d, meosType basetype, const SpanSet *ss);  (undefined type meosType) */
/* extern bool right_span_value(const Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool right_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool overleft_value_set(Datum d, meosType basetype, const Set *s);  (undefined type meosType) */
/* extern bool overleft_set_value(const Set *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool overleft_set_set(const Set *s1, const Set *s2);  (repeated) */
/* extern bool overleft_value_span(Datum d, meosType basetype, const Span *s);  (undefined type meosType) */
/* extern bool overleft_value_spanset(Datum d, meosType basetype, const SpanSet *ss);  (undefined type meosType) */
/* extern bool overleft_span_value(const Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool overleft_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool overright_value_set(Datum d, meosType basetype, const Set *s);  (undefined type meosType) */
/* extern bool overright_set_value(const Set *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool overright_set_set(const Set *s1, const Set *s2);  (repeated) */
/* extern bool overright_value_span(Datum d, meosType basetype, const Span *s);  (undefined type meosType) */
/* extern bool overright_value_spanset(Datum d, meosType basetype, const SpanSet *ss);  (undefined type meosType) */
/* extern bool overright_span_value(const Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool overright_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */

extern bool inter_span_span(const Span *s1, const Span *s2, Span *result);
/* extern bool intersection_set_value(const Set *s, Datum d, meosType basetype, Datum *result);  (undefined type meosType) */
/* extern bool intersection_span_value(const Span *s, Datum d, meosType basetype, Datum *result);  (undefined type meosType) */
/* extern bool intersection_spanset_value(const SpanSet *ss, Datum d, meosType basetype, Datum *result);  (undefined type meosType) */
/* extern Set *minus_set_value(const Set *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern SpanSet *minus_span_value(const Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern SpanSet *minus_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */
/* extern bool minus_value_set(Datum d, meosType basetype, const Set *s, Datum *result);  (undefined type meosType) */
/* extern bool minus_value_span(Datum d, meosType basetype, const Span *s, Datum *result);  (undefined type meosType) */
/* extern bool minus_value_spanset(Datum d, meosType basetype, const SpanSet *ss, Datum *result);  (undefined type meosType) */
/* extern Set *union_set_value(const Set *s, const Datum d, meosType basetype);  (undefined type meosType) */
/* extern SpanSet *union_span_value(const Span *s, Datum v, meosType basetype);  (undefined type meosType) */
/* extern SpanSet *union_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */

/* extern double distance_value_value(Datum l, Datum r, meosType basetype);  (undefined type meosType) */
/* extern double distance_span_value(const Span *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern double distance_spanset_value(const SpanSet *ss, Datum d, meosType basetype);  (undefined type meosType) */
/* extern double distance_value_set(Datum d, meosType basetype, const Set *s);  (undefined) */
/* extern double distance_set_value(const Set *s, Datum d, meosType basetype);  (undefined type meosType) */
/* extern double distance_set_set(const Set *s1, const Set *s2);  (repeated) */

/* extern uint32 datum_hash(Datum d, meosType basetype);  (undefined type meosType) */
/* extern uint64 datum_hash_extended(Datum d, meosType basetype, uint64 seed);  (undefined type meosType) */

/* extern TBox *number_period_to_tbox(Datum d, meosType basetype, const Span *p);  (undefined type meosType) */
/* extern TBox *number_timestamp_to_tbox(Datum d, meosType basetype, TimestampTz t);  (undefined type meosType) */
...
/* extern void number_set_tbox(Datum d, meosType basetype, TBox *box);  (undefined type meosType) */
...
/* extern Temporal *temporal_in(const char *str, meosType temptype);  (undefined type meosType) */
...
/* extern TInstant *tinstant_in(const char *str, meosType temptype);  (undefined type meosType) */
...
/* extern TSequence *tsequence_in(const char *str, meosType temptype, interpType interp);  (undefined type meosType) */
...
/* extern TSequenceSet *tsequenceset_in(const char *str, meosType temptype, interpType interp);  (undefined type meosType) */
...
/* extern Temporal *temporal_from_base_temp(Datum value, meosType temptype, const Temporal *temp);  (undefined type meosType) */
extern TInstant *tinstant_copy(const TInstant *inst);
/* extern TInstant *tinstant_make(Datum value, meosType temptype, TimestampTz t);  (undefined type meosType) */
...
/* extern TSequence *tsequence_from_base_timestampset(Datum value, meosType temptype, const Set *ss);  (undefined type meosType) */
...
/* extern TSequence *tsequence_from_base_period(Datum value, meosType temptype, const Span *p, interpType interp);  (undefined type meosType) */
...
/* extern TSequenceSet *tsequenceset_from_base_periodset(Datum value, meosType temptype, const SpanSet *ps, interpType interp);  (undefined type meosType) */
...
/* extern Temporal *distance_tnumber_number(const Temporal *temp, Datum value, meosType valuetype, meosType restype);  (undefined type meosType) */
/* extern double nad_tnumber_number(const Temporal *temp, Datum value, meosType basetype);  (undefined type meosType) */
