...
'''
	...
	supplement = NIH_API_one.find (dsld_id)
'''
...
import cyte.supplements.NIH.API.source as NIH_API_source
import cyte.supplements.NIH.API.one.assertions as assertions
...
def find (
	...
	print (json.dumps (nih_supplement_data, indent = 4))
