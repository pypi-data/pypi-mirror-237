...
ckoppeltaalole_logger = logging.StreamHandler(sys.stdout)
ckoppeltaalole_logger.setLevel(logging.DEBUG)
ckoppeltaalole_logger.setFormatter(formatter)

file_logger = logging.FileHandler(r'koppeltaal.log')  # FIXME: make optional
file_logger.setLevel(logging.INFO)
file_logger.setFormatter(formatter)

koppeltaal_logger.addHandler(ckoppeltaalole_logger)
