...
install_requires = \
['datar[pandas]>=0.15.2,<0.16.0',
 'pipen-board[report]>=0.13,<0.14',
 'pipen-cli-run>=0.11,<0.12',
 'pipen-filters>=0.10,<0.11',
 'pipen-verbose>=0.9,<0.10']

extras_require = \
{'runinfo': ['pipen-runinfo>=0.4,<0.5']}
