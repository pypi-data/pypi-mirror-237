...
class ProvisioningState(object):
    ...
    allowable_values = [PROVISIONING, DESTROYING, AVAILABLE, FAILED]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ProvisioningState - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProvisioningState):
            return False
