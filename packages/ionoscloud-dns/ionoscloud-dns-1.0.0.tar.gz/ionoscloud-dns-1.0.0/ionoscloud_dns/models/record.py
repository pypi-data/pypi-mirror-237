...
class Record(object):
    ...
    def type(self):
        ...
        Holds supported DNS resource record types. In the DNS context a record is a DNS resource record.  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["A", "AAAA", "CNAME", "ALIAS", "MX", "NS", "SRV", "TXT", "CAA", "SSHFP", "TLSA", "SMIMEA", "DS", "HTTPS", "SVCB", "OPENPGPKEY", "CERT", "URI", "RP", "LOC"]  # noqa: E501
