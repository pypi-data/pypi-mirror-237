...
import ionoscloud_dns.models
from ionoscloud_dns import rest
from ionoscloud_dns.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_dns.models, klass)
