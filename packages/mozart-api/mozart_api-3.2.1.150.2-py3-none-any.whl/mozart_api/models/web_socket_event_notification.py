...
class WebSocketEventNotification(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSocketEventNotification:
        """Create an instance of WebSocketEventNotification from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSocketEventNotification:
        """Create an instance of WebSocketEventNotification from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventNotification.parse_obj(obj)

        _obj = WebSocketEventNotification.parse_obj(
            {
                "event_data": WebsocketNotificationTag.from_dict(obj.get("eventData"))
