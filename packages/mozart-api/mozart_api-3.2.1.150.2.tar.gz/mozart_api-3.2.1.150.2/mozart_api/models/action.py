...
class Action(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('standby', 'tone', 'radio', 'sourcePreset', 'deezerFlow', 'activateSource', 'playQueue', 'buttonShortPress', 'allStandby', 'touchToJoin', 'fallback', 'volume', 'stop', 'triggerContent', 'speakerGroup', 'listeningMode', 'stand')"
            )
        return value
        ...
        _obj = Action.parse_obj(
            {
                ...
                "queue_item": PlayQueueItem.from_dict(obj.get("queueItem"))
                if obj.get("queueItem") is not None
                else None,
                "queue_settings": PlayQueueSettings.from_dict(obj.get("queueSettings"))
                ...
                "stand_position": StandPosition.from_dict(obj.get("standPosition"))
