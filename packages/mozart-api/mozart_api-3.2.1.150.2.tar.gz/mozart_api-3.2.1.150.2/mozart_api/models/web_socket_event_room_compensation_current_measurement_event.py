...
class WebSocketEventRoomCompensationCurrentMeasurementEvent(BaseModel):
    """
    Sent when a room compensation measurement is started/done. Is only sent when room compensation type is advanced.
    """
    ...
    def from_json(
        ...
        """Create an instance of WebSocketEventRoomCompensationCurrentMeasurementEvent from a JSON string"""
    ...
    def from_dict(
        ...
        """Create an instance of WebSocketEventRoomCompensationCurrentMeasurementEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSocketEventRoomCompensationCurrentMeasurementEvent.parse_obj(obj)

        _obj = WebSocketEventRoomCompensationCurrentMeasurementEvent.parse_obj(
            {
                "event_data": RoomCompensationCurrentMeasurement.from_dict(
                    obj.get("eventData")
                )
