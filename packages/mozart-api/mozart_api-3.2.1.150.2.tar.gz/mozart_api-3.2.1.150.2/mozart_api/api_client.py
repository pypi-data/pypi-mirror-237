...
import mozart_api.models
from mozart_api import rest
from mozart_api.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.user_agent = "OpenAPI-Generator/3.2.1.150.2/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mozart_api.models, klass)
