    ...
    def __init__(self,config_file):
        ...
        try:
            ...
            if 'DB' in self.config:
                ...
                print("Required sections 'DB' not found in the configuration file.")
            if 'EMAIL' in self.config:
                ...
                print("Required sections 'EMAIL' not found in the configuration file.")
            if 'PARAM' in self.config:
                self.log = self.config.get('PARAM', 'log')
            else:
                print("Required sections 'PARAM' not found in the configuration file.")
