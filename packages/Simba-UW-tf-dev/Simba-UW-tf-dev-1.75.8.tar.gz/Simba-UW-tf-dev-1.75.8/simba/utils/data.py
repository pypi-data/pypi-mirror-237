...
#
# for h in headers:
#     new_headers.append(h + '_x')
#     new_headers.append(h + '_y')
#     new_headers.append(h + '_p')

# df = slp_to_df_convert_updated(file_path='/Users/simon/Desktop/envs/troubleshooting/ryan/LBN4a_Ctrl_P05_1_2022-01-15_08-16-20c.h5', headers=new_headers, joined_tracks=True, drop_body_parts=headers_to_drop)
# print(df)
#df.to_csv('Ryan_test.csv')
