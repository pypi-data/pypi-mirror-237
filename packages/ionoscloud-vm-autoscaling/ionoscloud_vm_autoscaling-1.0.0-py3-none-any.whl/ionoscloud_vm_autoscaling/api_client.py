...
import ionoscloud_vm_autoscaling.models
from ionoscloud_vm_autoscaling import rest
from ionoscloud_vm_autoscaling.exceptions import ApiValueError, ApiException, ApiFailedRequest, ApiTimeout
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_vm_autoscaling.models, klass)
