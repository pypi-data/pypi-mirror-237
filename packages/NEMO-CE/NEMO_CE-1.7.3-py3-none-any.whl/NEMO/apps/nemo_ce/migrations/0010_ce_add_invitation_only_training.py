...
class Migration(NEMOMigration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.BooleanField(default=False, help_text='If checked, users can only register if they have been invited'),
        ),
        migrations.AlterField(
            model_name='trainingevent',
            name='recorded',
            field=models.BooleanField(default=False, help_text='Indicates this training event has completed and training session was recorded'),
        ),
    ]
