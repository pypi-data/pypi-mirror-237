...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"drives": "drives", "site": "site"},
)
class MicrosoftSharepointOnlineObject:
    def __init__(
        self,
        *,
        drives: typing.Sequence[builtins.str],
        site: builtins.str,
    ) -> None:
        '''(experimental) Represents a list of Microsoft Sharepoint Online site drives from which to retrieve the documents.

        :param drives: (experimental) An array of Microsoft Sharepoint Online site drives from which the documents are to be retrieved. Note: each drive requires full name starting with 'drives/'
    ...
    @builtins.property
    def drives(self) -> typing.List[builtins.str]:
        '''(experimental) An array of Microsoft Sharepoint Online site drives from which the documents are to be retrieved.
        ...
        assert result is not None, "Required property 'drives' is missing"
        return typing.cast(typing.List[builtins.str], result)
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "refres_token_grant": "refresTokenGrant",
    },
)
class SalesforceOAuthFlow:
    def __init__(
        ...
        *,
        ...
        refres_token_grant: typing.Optional[typing.Union["SalesforceOAuthRefreshTokenGrantFlow", typing.Dict[builtins.str, typing.Any]]] = None,
    ) -> None:
        '''
        :param refresh_token_grant: (experimental) The parameters required for the refresh token grant OAuth flow.
        :param refres_token_grant: (deprecated) The parameters required for the refresh token grant OAuth flow.
        ...
        if refres_token_grant is not None:
            self._values["refres_token_grant"] = refres_token_grant
    ...
    @builtins.property
    def refres_token_grant(
        self,
    ) -> typing.Optional["SalesforceOAuthRefreshTokenGrantFlow"]:
        '''(deprecated) The parameters required for the refresh token grant OAuth flow.
...
class SnowflakeConnectorProfile(
    ...
    def integration_role(self) -> typing.Optional[_aws_cdk_aws_iam_ceddda9d.IRole]:
        '''(experimental) The AWS IAM Role for the storage integration with Snowflake. Available only if [SnowflakeConnectorProfileProps's integration property]{@link SnowflakeConnectorProfileProps#integration} is provided.
