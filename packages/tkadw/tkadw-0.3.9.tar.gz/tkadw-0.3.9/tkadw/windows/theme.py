...
if __name__ == '__main__':
    ...
    circular_button = AdwTCircularButton(text="AdwTCircularButtorn")
    ...
    frame2 = AdwTDesignerFrame(master=frame, widget=AdwTButton, text="可拖拽缩放按钮")
    frame2.place(x=0, y=0, width=150, height=100)
    frame2.update()
