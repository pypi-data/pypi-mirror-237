...
class TestPrecommit(unittest.TestCase):
    ...
    @unittest.skip("Skipping test_get_changed_xpaths")
    ...
    @unittest.skip("Skipping test_get_all_xpaths_submodule")
    ...
    @unittest.skip("Skipping test_get_test_data")
    ...
    @unittest.skip("Skipping test_report_invalid_testcases")
    ...
    @unittest.skip("Skipping test_calculate_test_coverage")
