...
#eventobj=APIEvent()
#api=TCoreAPI(eventclass=eventobj)#
api=TCoreAPI(eventclass=APIEvent)#
...
print(api.gettradeingdate("TC.O.SSE.510050.202307.C.2.5",20230401,20230607))
#获取合约剩余交易日还有多少天
print(api.gettradeingdays("TC.O.SSE.510050.202307.C.2.5"))
...
api.subbar(BarType.MINUTE,5,"TC.O.SSE.510050.202212.C.2.5",starttime="2022120101")#TC.F.SHFE.rb.HOT
...
#订阅动态Greeks线图数据
api.subgreeksline(GreeksType.DOGSK,5,"TC.O.SSE.510050.202301.C.2.75",starttime="2023011101")#TC.F.SHFE.rb.HOT
