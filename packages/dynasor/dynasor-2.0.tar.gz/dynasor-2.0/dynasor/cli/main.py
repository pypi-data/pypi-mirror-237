...
def main():
    ...
    iogroup.add_argument(
        '--length-unit', type=str, metavar='LENGTH_UNIT',
        help='Length unit of trajectory. Necessary for correct conversion to internal dynasor'
        ' units if the trajectory file does not contain unit information.'
        ' For available options see the documentation of MDAnalysis.')
    iogroup.add_argument(
        '--time-unit', type=str, metavar='TIME_UNIT',
        help='Time unit of trajectory. Necessary for correct conversion to internal dynasor'
        ' units if the trajectory file does not contain unit information.'
        ' For available options see the documentation of MDAnalysis.')
    iogroup.add_argument(
    ...
    if args.q_sampling == 'isotropic':
        sample = compute_spherical_qpoint_average(sample, args.q_bins)
