...
def get_supercell_qpoints_along_path(
        ...
        super_cell: NDArray[float]) -> Tuple[NDArray[float], List[str]]:
    r"""
    ...
    Tuple[NDArray[float], List[str]]
        a tuple comprising the accessible q-point coordinates along the
        specified path as well as the respective q-point labels
