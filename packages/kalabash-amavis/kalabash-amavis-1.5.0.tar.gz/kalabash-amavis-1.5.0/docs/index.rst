.. kalabash-amavis documentation master file, created by
   sphinx-quickstart on Sun Feb 22 14:35:42 2015.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to kalabash-amavis's documentation!
==========================================
...
.. note::
   ...
   installations. Currently, you can't use kalabash with an existing
