...
from habana_frameworks.mediapipe.operators.cpu_nodes.cpu_ops_node import cpu_media_const_node
...
schema.add_operator("GaussianFilter", None, 1, 1, gaussian_filter_in_keys, 1,
                    gaussian_filter_params, None, gaussian_filter, dt.FLOAT32)
...
schema.add_operator_cpu("MediaConst", "media_const", 0, 0, generic_in0_keys, 1,
                        media_constant_params, mpn.MediaConstantParams_t, cpu_media_const_node, dt.NDT)

schema.add_operator_cpu("SSDCropWindowGen", "ssd_crop_window_gen", 4, 4, ssd_crop_window_gen_keys,  5,
                        ssd_crop_window_gen_params, mpn.SSDCropWindowGenParams_t, cpu_ops_node, dt.NDT)
