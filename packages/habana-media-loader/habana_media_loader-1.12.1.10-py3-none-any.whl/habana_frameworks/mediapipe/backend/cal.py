...
class graph_handler():
    def __init__(self, batch_size, const_node, reader_nodes, cpu_nodes, decoder_nodes, hpu_nodes, outputs, fw_type, proxy):
        self.__reader_nodes__ = reader_nodes
        self.__const_nodes__ = const_node
        ...
        for op in self.__decoder_nodes__:
            self.__create_c_nodes__(
                op, mpn.NodeType_t.NODE_DECODER_BATCHER, mpn.Device_t.DEVICE_CPU)
