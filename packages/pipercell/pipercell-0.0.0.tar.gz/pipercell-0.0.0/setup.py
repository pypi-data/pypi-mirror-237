...
if __name__ == '__main__':
    ...
    # Locally for testing (from pipercell/python-packate dir)
    #   pip install -e . --force-reinstall -v
    # Upload to test.pypi
    #   twine upload --repository testpypi dist/*
    # Istall from test.pypi
    #   pip install --force-reinstall -i https://test.pypi.org/simple/ pipercell
    ...
    setuptools.setup(
        ...
        packages=setuptools.find_packages(include=['pipercell']),
        include_package_data=True,
        long_description=long_description,
        long_description_content_type="text/markdown",
        url="https://www.pipercell.com",
        project_urls={"github": "https://github.com/GinkoBalboa/pipercell",
                      "documentation": "https://www.pipercell.com"},
        classifiers=[
