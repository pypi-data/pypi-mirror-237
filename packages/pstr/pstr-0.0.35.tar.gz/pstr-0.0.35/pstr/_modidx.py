...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'pstr.chck': { 'pstr.chck.ischars': ('chck.html#ischars', 'pstr/chck.py'),
            ...
            'pstr.filt': { 'pstr.filt.allbut': ('filt.html#allbut', 'pstr/filt.py'),
                           ...
                           'pstr.filt.stripjoin': ('filt.html#stripjoin', 'pstr/filt.py')},
            ...
            'pstr.join': { 'pstr.join.charjoin': ('join.html#charjoin', 'pstr/join.py'),
                           ...
                           'pstr.join.tovargs': ('join.html#tovargs', 'pstr/join.py'),
            ...
            'pstr.util.core': { 'pstr.util.core.getcard': ('05_util/core.html#getcard', 'pstr/util/core.py'),
