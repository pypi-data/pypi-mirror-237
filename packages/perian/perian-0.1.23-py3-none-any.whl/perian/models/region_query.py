...
class RegionQuery(BaseModel):
    ...
    __properties = ["name", "location", "sustainable", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegionQuery:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegionQuery:
        """Create an instance of RegionQuery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegionQuery.parse_obj(obj)

        _obj = RegionQuery.parse_obj({
            "name": obj.get("name"),
