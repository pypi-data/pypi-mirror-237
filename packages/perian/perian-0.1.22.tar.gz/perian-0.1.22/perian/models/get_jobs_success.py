...
class GetJobsSuccess(BaseModel):
    ...
    jobs: conlist(Job) = Field(...)
    __properties = ["status", "message", "detail", "status_code", "jobs"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetJobsSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetJobsSuccess:
        """Create an instance of GetJobsSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetJobsSuccess.parse_obj(obj)

        _obj = GetJobsSuccess.parse_obj({
