...
class NetworkQuery(BaseModel):
    ...
    __properties = ["inbound_speed", "outbound_speed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NetworkQuery:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NetworkQuery:
        """Create an instance of NetworkQuery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NetworkQuery.parse_obj(obj)

        _obj = NetworkQuery.parse_obj({
