...
class StorageQuery(BaseModel):
    ...
    __properties = ["no", "size", "type", "speed", "included"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StorageQuery:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StorageQuery:
        """Create an instance of StorageQuery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StorageQuery.parse_obj(obj)

        _obj = StorageQuery.parse_obj({
            "no": obj.get("no"),
            "size": obj.get("size"),
            "type": obj.get("type"),
            "speed": obj.get("speed"),
