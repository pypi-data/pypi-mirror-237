...
class NoJobFoundError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoJobFoundError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoJobFoundError:
        """Create an instance of NoJobFoundError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoJobFoundError.parse_obj(obj)

        _obj = NoJobFoundError.parse_obj({
