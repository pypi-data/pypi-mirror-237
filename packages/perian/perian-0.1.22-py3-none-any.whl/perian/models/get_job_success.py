...
class GetJobSuccess(BaseModel):
    ...
    job: Job = Field(...)
    __properties = ["status", "message", "detail", "status_code", "job"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetJobSuccess:
        """Create an instance of GetJobSuccess from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetJobSuccess:
        """Create an instance of GetJobSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetJobSuccess.parse_obj(obj)

        _obj = GetJobSuccess.parse_obj({
