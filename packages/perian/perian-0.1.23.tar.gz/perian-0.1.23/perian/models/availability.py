...
class Availability(BaseModel):
    ...
    source: Optional[AvailabilitySource] = None
    __properties = ["available", "source"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Availability:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Availability:
        """Create an instance of Availability from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Availability.parse_obj(obj)

        _obj = Availability.parse_obj({
