...
from .constants import _AzuremlOptimizationArgs, _AzuremlIOArgs, HfTrainerType, LoraAlgo
...
from .utils.callbacks import LoraPyTorchSaveCallback, FinetuneCallback
...
class AzuremlFinetuneArgs:
    ...
    def __post_init__(self):
        ...
        if self.optimization_args.apply_lora and self._enable_peft():
            logger.info(
