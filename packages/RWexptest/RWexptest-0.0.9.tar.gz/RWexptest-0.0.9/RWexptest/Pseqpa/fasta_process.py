...
def process_fasta_files(input_directory, output_directory, batch_size, min_length=10, max_length=6000):
    # 确保输出目录存在
...
def read_fasta(file_path, min_length, max_length):
    ...
    # 处理最后一个序列
    if current_id and current_sequence and min_length <= len(current_sequence) <= max_length:
