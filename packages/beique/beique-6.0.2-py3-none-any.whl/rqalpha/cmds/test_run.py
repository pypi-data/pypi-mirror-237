...
def run(**kwargs):
    ...
    plot_result(results['sys_analyser'], weekly_indicators=True, open_close_points=True)
    print(results)
    # with pd.option_context('expand_frame_repr', False, 'display.max_rows', None):
    #     print(results['sys_analyser']["trades"])
...
run(config_path='C:\\Users\\admin\\Documents\\quant\\rqalpha\\rqalpha\\config.yml')
