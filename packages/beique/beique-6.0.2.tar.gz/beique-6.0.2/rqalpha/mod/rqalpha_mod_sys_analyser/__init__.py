...
__config__ = {
    ...
    "output_file": "C:\\Users\\admin\\Documents\\quant\\data\\result\\result.pkl",
    # 回测结果输出的json格式
    "output_json": "C:\\Users\\admin\\Documents\\quant\\data\\result\\",
...
inject_run_param(click.Option(
    ('-ojson', '--output-json', 'mod__sys_analyser__output_json'),
    type=click.Path(writable=True),
    help=_("[sys_analyser] output result pickle file")
))
inject_run_param(click.Option(
