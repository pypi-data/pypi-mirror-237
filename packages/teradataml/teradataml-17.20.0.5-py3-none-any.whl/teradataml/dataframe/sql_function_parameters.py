...
_edit_distance_param_structure = [_generate_param_structure("expression", (ColumnExpression, str)),
                                  _generate_param_structure("ci", (int), default_value=1),
                                  _generate_param_structure("cd", (int), default_value=1),
                                  _generate_param_structure("cs", (int), default_value=1),
                                  _generate_param_structure("ct", (int), default_value=1)]

_ltrim_rtrim_param_structure = [_generate_param_structure("expression", (ColumnExpression, str), default_value=' ')]

_index_param_structure = [_generate_param_structure("expression", (ColumnExpression, str))]

_instr_param_structure = [_generate_param_structure("expression", (ColumnExpression, str)),
                          _generate_param_structure("position", (int), default_value=1),
                          _generate_param_structure("occurrence", (int), default_value=1)]

_left_right_param_structure = [_generate_param_structure("length", (ColumnExpression, int))]

_locate_param_structure = [_generate_param_structure("expression", (ColumnExpression, str)),
                           _generate_param_structure("n1", (int), default_value=1)]

_lpad_rpad_param_structure = [_generate_param_structure("length", (ColumnExpression, int), default_value=' '),
                              _generate_param_structure("fill_string", (ColumnExpression, str), default_value=' ')]

_ngram_param_structure = [_generate_param_structure("expression", (ColumnExpression, str)),
                          _generate_param_structure("length", (int)),
                          _generate_param_structure("position", (int), default_value=1)]

_nvp_param_structure = [_generate_param_structure("name_to_search", (ColumnExpression, str)),
                        _generate_param_structure("name_delimiters", (str), default_value="&"),
                        _generate_param_structure("value_delimiters", (str), default_value="="),
                        _generate_param_structure("occurrence", (int), default_value=1)]

_oreplace_otranslate_param_structure = [_generate_param_structure("search_string", (ColumnExpression, str)),
                                        _generate_param_structure("replace_string", (ColumnExpression, str), default_value=" ")]
