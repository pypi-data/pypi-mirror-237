...
class _Plot:
    def __init__(self, x, y, scale=None, kind='line', **kwargs):
        ...
        arg_info_matrix.append(["scale", self.scale, True, (ColumnExpression, list), True])
        ...
        self.wiggle_fill = kwargs.pop("wiggle_fill", True)
        ...
        if self.figtype not in ["png", "jpg"] and self.figdpi is not None:
            message = Messages.get_message(MessageCodes.DEPENDENT_ARGUMENT,
                                           "figdpi", "figtype='png' or figtype='jpg'")
            raise TeradataMlException(message, MessageCodes.DEPENDENT_ARGUMENT)
