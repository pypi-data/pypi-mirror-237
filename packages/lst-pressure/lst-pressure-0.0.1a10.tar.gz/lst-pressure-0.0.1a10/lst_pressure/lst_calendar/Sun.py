...
class Sun:
    ...
    @property
    def dawn_lst(self):
        return utc_to_lst(self._attributes.get("dawn"))
    ...
    def sunrise_lst(self):
        return utc_to_lst(self._attributes.get("sunrise"))
    ...
    @property
    def noon_lst(self):
        return utc_to_lst(self._attributes.get("noon"))
    ...
    @property
    def sunset_lst(self):
        return utc_to_lst(self._attributes.get("sunset"))
    ...
    @property
    def dusk_lst(self):
        return utc_to_lst(self._attributes.get("dusk"))
