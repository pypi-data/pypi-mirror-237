...
from ..lst_calendar import LSTCalendar, LSTIntervalType, helpers
    ...
    def observable_dates(self) -> List["Interval"]:
        ...
        return [
            ...
            for i in self.calendar.lst_calendar_index.get_intervals_containing(
                LSTInterval(*helpers.calculate_OBSERVATION_WINDOW(self.lst_window_start, self.lst_window_end)).interval
            )
