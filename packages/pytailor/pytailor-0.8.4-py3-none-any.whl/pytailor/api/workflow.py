...
class Workflow(APIBase):
    ...
    **Parameters(default constructor):**
    ...
    @property
    def local_files_node_ids(self):
        return self.__local_files_node_ids
    ...
    def __update_from_backend(self, wf_model: WorkflowModel):
        ...
        self.__local_files_node_ids = wf_model.local_files_node_ids
        self.__model = wf_model

        if wf_model.local_files:
            self.__local_files = LocalFiles()
            self.__local_files.files = wf_model.local_files
    ...
    def run(self, distributed: bool = False, worker_name: Optional[str] = None) -> None:
        ...
        *distributed=False*
        ...
        if self.__local_files:
            ...
            local_node_id = self.__local_files.node_id
        else:
            local_files = None
