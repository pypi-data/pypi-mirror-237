...
from syned.beamline.shape import SurfaceShape, Conic, Ellipsoid, Plane, Sphere
...
if __name__ == "__main__":
    ...
    mirror1 = Mirror(name="mirror1",boundary_shape=Rectangle(-0.5e-3,0.5e-3,-2e-3,2e-3), surface_shape=Sphere())
