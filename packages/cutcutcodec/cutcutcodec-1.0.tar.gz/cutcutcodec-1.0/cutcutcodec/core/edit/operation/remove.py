...
"""
** Allows you to remove elements from the graph by managing collateral damage. **
---------------------------------------------------------------------------------
"""
...
def remove_edges(
    ...
    ** Deletes several edges from the graph. **
    ...
    """
    assert isinstance(graph, networkx.MultiDiGraph), graph.__class__.__name__
    assert hasattr(edges, "__iter__"), edges.__class__.__name__
    edges = list(edges)
...
def remove_elements(
    ...
    ** Deletes several nodes or edges from the graph. **
    ...
    graph : network.MultiDiGraph
        ...
        The operations on this graph will be performed in-place.
    elements : typing.Iterable[typing.Union[str, tuple[str, str, str]]]
    ...
    """
    assert isinstance(graph, networkx.MultiDiGraph), graph.__class__.__name__
    assert hasattr(elements, "__iter__"), elements.__class__.__name__
...
def remove_nodes(
    ...
    ** Deletes several nodes from the graph. **
    ...
    """
    assert isinstance(graph, networkx.MultiDiGraph), graph.__class__.__name__
    assert hasattr(nodes, "__iter__"), nodes.__class__.__name__
    nodes = list(nodes)
