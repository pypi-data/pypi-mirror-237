...
from cutcutcodec.core.filters.cut import FilterCut
...
class FilterVideoCut(FilterCut, Filter):
    ...
    ** Splits the video stream at the given positions. **
    ...
    Examples
    --------
    >>> from cutcutcodec.core.filters.video.cut import FilterVideoCut
    ...
    def __init__(self, in_streams: typing.Iterable[Stream], *limits: numbers.Real):
        ...
        limits : numbers.Real
            Transmitted to ``cutcutcodec.core.filters.cut.FilterCut.init``.
        """
...
class _StreamVideoCut(StreamVideoWrapper):
    ...
    ** Select a slice of a video stream. **
    ...
    def __init__(self,
        node: FilterVideoCut, index: numbers.Integral, l_min: numbers.Real, l_max: numbers.Real
    ):
        """
        Parameters
        ----------
        filter : cutcutcodec.core.filters.video.cut.FilterVideoCut
