...
from cutcutcodec.core.filters.audio.cut import FilterAudioCut
from cutcutcodec.core.filters.audio.identity import FilterAudioIdentity
from cutcutcodec.core.filters.subclip import FilterSubclip
...
class FilterAudioSubclip(FilterSubclip, MetaFilter):
    ...
    ** Extract a segment from an audio stream. **
    ...
    It is a particular case of ``cutcutcodec.core.filters.audio.cut.FilterAudioCut``.
    ...
    def __init__(self,
        ...
        delay: numbers.Real, default=0
            Transmitted to ``cutcutcodec.core.filters.subclip.FilterSubClip``.
    ...
    def _compile(self, in_streams: tuple[Stream]) -> Node:
        ...
        return FilterAudioIdentity(sub_streams)

    def _setstate(self, in_streams: typing.Iterable[Stream], state: dict) -> None:
        assert set(state) == {"delay", "duration_max"}, set(state)
        FilterAudioSubclip.__init__(self,
