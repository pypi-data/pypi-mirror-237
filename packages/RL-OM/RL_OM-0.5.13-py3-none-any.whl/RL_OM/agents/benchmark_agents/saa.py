...
# %% auto 0
__all__ = ['SAA_MP_Agent', 'round_none', 'SAA_MP_Policy']
...
class SAA_MP_Policy():
    ...
    def optimize(self, state):
        ...
        scenarios, weights = self.sample_scenarios()
        ...
        solver.msg = True  # Turn off solver output
        model.solve(solver)
        # Print the results
        print("preparing results")
        if self.counter >= 25:
            t, s = ts[0]
            print("weights:", weights[s])
            print("u:", u[t,s].varValue)
            print("I:", I[t,s].varValue)
            print("q_0:", q[0,0].varValue)
        results = {
    ...
    def get_scenarios(self, demand):
        ...
        print(self.all_scenarios.shape)
