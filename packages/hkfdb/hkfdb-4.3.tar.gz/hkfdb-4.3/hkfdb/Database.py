    ...
    def get_ccass_by_id(self, ccass_id, start_date, end_date):
        ...
        if False not in list(check_bool_dict.values()):
            ...
            if response_ok == True:
                ...
                result = json.loads(json.loads(response.content).replace("'", "\"").replace('nan','0'))
        ...
        if False not in list(check_bool_dict.values()):
            ...
            if response_ok == True:
                ...
                if response_ok == True:
                    ...
                    df['share_first'] = df['share_first'].astype(int)
                    df['share_last'] = df['share_last'].astype(int)
                    df['share_chg'] = df['share_chg'].astype(float)
