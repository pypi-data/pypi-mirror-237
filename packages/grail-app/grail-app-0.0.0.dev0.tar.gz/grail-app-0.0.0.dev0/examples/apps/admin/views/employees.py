...
Generated from /generators/fabview/?classname=Employee&list_columns=name,division&show_columns=name,division&add_columns=name,division&edit_columns=name
"""
...
def init_app(app:flask.Flask):
    ...
    with app.app_context():
        fab.add_view(EmployeeView,'Employee')
