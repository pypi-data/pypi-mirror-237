...
class UnixHTTPConnection(urllib3.connection.HTTPConnection, object):
    ...
    def connect(self):
        ...
        try:
            ...
            sock.close()
            raise RuntimeError(f"Could not connect to {socket_path}, are you sure the service is running and that you have permissions?")
        self.sock = sock
...
class Session(requests.Session):
    def __init__(self, url_scheme:str, *args:list[str], **kwargs:dict[str,str]):
