...
class Command(BaseCommand):
    ...
    def getConfig(self):
        return {
            "kubefacets": {
                "basic": [self.update_utils_pkg, self.clean_db],
                "migrate": [
                ...
                "setup_fixtures": [
                    ...
                    "v1/kubefacets/events/events_inbound_sso_api_user_upsert.json",
                    "v1/kubefacets/events/events_inbound_sso_api_verify_upsert.json",
                    "v1/kubefacets/events/events_outbound_tbl_upsert.json",
                ],
                "data_fixtures": [],
                "msmq": "python manage.py basemsmq -s={}".format(self.service_id),
                "server": "python manage.py runserver 8008",
            }
        }
