...
__repository__ = 'https://github.com/usmanmusa1920/pstyle'
__url__ = 'https://pstyle.readthedocs.io'
__license__ = 'MIT'
__copyright__ = f'Copyright (C) 2023 - {datetime.today().year} Usman Musa'
__description__ = 'Pstyle it is python text-style ✅ not python textile! 🤔 it actually print your text on terminal in different kind of colors.'
