...
def decode_capnp(decoded_data, clk, valid, capnp_bits, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(CapnpDecodeOp(decodedData=decoded_data, clk=clk, valid=valid, capnpBits=capnp_bits, loc=loc, ip=ip))
...
def encode_capnp(capnp_bits, clk, valid, data_to_encode, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(CapnpEncodeOp(capnpBits=capnp_bits, clk=clk, valid=valid, dataToEncode=data_to_encode, loc=loc, ip=ip))
...
def cosim(recv, clk, rst, send, name, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(CosimEndpointOp(recv=recv, clk=clk, rst=rst, send=send, name=name, loc=loc, ip=ip))
...
def service_req_to_client(to_client, service_port, client_name_path, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(RequestToClientConnectionOp(toClient=to_client, servicePort=service_port, clientNamePath=client_name_path, loc=loc, ip=ip))
...
def service_req_to_server(service_port, to_server, client_name_path, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(RequestToServerConnectionOp(servicePort=service_port, toServer=to_server, clientNamePath=client_name_path, loc=loc, ip=ip))
...
def service_impl_req_req(to_client, service_port, client_name_path, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ServiceImplementConnReqOp(toClient=to_client, servicePort=service_port, clientNamePath=client_name_path, loc=loc, ip=ip))
...
def service_impl_req(outputs, impl_type, inputs, *, service_symbol=None, impl_opts=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ServiceImplementReqOp(outputs=outputs, impl_type=impl_type, inputs=inputs, service_symbol=service_symbol, impl_opts=impl_opts, loc=loc, ip=ip))
...
def service_instance(result, impl_type, inputs, *, service_symbol=None, impl_opts=None, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(ServiceInstanceOp(result=result, impl_type=impl_type, inputs=inputs, service_symbol=service_symbol, impl_opts=impl_opts, loc=loc, ip=ip))
...
class ToClientOp(_ods_ir.OpView):
  ...
  def __init__(self, inner_sym, toClientType, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_456')) else
      _ods_ir.AttrBuilder.get('anonymous_456')(toClientType, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class ToServerOp(_ods_ir.OpView):
  ...
  def __init__(self, inner_sym, toServerType, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_456')) else
      _ods_ir.AttrBuilder.get('anonymous_456')(toServerType, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
