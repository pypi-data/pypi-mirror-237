...
class AppIDHierNodeOp(_ods_ir.OpView):
  OPERATION_NAME = "esi.esi.manifest.hier_node"
...
def esi_manifest_hier_node(app_id, module_ref, *, loc=None, ip=None) -> _ods_ir.Operation:
...
class AppIDHierRootOp(_ods_ir.OpView):
  OPERATION_NAME = "esi.esi.manifest.hier_root"
...
def esi_manifest_hier_root(top_module_ref, *, loc=None, ip=None) -> _ods_ir.Operation:
...
class ServiceImplClientRecordOp(_ods_ir.OpView):
  OPERATION_NAME = "esi.esi.manifest.impl_conn"
  ...
  def __init__(self, relAppIDPath, servicePort, bundleType, implDetails, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_444')) else
      _ods_ir.AttrBuilder.get('anonymous_444')(bundleType, context=_ods_context))
...
def esi_manifest_impl_conn(rel_app_id_path, service_port, bundle_type, impl_details, *, loc=None, ip=None) -> _ods_ir.Operation:
...
class ServiceImplRecordOp(_ods_ir.OpView):
  OPERATION_NAME = "esi.esi.manifest.service_impl"
...
def esi_manifest_service_impl(app_id, service_impl_name, impl_details, *, service=None, loc=None, ip=None) -> _ods_ir.Operation:
...
class ServiceRequestRecordOp(_ods_ir.OpView):
  OPERATION_NAME = "esi.esi.manifest.req"
...
def esi_manifest_req(requestor, service_port, direction, bundle_type, *, loc=None, ip=None) -> _ods_ir.Operation:
...
class ToClientOp(_ods_ir.OpView):
  ...
  def __init__(self, inner_sym, toClientType, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_444')) else
      _ods_ir.AttrBuilder.get('anonymous_444')(toClientType, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class ToServerOp(_ods_ir.OpView):
  ...
  def __init__(self, inner_sym, toServerType, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_444')) else
      _ods_ir.AttrBuilder.get('anonymous_444')(toServerType, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
