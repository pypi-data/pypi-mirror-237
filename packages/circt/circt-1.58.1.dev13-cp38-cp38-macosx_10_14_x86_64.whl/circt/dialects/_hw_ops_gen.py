...
def struct_extract(result, input, field, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(StructExtractOp(result=result, input=input, field=field, loc=loc, ip=ip))
...
def struct_inject(input, field, new_value, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(StructInjectOp(input=input, field=field, newValue=new_value, loc=loc, ip=ip))
...
def union_create(result, field, input, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(UnionCreateOp(result=result, field=field, input=input, loc=loc, ip=ip))
...
def union_extract(input, field, *, loc=None, ip=None) -> _ods_ir.OpResult:
  return _get_op_result_or_op_results(UnionExtractOp(input=input, field=field, loc=loc, ip=ip))
