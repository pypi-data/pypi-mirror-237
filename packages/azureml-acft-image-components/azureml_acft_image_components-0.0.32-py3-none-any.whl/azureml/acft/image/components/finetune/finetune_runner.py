...
from azureml.acft.common_components.utils.mlflow_utils import fetch_mlflow_acft_metadata
...
def finetune_runner(component_args: Namespace) -> None:
    ...
    model_metafile_path = component_args.model_metafile_path if \
        hasattr(component_args, "model_metafile_path") else None
    ...
    # fetch metadata to be dumped in MLmodel file
    metadata = fetch_mlflow_acft_metadata(is_finetuned_model=True,
                                          base_model_name=component_args.model_name)
