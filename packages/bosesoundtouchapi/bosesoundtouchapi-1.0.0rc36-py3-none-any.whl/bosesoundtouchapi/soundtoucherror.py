...
class SoundTouchError(Exception):
    ...
    """
    def __init__(self, message:str, name:str, severity:str, errorCode:str, logsi:SISession=None) -> None:
        """
    ...
    def ToString(self) -> str:
        ...
        msg = '%s, code="%s"' % (msg, str(self._ErrorCode))
        msg = '%s, name="%s"' % (msg, str(self._Name))
        msg = '%s, severity="%s"' % (msg, str(self._Severity))
        return msg 
