...
class KiteConnectBrowser(KiteConnect):
    """
    Code borrowed from: https://github.com/jugaad-py/jugaad-trader/blob/master/jugaad_trader/zerodha.py
    """
    _default_root_uri = "https://kite.zerodha.com"

    def __init__(self, user_id=None, password=None, pin=None, google_authenticator_secret=None):

        self.user_id = user_id
        self.password = password
        self.pin = pin
        self.google_authenticator_secret = google_authenticator_secret
    ...
    def login_step2(self, j):
        data = {"user_id": self.user_id, "request_id": j['data']["request_id"],
                "twofa_value": get_totp(self.google_authenticator_secret) if self.pin is None else self.pin}
    ...
    def ticker(self, api_key='kitefront', enctoken=None, userid=None):
        ...
        return KiteTicker(api_key=api_key, access_token=self.enc_token + '&user_id=' + self.user_id,
                          root='wss://ws.zerodha.com')


class Console(KiteConnectBrowser):
    """
    ...
    def __init__(self, z):
        ...
        super().__init__(z.user_id, z.password, z.pin, z.google_authenticator_secret)
    ...
    def factory_functions(self, route, docstring=""):
        """
            ...
            data, hence creating a factory function which will generate a
