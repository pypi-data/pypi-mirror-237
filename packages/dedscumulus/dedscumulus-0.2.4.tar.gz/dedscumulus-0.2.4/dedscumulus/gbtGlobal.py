...
def getSiteAccesses(greenbyte_client,QUERY_PARAMS,LOGGER):
    ...
    while tries<3:
        try:
            ...
            return greenbyte_client.plan.list_site_accesses(QUERY_PARAMS['deviceIds'],QUERY_PARAMS['timestampStart'],QUERY_PARAMS['timestampFinish'],QUERY_PARAMS['categories'],
                                                          QUERY_PARAMS['lostProductionSignalId'],None,None,False,QUERY_PARAMS['pageSize'],QUERY_PARAMS['page'],False,'custom')
        except Exception as ge:
            tries+=1
