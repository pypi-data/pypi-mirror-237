...
@dataclass
class ReferencedInExperimentContainer:
    """
    Contains information about the reference of a dataset in an ExperimentContainer.

    Attributes
    ----------
    added_to_experiment_container_by : User
        User who added the dataset to the experiment container.
    added_to_experiment_container_at : datetime
        Time when the dataset was added to the experiment container.
    """
...
REFERENCED_IN_EXPERIMENT_CONTAINER_TRAFARET = t.Dict(
    {
        t.Key("added_to_experiment_container_by"): USER_TRAFARET,
        t.Key("added_to_experiment_container_at"): t.String(),
    }
).ignore_extra("*")
...
class DatasetInfo:
    ...
    referenced_in_experiment_container : Optional[ReferencedInExperimentContainer]
        Information about the reference of this dataset in the experiment container. This
        information will only be present if the experiment_container_id was passed to
        ``ModelLineage.get``.
    """
    ...
    number_of_features: int
    number_of_feature_by_type: List[FeatureCountByType]
    referenced_in_experiment_container: Optional[ReferencedInExperimentContainer] = None
...
DATASET_INFO_TRAFARET = t.Dict(
    {
        ...
        t.Key(
            "referenced_in_experiment_container", optional=True
        ): REFERENCED_IN_EXPERIMENT_CONTAINER_TRAFARET,
    }
).ignore_extra("*")
...
class FeaturelistInfo:
    ...
    def __repr__(self) -> str:
        return (
            f"{self.__class__.__name__}(featurelist_name={self.featurelist_name}, "
            f"featurelist_id={self.featurelist_id})"
        )
...
TARGET_INFO_TRAFARET = t.Dict(
    {
        ...
        t.Key("positive_class_label", optional=True): t.String() | t.Float() | t.Int(),
...
PARTITION_INFO_TRAFARET = t.Dict(
    {
        ...
        t.Key("cv_holdout_level", optional=True): t.String() | t.Float() | t.Int(),
        t.Key("holdout_level", optional=True): t.String() | t.Float() | t.Int(),
        t.Key("user_partition_col", optional=True): t.String(),
        t.Key("training_level", optional=True): t.String() | t.Float() | t.Int(),
        t.Key("partition_key_cols", optional=True): t.List(t.String()),
        t.Key("validation_level", optional=True): t.String() | t.Float() | t.Int(),
...
class ModelInfo:
    ...
    sample_size : Optional[int]
        Numer of rows this model was trained on.
    ...
    def __repr__(self) -> str:
        return (
            f"{self.__class__.__name__}(model_type={self.model_type}, "
...
class ModelLineage(APIObject):
    ...
    @classmethod
    def get(cls, model_id: str, experiment_container_id: Optional[str] = None) -> "ModelLineage":
        """
        Retrieve lineage information about a trained model. If you pass the optional
        ``experiment_container_id`` parameter, this class will contain additional information.

        Parameters
        ----------
        model_id : str
            Model Id.
        experiment_container_id : Optional[str]
        ...
        params = {}
        if experiment_container_id is not None:
            params["experiment_container_id"] = experiment_container_id
    ...
    def _construct_featurelist_info(featurelist: Dict[str, Any]) -> FeaturelistInfo:
        return FeaturelistInfo(
            ...
            number_of_feature_by_type=[
                FeatureCountByType(**t) for t in featurelist["number_of_feature_by_type"]
            ],
            number_of_features_with_missing_values=featurelist[
            ...
            features_with_most_missing_values=[
                FeatureWithMissingValues(**f)
                for f in featurelist["features_with_most_missing_values"]
            ],
    ...
    @classmethod
    def _construct_dataset_info(
        cls, dataset: Optional[Dict[str, Any]] = None
        ...
        referenced_in_experiment_container = dataset.get("referenced_in_experiment_container")
        _referenced_in_experiment_container = None
        if referenced_in_experiment_container is not None:
            _referenced_in_experiment_container = ReferencedInExperimentContainer(
                added_to_experiment_container_by=cls._construct_user_from_api_data(
                    referenced_in_experiment_container["added_to_experiment_container_by"]
                ),
                added_to_experiment_container_at=pd.to_datetime(
                    referenced_in_experiment_container["added_to_experiment_container_at"]
                ).to_pydatetime(),
            )
        ...
        return DatasetInfo(
            ...
            number_of_feature_by_type=[
                FeatureCountByType(**t) for t in dataset["number_of_feature_by_type"]
            ],
            referenced_in_experiment_container=_referenced_in_experiment_container,
        )
