...
class ComparisonPrompt(APIObject):
    ...
    def get(cls, comparison_prompt: Union[ComparisonPrompt, str]) -> ComparisonPrompt:
        ...
        comparison_prompt : str
            The comparision prompt you want to retrieve. Accepts entity or ID.
    ...
    def update(
        cls,
        comparison_prompt: Union[ComparisonPrompt, str],
        additional_llm_blueprints: List[Union[LLMBlueprint, str]],
        wait_for_completion: bool = False,
    ) -> ComparisonPrompt:
        """
        Update a comparison prompt.

        Parameters
        ----------
        comparison_prompt: ComparisonPrompt or str
            The comparison prompt you want to update.
    ...
    @classmethod
    def delete(cls, comparison_prompt: Union[ComparisonPrompt, str]) -> None:
        """
        Delete a single comparison prompt.

        Parameters
        ----------
        comparison_prompt : ComparisonPrompt or str
            The comparison prompt you want to delete. Accepts entity or ID.
        """
        url = f"{cls._client.domain}/{cls._path}/{_get_genai_entity_id(comparison_prompt)}/"
