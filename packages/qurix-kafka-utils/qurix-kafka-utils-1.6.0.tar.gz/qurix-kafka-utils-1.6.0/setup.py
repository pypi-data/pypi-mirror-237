...
main_ns = {}
with open("qurix/kafka/utils/__version__.py", "r") as file_handler:
...
setup(
    ...
    description="qurix generic utils for kafka",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/qurixtechnology/qurix-kafka-utils.git",
