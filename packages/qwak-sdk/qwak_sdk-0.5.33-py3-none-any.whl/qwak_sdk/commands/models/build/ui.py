import click
from qwak.inner.build_config.build_config_v1 import ModelUri, RemoteBuildResources, BuildProperties, DockerConf, \
    BuildConfigV1
...
def build(
    ...
    **kwargs,
    ...
    if out_conf:
        ...
        use_git_credentials = kwargs.get("use_git_credentials")
        id_only = kwargs.get("id_only")
        return execute_build_pipeline(
            config=config,
            json_logs=json_logs,
            programmatic=programmatic,
            use_git_credentials=use_git_credentials,
            id_only=id_only,
        )
