    ...
    def copy_model(
        ...
        if custom_dependencies_path:
            ...
            if git_custom_dependencies_path.is_file():
                ...
                self.build_logger.debug("Custom dependency file copied from git repository")
...
def get_git_remote_uri(build_logger: BuildLogger, url: str, git_credentials: str) -> str:
    if git_credentials:
