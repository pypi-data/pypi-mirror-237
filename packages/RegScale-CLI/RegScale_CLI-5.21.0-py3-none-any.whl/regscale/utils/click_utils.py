...
def find_file_path_parameters(
    group: Union[click.Group, click.Command], prefix: str = None
) -> dict:
    ...
    :returns: a dictionary of file path parameters
    :rtype: dict
    """
    file_path_parameters = {}

    def add_to_dict(_key: str, _param: Any):
        """Helper function to add to the dictionary
        :param _key: the key to add to the dictionary
        :param _param: the parameter to add to the dictionary
        :returns: None
        :rtype: None
        """
