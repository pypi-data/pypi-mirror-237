...
def create_alert_assessment(
    ...
    :param Api api: RegScale API object
    :param str parent_module: Parent module of the assessment, defaults to None
    :param int parent_id: Parent ID of the assessment, defaults to None
...
def create_alert_issues(
    ...
    :param parent_module: Parent module of the assessment, defaults to None
    :param parent_id: Parent ID of the assessment, defaults to None
    :return: None
    """
...
def get_and_create_dependabot_alerts(
    ...
    :param int parent_id: RegScale ID, defaults to None
    :param str parent_module: RegScale Module, defaults to None
    :return: None
    """
    app = Application()
    api = Api(app)
...
def create_alerts(
    regscale_id: Optional[int] = None, regscale_module: Optional[str] = None
) -> None:
    """
    Create an assessment and child issues in RegScale from Dependabot alerts.
    """
