...
model_path = 'https://drive.google.com/uc?id=1xk3ei6v8qzpeFN9SZXUzQO6ra0tMsdvR'


def init_nike_model():
    # Load a model
    output = 'best_old.pt'
    gdown.download(model_path, output, quiet=False)

    # url = 'https://drive.google.com/uc?id=18PLkDxN54ogNKCpZA9P7abEq-gKJSUVX'
    # output = 'yolov8x.pt'
