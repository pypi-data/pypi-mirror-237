...
class Houston:
    ...
    def http_trigger(self, data: dict):
        ...
        if service_auth_requirement is not None:
            # TODO: give an example of the specific authentication requirement for the service. The current example
            #       is only for Bearer auth for HTTP triggered services
