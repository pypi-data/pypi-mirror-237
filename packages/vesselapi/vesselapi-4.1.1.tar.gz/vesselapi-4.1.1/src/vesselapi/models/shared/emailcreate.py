...
class EmailCreateContactRole(str, Enum):
    FROM = 'from'
    TO = 'to'
    CC = 'cc'
    BCC = 'bcc'
...
class EmailCreateContact:
    ...
    role: Optional[EmailCreateContactRole] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('role'), 'exclude': lambda f: f is None }})
    


class EmailCreateLeadRole(str, Enum):
    FROM = 'from'
    TO = 'to'
    CC = 'cc'
    BCC = 'bcc'
...
class EmailCreateLead:
    ...
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is None }})
    role: Optional[EmailCreateLeadRole] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('role'), 'exclude': lambda f: f is None }})
