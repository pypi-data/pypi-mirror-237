#https://github.com/johnblay/colorfill
#from colorfill import *
#u can use it like this

#red,blue,orange,etc

#from colorfill import Colors, Colorate
...
#print(Colors.yellow+"Hello world")

#print(Colors.green+"Hello world")
...
#from colorfill import Write, Colors
