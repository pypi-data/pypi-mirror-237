...
def transpose2d(input_matrix: Matrix) -> Matrix:
    ...
    Returns:
    - Optional (Matrix): The transposed matrix as a 2D list of floats or None in case of error.
    ...
    try:
        ...
        raise Exception("Error in transposition operation: ", str(e))
...
def window1d(
    ...
    try:
        ...
        raise Exception("Error occurred performing windowing: ", str(e))


def validate_inputs(input_matrix: Matrix2D, kernel: Matrix2D, stride: int) -> None:
    """
    Helper function to validate convolution operation's inputs.
    """
    ...
    if (
        ...
        raise TypeError("input_matrix and kernel must be 2D np.ndarray.")
...
def convolution2d(
    ...
    """
    Compute the 2D cross-correlation between the input matrix and kernel, by sliding the kernel over
    the input matrix and computing the sum of element-wise products at each position.
    ...
    Returns:
    - Matrix2D: 2D numpy array representing the result of the cross-correlation operation between
    the input matrix and the kernel.
    ...
    # Validate the inputs
    validate_inputs(input_matrix, kernel, stride)
    ...
    try:
        ...
        raise Exception("Error occurred performing convolution: ", str(e))
