...
def before_test(request):
    ...
    pytest.logger.info(
        f"driver window size: Width--> {driver.get_window_size().get('width')}  ::  Height --> {driver.get_window_size().get('height')} ")
    ...
    pytest.logger.info(
        f"Driver window full screen ::  window size: Width--> {driver.get_window_size().get('width')}  ::  Height --> {driver.get_window_size().get('height')} ")
