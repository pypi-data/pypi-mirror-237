...
import pytest
from dcentralab_qa_infra_automation.pages.metamaskPages.ConfirmPage import ConfirmPage as MetamaskConfrimPage
...
class MetamaskActions(WalletsActionsInterface):
    ...
    def __init__(self, driver):
        ...
        self.metamask_confirm_page = MetamaskConfrimPage(self.driver)
    ...
    def import_wallet(self):
        ...
        self.logger.info("tab to import wallet opened")
        # Focus on the new tab window
        self.driver.switch_to.window(self.driver.window_handles[1])
        self.logger.info("switch tab successfully")
        # Open chrome extension
        self.driver.get(pytest.properties.get("metamask.connect.url"))
        self.logger.info("navigating to metamask - Import Wallet")
