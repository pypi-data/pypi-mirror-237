...
IMPORT_WALLET_CONTAINER_TITLE = (By.CSS_SELECTOR, "[data-testid='import-wallet-container'] h3")
...
class ImportWalletPage(BasePage):
    ...
    def is_page_loaded(self):
        ...
        return self.is_element_exist("IMPORT_WALLET_CONTAINER",
                                     IMPORT_WALLET_CONTAINER) is True and "Import Wallet" in self.get_text(
            "IMPORT_WALLET_CONTAINER_TITLE", IMPORT_WALLET_CONTAINER_TITLE) and self.is_element_exist(
            "SEED_PHRASE_INPUT", SEED_PHRASE_INPUT) is True and self.is_button_enable("IMPORT_WALLET_BTN",
                                                                                      IMPORT_WALLET_BTN) is False
