...
```
cd existing_repo
git remote add origin https://gitlab.com/DcentraLab/qa/auto-qa-pip.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/DcentraLab/qa/auto-qa-pip/-/settings/integrations)
