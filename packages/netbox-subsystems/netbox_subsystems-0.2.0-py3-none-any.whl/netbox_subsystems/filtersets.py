...
from utilities.filters import TreeNodeMultipleChoiceFilter, ContactModelFilterSet
from .models import Subsystem, SystemGroup, System
...
class SubsystemFilterSet(NetBoxModelFilterSet):
