...
class SystemForm(NetBoxModelForm):
    ...
    class Meta:
        model = System
        fields = ('name', 'slug', 'group', 'parent', 'type', 'tenant', 'system_security_id', 'description', 'tags')
...
class SubsystemForm(NetBoxModelForm):
    ...
    class Meta:
        model = Subsystem
        fields = ('name', 'parent', 'type', 'system', 'system_security_id', 'comments', 'tags')
...
class SystemFilterForm(NetBoxModelFilterSetForm):
    ...
    system_security_id = forms.CharField(
        label='SSID',
        required=False
    )
    parent_id = DynamicModelMultipleChoiceField(
