...
urlpatterns = (
    ...
    # system-groups
    path('system-groups/', SystemGroupListView.as_view(), name='system-groups_list'),
    path('system-groups/add/', SystemGroupEditView.as_view(), name='system-groups_add'),
    path('system-groups/<int:pk>/', SystemGroupView.as_view(), name='system-groups'),
    path('system-groups/<int:pk>/edit/', SystemGroupEditView.as_view(), name='system-groups_edit'),
    path('system-groups/<int:pk>/delete/', SystemGroupDeleteView.as_view(), name='system-groups_delete'),
    path('system-groups/<int:pk>/changelog/', ObjectChangeLogView.as_view(), name='system-groups_changelog', kwargs={
        'model': SystemGroup
    }),
    # subsystems
