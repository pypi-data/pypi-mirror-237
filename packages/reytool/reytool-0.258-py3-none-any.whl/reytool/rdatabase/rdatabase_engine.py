...
class REngine(object):
    ...
    def exe(self):
        ...
        # Import.
        from .rdatabase_execute import RExecute
    ...
    def info(self):
        ...
        # Import.
        from .rdatabase_information import RISchema


        # Build.
        rschema = RISchema(self)
    ...
    def build(self):
        ...
        # Import.
        from .rdatabase_build import RBuild
    ...
    def status(self):
        ...
        # Import.
        from .rdatabase_parameter import RPStatus


        # Build.
        rstatus = RPStatus(self, False)
    ...
    def variables(self):
        ...
        # Import.
        from .rdatabase_parameter import RPVariable


        # Build.
        rvariables = RPVariable(self, False)
    ...
    def global_variables(self):
        ...
        # Build.
        rvariables = RPVariable(self, True)
