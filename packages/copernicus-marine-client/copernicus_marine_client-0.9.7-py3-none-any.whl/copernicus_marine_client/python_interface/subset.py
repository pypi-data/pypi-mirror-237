...
@deprecated_python_option(minimal_longitude="minimum_longitude")
@deprecated_python_option(maximal_longitude="maximum_longitude")
@deprecated_python_option(minimal_latitude="minimum_latitude")
@deprecated_python_option(maximal_latitude="maximum_latitude")
@deprecated_python_option(minimal_depth="minimum_depth")
@deprecated_python_option(maximal_depth="maximum_depth")
@log_exception_and_exit
def subset(
