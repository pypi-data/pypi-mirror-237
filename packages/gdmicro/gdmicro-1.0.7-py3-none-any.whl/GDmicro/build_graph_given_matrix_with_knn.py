...
#o=open('tem_check/log.txt','w+')
#check_trans_visualize_graph('Test_datasets/IBD_metaphlan2_merge_nl/IBD_meta.tsv','GDmicro_test/IBD_test_nl/Graph_File/Fold1/P3_build_graph/eggNOG_pca_knn_graph_ini.txt','tem_check','tem',o)
