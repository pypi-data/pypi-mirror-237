...
function GetOciCommandsToLongParams_mysql() {
    $ociCommandsToLongParams = @{
        ...
        'mysql db-system list' = 'all compartment-id configuration-id db-system-id display-name from-json help is-heatwave-cluster-attached is-up-to-date lifecycle-state limit page page-size sort-by sort-order'
