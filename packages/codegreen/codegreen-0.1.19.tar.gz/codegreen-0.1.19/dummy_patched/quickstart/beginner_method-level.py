...
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.models.Sequential(x_train[:1]).numpy()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 13}, method_object=model, function_args=None, function_kwargs=None)
predictions
...
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.nn.softmax(predictions).numpy()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 15}, method_object=None, function_args=None, function_kwargs=None)
...
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.losses.SparseCategoricalCrossentropy()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 16}, method_object=None, function_args=None, function_kwargs={'from_logits': True})
...
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.losses.SparseCategoricalCrossentropy(y_train[:1], predictions).numpy()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 17}, method_object=loss_fn, function_args=None, function_kwargs=None)
...
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.models.Sequential.compile()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 18}, method_object=model, function_args=None, function_kwargs={'optimizer': 'adam', 'loss': loss_fn, 'metrics': ['accuracy']})
...
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.models.Sequential.fit()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 21}, method_object=model, function_args=[x_train, y_train], function_kwargs={'epochs': 5})
...
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.models.Sequential.evaluate()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 22}, method_object=model, function_args=[x_test, y_test], function_kwargs={'verbose': 2})
...
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.Sequential()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 23}, method_object=None, function_args=[[model, tf.keras.layers.Softmax()]], function_kwargs=None)
start_times_INSERTED_INTO_SCRIPT = before_execution_INSERTED_INTO_SCRIPT(experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.Sequential()')
probability_model(x_test[:5])
after_execution_INSERTED_INTO_SCRIPT(start_times=start_times_INSERTED_INTO_SCRIPT, experiment_file_path=EXPERIMENT_FILE_PATH, function_to_run='tensorflow.keras.Sequential()', project_metadata={'script_path': '/home/saurabh/method-energy-dataset/dummy_patched/quickstart/beginner.ipynb', 'api_call_line': 27}, method_object=probability_model, function_args=[x_test[:5]], function_kwargs=None)