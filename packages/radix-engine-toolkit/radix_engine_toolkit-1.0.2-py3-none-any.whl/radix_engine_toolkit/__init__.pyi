...
class Hash:
    def __init__(self, hash: typing.List[int]) -> None: ...
    def __del__(self) -> None: ...
    @classmethod
...
class ManifestBuilder:
    def __init__(self) -> None: ...
    def __del__(self) -> None: ...
    def access_controller_initiate_recovery(
        self,
        access_controller_address: Address,
        proposer: Proposer,
        proposed_primary_role: AccessRule,
        proposed_recovery_role: AccessRule,
        proposed_confirmation_role: AccessRule,
        proposed_timed_recovery_delay_in_minutes: typing.Optional[int],
    ) -> ManifestBuilder: ...
    def access_controller_quick_confirm_recovery(
        self,
        access_controller_address: Address,
        proposer: Proposer,
        proposed_primary_role: AccessRule,
    ...
    def account_add_authorized_depositor(
        self, account_address: Address, badge: ResourceOrNonFungible
    ) -> ManifestBuilder: ...
    def account_burn(
        self, account_address: Address, resource_address: Address, amount: Decimal
    ) -> ManifestBuilder: ...
    ...
    def account_deposit(
        self, account_address: Address, bucket: ManifestBuilderBucket
    ) -> ManifestBuilder: ...
    def account_deposit_batch(
        self, account_address: Address, buckets: typing.List[ManifestBuilderBucket]
    ) -> ManifestBuilder: ...
    def account_deposit_entire_worktop(
        self, account_address: Address
    ) -> ManifestBuilder: ...
    def account_lock_contingent_fee(
        self, account_address: Address, amount: Decimal
    ) -> ManifestBuilder: ...
    ...
    def account_remove_resource_preference(
        self, account_address: Address, resource_address: Address
    ) -> ManifestBuilder: ...
    def account_securify(self, account_address: Address) -> ManifestBuilder: ...
    def account_set_default_deposit_rule(
        self, account_address: Address, default_deposit_rule: AccountDefaultDepositRule
    ) -> ManifestBuilder: ...
    ...
    def create_access_controller_with_securify_structure(
        self,
    ...
    def create_signature_based_access_controller(
        self,
        controlled_asset: ManifestBuilderBucket,
    ...
    def publish_package(
        self, code: typing.List[int], definition: typing.List[int], metadata: dict
    ) -> ManifestBuilder: ...
    ...
    def set_role(
        self, address: Address, module: ObjectModuleId, role_key: str, rule: AccessRule
    ) -> ManifestBuilder: ...
...
class PrivateKey:
    def __init__(self, bytes: typing.List[int], curve: Curve) -> None: ...
    def __del__(self) -> None: ...
    @classmethod
    ...
    def public_key(self) -> PublicKey: ...
    def public_key_bytes(self) -> typing.List[int]: ...
    def raw(self) -> typing.List[int]: ...
...
class TransactionManifest:
    def __init__(
        self, instructions: Instructions, blobs: typing.List[typing.List[int]]
    ) -> None: ...
    def __del__(self) -> None: ...
    @classmethod
    def decompile(cls, compiled: typing.List[int], network_id: int): ...
    ...
    def analyze_execution(
        self, transaction_receipt: typing.List[int]
    ) -> ExecutionAnalysis: ...
    ...
    def parse_transfer_information(
        self, allow_lock_fee_instructions: bool
    ) -> typing.Optional[TransferTransactionType]: ...
...
class AuthorizedDepositorsChanges:
    added: typing.List[ResourceOrNonFungible]
    removed: typing.List[ResourceOrNonFungible]
...
class ClaimStakeInformation:
    from_account: Address
    validator_address: Address
    claim_nft_resource: Address
    claim_nft_local_ids: typing.List[NonFungibleLocalId]
    claimed_xrd: Decimal
    def __init__(
        self,
        from_account,
...
class _UniffiConverterTypeClaimStakeInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf): ...
    @staticmethod
    def write(value, buf) -> None: ...
...
class ExecutionAnalysis:
    ...
    transaction_types: typing.List[TransactionType]
    reserved_instructions: typing.List[ReservedInstruction]
    def __init__(
        self, fee_locks, fee_summary, transaction_types, reserved_instructions
    ) -> None: ...
    def __eq__(self, other): ...
...
class StakeInformation:
    from_account: Address
    validator_address: Address
    stake_unit_resource: Address
...
class _UniffiConverterTypeStakeInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf): ...
    @staticmethod
    def write(value, buf) -> None: ...
...
class TransferTransactionType:
    transfers: dict
    def __init__(self, _from, transfers) -> None: ...
    def __eq__(self, other): ...

class _UniffiConverterTypeTransferTransactionType(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf): ...
    @staticmethod
    def write(value, buf) -> None: ...
...
class UnstakeInformation:
    from_account: Address
    stake_unit_address: Address
    stake_unit_amount: Decimal
    validator_address: Address
    claim_nft_resource: Address
    claim_nft_local_id: NonFungibleLocalId
    claim_nft_data: UnstakeData
    def __init__(
        self,
        from_account,
        stake_unit_address,
...
class _UniffiConverterTypeUnstakeInformation(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf): ...
    @staticmethod
    def write(value, buf) -> None: ...
...
class DecimalSource:
    ...
    class PREDICTED:
        ...
        value: Decimal
        def __init__(self, instruction_index, value) -> None: ...
        def __eq__(self, other): ...
...
class ResourceTracker:
    ...
    class NON_FUNGIBLE:
        ...
        def __init__(self, resource_address, amount, ids) -> None: ...
        def __eq__(self, other): ...
...
class TransactionType:
    ...
    class SIMPLE_TRANSFER:
        ...
        def __init__(self, _from, to, transferred) -> None: ...
        def __eq__(self, other): ...
    ...
    class ACCOUNT_DEPOSIT_SETTINGS:
        resource_preference_changes: dict
        default_deposit_rule_changes: dict
        authorized_depositors_changes: dict
        def __init__(
            self,
    ...
    class STAKE_TRANSACTION:
        stakes: typing.List[StakeInformation]
        def __init__(self, stakes) -> None: ...
        def __eq__(self, other): ...

    class UNSTAKE_TRANSACTION:
        unstakes: typing.List[UnstakeInformation]
        def __init__(self, unstakes) -> None: ...
        def __eq__(self, other): ...

    class CLAIM_STAKE_TRANSACTION:
        claims: typing.List[ClaimStakeInformation]
        def __init__(self, claims) -> None: ...
        def __eq__(self, other): ...

    class GENERAL_TRANSACTION:
        account_proofs: typing.List[Address]
        account_withdraws: dict
        account_deposits: dict
        addresses_in_manifest: dict
        metadata_of_newly_created_entities: dict
        data_of_newly_minted_non_fungibles: dict
        addresses_of_newly_created_entities: typing.List[Address]
        def __init__(
            self,
            account_proofs,
            account_withdraws,
    ...
    def is_stake_transaction(self) -> bool: ...
    def is_unstake_transaction(self) -> bool: ...
    def is_claim_stake_transaction(self) -> bool: ...
...
class _UniffiConverterOptionalTypeTransferTransactionType(_UniffiConverterRustBuffer):
    @classmethod
    def write(cls, value, buf) -> None: ...
    @classmethod
    def read(cls, buf): ...
...
class _UniffiConverterSequenceTypeClaimStakeInformation(_UniffiConverterRustBuffer):
    @classmethod
    def write(cls, value, buf) -> None: ...
    @classmethod
    def read(cls, buf): ...
...
class _UniffiConverterSequenceTypeStakeInformation(_UniffiConverterRustBuffer):
    @classmethod
    def write(cls, value, buf) -> None: ...
    @classmethod
    def read(cls, buf): ...

class _UniffiConverterSequenceTypeUnstakeInformation(_UniffiConverterRustBuffer):
    @classmethod
    def write(cls, value, buf) -> None: ...
    @classmethod
    def read(cls, buf): ...
...
class _UniffiConverterMapStringTypeAuthorizedDepositorsChanges(
    _UniffiConverterRustBuffer
):
    @classmethod
    def write(cls, items, buf) -> None: ...
...
class _UniffiConverterMapStringMapStringTypeResourcePreferenceAction(
    _UniffiConverterRustBuffer
):
    @classmethod
    def write(cls, items, buf) -> None: ...
...
class _UniffiConverterMapStringMapTypeNonFungibleLocalIdSequenceUInt8(
    _UniffiConverterRustBuffer
):
    @classmethod
    def write(cls, items, buf) -> None: ...
...
class _UniffiConverterMapTypeNonFungibleLocalIdSequenceUInt8(
    _UniffiConverterRustBuffer
):
    @classmethod
    def write(cls, items, buf) -> None: ...
...
def non_fungible_local_id_sbor_decode(
    bytes: typing.List[int],
) -> NonFungibleLocalId: ...
def non_fungible_local_id_sbor_encode(
    value: NonFungibleLocalId,
) -> typing.List[int]: ...
