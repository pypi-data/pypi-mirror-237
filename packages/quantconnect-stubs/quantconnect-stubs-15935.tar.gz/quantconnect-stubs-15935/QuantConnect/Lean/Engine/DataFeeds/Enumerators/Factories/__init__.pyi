...
class FineFundamentalSubscriptionEnumeratorFactory(System.Object, QuantConnect.Data.ISubscriptionEnumeratorFactory):
    ...
    def __init__(self, isLiveMode: bool, objectStore: QuantConnect.Interfaces.IObjectStore, tradableDaysProvider: typing.Callable[[QuantConnect.Data.UniverseSelection.SubscriptionRequest], System.Collections.Generic.IEnumerable[datetime.datetime]] = None) -> None:
        """
        ...
        :param tradableDaysProvider: Function used to provide the tradable dates to the enumerator. Specify null to default to SubscriptionRequest.TradableDaysInDataTimeZone
        """
        ...
