...
def upload_files(suite_id: str, data: Dict[str, Any]):
    ...
    for test in data["tests"]:
        ...
        if "file_sample_output" in test:
            file_path = test["file_sample_output"]
            files[file_path] = upload_file(suite_id, file_path)
    return files
...
def add_tests(data, files, suite_id):
    ...
    for test in data["tests"]:
        ...
        if "sample_output" in test:
            sample_output = test["sample_output"]
            sample_output_type = "raw"
        elif "file_sample_output" in test:
            sample_output = files[test["file_sample_output"]]
            sample_output_type = "file"
        else:
            sample_output = ""
            sample_output_type = "raw"
        ...
        mutation addUpdateTest {{
              updateTest(
                  ...
                  sampleOutputType: "{sample_output_type}",
                  checks: {checks}, 
