    ...
    def income_detection(self,res_json):
        ...
        # try:
            ...
            if len(groups) > 0 and groups:
                ...
                with importlib.resources.open_text("bankstatementextractor", "global_percentiles.json") as file:
                    global_percentiles = json.load(file)  
                # with open("./bankstatementextractor/global_percentiles.json", "r") as f:
                ...
                # qt_model=importlib.resources.read_binary("bankstatementextractor", "qt.pkl")
                # qt = pickle.loads(qt_model)
                    # global_percentiles = json.load(file)  
                qt_file_path = os.path.join(script_dir, 'qt.pkl')
                qt = load(open(qt_file_path, 'rb'))
