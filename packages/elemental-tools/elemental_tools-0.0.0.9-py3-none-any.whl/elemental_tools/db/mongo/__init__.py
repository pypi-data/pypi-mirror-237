...
class Index:
	...
	def __init__(self, fields: list, unique: bool = False, order: str = 'asc'):
...
class Connect:
	def __init__(self, uri: str, environment: str = None):
	...
	def collection(self, collection_name):
		...
		:return success: Returns The collection for the given collection name
	...
	def set_index(self, collection_name, _index_specs: Index):
		...
		_index = [
			IndexModel([(_i, _index_specs.order) for _i in _index_specs.fields], unique=_index_specs.unique),
		]
