...
PACKAGE_NAME = 'deftools'
PACKAGE_VERSION = '1.0.1'
PACKAGE_AUTHOR = 'Hao Hoang'
PACKAGE_AUTHOR_EMAIL = 'haohoangofficial@gmail.com'
PACKAGE_URL = 'https://github.com/haohoangofficial/deftools'
PACKAGE_DOWNLOAD_URL = \
    'https://github.com/haohoangofficial/deftools/tarball/' + PACKAGE_VERSION
PACKAGES = [
    'deftools'
]
PACKAGE_DATA = {
...
PACKAGE_DESCRIPTION = 'Python Tools'
