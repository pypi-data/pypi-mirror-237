...
class GridSearchCV(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._handlers: FitPredictHandlers = HandlersImpl(class_name=GridSearchCV.__class__.__name__, subproject=_SUBPROJECT, autogenerated=True, wrapper_provider=SklearnModelSelectionWrapperProvider())
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "GridSearchCV":
        """
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.model_selection.GridSearchCV.score]
