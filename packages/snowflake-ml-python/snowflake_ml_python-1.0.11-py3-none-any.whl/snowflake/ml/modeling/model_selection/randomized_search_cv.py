...
from snowflake.ml.modeling._internal.snowpark_handlers import SklearnModelSelectionWrapperProvider
...
class RandomizedSearchCV(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        deps = set(SklearnModelSelectionWrapperProvider().dependencies)
        ...
        self._handlers: FitPredictHandlers = HandlersImpl(class_name=RandomizedSearchCV.__class__.__name__, subproject=_SUBPROJECT, autogenerated=True, wrapper_provider=SklearnModelSelectionWrapperProvider())
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "RandomizedSearchCV":
        """
    ...
    def _get_output_column_names(self, output_cols_prefix: str, output_cols: Optional[List[str]] = None) -> List[str]:
        ...
        if output_cols:
            return [f"{output_cols_prefix}{identifier.resolve_identifier(c)}" for c in output_cols]
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.model_selection.RandomizedSearchCV.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.RandomizedSearchCV.html#sklearn.model_selection.RandomizedSearchCV.score)
