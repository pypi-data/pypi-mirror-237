...
from snowflake.ml.modeling._internal.snowpark_handlers import LightGBMWrapperProvider
...
class LGBMClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        **kwargs,
        ...
        deps = set(LightGBMWrapperProvider().dependencies)
        ...
        self._handlers: FitPredictHandlers = HandlersImpl(class_name=LGBMClassifier.__class__.__name__, subproject=_SUBPROJECT, autogenerated=True, wrapper_provider=LightGBMWrapperProvider())
