...
from process_twarc.train.util import load_datasets, init_run, reinit_run, check_if_complete, complete_trial, launch_study, print_run_init
...
def initiate_trial(
    ...
    def objective(trial):
        ...
        print_run_init(model, config, parameters, trainer, trial_checkpoint)
        trainer.train()
