...
class ModalClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AppPrepareSingleObject = channel.unary_unary(
                '/modal.client.ModalClient/AppPrepareSingleObject',
                request_serializer=modal__proto_dot_api__pb2.AppPrepareSingleObjectRequest.SerializeToString,
                response_deserializer=modal__proto_dot_api__pb2.AppPrepareSingleObjectResponse.FromString,
                )
...
class ModalClientServicer(object):
    ...
    def AppPrepareSingleObject(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ModalClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AppPrepareSingleObject': grpc.unary_unary_rpc_method_handler(
                    servicer.AppPrepareSingleObject,
                    request_deserializer=modal__proto_dot_api__pb2.AppPrepareSingleObjectRequest.FromString,
                    response_serializer=modal__proto_dot_api__pb2.AppPrepareSingleObjectResponse.SerializeToString,
            ),
...
class ModalClient(object):
    ...
    @staticmethod
    def AppPrepareSingleObject(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modal.client.ModalClient/AppPrepareSingleObject',
            modal__proto_dot_api__pb2.AppPrepareSingleObjectRequest.SerializeToString,
            modal__proto_dot_api__pb2.AppPrepareSingleObjectResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
