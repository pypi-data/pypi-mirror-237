...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def AppPrepareSingleObject(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.AppPrepareSingleObjectRequest, modal_proto.api_pb2.AppPrepareSingleObjectResponse]') -> None:
        pass

    @abc.abstractmethod
    async def AppDeploySingleObject(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.AppDeploySingleObjectRequest, google.protobuf.empty_pb2.Empty]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/modal.client.ModalClient/AppPrepareSingleObject': grpclib.const.Handler(
                self.AppPrepareSingleObject,
                grpclib.const.Cardinality.UNARY_UNARY,
                modal_proto.api_pb2.AppPrepareSingleObjectRequest,
                modal_proto.api_pb2.AppPrepareSingleObjectResponse,
            ),
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.AppPrepareSingleObject = grpclib.client.UnaryUnaryMethod(
            channel,
