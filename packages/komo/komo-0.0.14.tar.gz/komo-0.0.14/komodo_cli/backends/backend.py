...
from komodo_cli.types import Job, JobStatus, Machine, ClientException
...
class Backend(ABC):
    ...
    def vscode(self, job_id: str, node_index: int):
        raise ClientException("Support for VSCode for this type of backend is not supported yet, but coming soon!")
