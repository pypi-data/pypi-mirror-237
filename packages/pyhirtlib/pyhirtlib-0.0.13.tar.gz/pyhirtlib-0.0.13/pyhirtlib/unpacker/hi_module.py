...
class HiModule:
    def __init__(self, path_file: str):
        ...
        self.hiFileTagGlobalIdMap: {str, HiModuleFileEntry} = {}
        self.blocks = {}
    ...
    def getResourceOfFileAt(self, f, entry: HiModuleFileEntry, index:int)-> HiModuleFileEntry:
        r_index = self.__readResourceEntryIn(entry.First_resource_index + index)
        fileEntry = self.__readFileEntry(r_index)
