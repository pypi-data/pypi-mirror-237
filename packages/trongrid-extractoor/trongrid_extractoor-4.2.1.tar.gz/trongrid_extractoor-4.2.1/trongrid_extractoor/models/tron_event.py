...
KEYS_TO_STRIP_FROM_FLAT_DICT = ['datetime', 'ms_from_epoch', 'raw_event']
...
class TronEvent:
    ...
    datetime: Optional[pendulum.DateTime] = None  # Derived field; not passed in constructor
    ...
    def to_properties_dict(self) -> Dict[str, bool|float|int|str]:
        ...
        base_dict['block_written_at'] = self.datetime
    ...
    def __rich__(self) -> Text:
        ...
        txt = Text('[').append(str(self.datetime)).append('] ').append(self.event_name, style=color).append('\n')
