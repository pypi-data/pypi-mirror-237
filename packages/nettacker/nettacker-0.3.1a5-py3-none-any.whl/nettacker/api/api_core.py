...
import os
from nettacker.core.load_modules import load_all_modules, load_all_profiles
from nettacker.core.load_modules import load_all_graphs
...
def languages_to_country():
    ...
    """
    from nettacker.core.load_modules import load_all_languages
