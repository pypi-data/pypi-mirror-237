...
class Terminal:
    ...
    def trash_cat_choose_react(self, *args, **kwargs):
        self.posTrashTypes()
        new_clients = self.operator.get_trash_allowed_clients_by_trash_cat(self.chosenTrashCat)
    ...
    def posTrashTypes(self, a='a', b='b', c='c', d='d', e='e'):
        ...
        if self.chosenTrashCat == '':
            ...
            try:
                trashtypes = self.operator.get_trash_cats_types(self.operator.get_client_id(self.clientOm.get()))[self.chosenTrashCat]
            except KeyError:
                trashtypes = []
