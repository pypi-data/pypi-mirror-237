...
class UserAgentManager:
    def __init__(self, os=None, browser=None, version=None):
...
class SafeRequest:
    ...
    def __init__(self,
        ...
        self.ssl_manager = ssl_manager or SSLManager(ciphers=self.ciphers, ssl_options_list=self.ssl_options, certification=self.certification)
        self.tls_adapter=tls_adapter or  TLSAdapter(ssl_manager=self.ssl_manager,certification=self.certification,ssl_options_list=self.self.ssl_manager.ssl_options)
