...
from shootpandora.exts.hooks import hook_logging
from shootpandora.exts.token import check_access_token
from shootpandora.openai.auth import Auth0
...
class ChatBot:
    ...
    def __after_request(resp):
        resp.headers['X-Server'] = 'shootpandora-cloud/{}'.format(__version__)
        return resp
