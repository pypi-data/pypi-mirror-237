...
def send_slack_alert(info_alert_slack_webhook_url=None, red_alert_slack_webhook_url=None, slack_red_alert_userids=None, payload=None, is_red_alert=False):
    ...
    response_code = 500
    retry_count = 0
    while response_code != 200 and retry_count < 5:
