...
version_line = open("sensirion_i2c_sts3x/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_sts3x',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion STS3X sensor family',
    license='BSD',
    keywords="""Sensirion STS3X
        I2C
        STS30
        STS30A
        STS31A
