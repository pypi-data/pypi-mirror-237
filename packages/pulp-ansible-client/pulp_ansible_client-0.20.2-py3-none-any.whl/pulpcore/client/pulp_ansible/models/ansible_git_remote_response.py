...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, client_cert=None, headers=None, proxy_url=None, pulp_last_updated=None, rate_limit=None, hidden_fields=None, max_retries=None, name=None, url=None, ca_cert=None, sock_read_timeout=None, tls_validation=None, pulp_labels=None, connect_timeout=None, sock_connect_timeout=None, download_concurrency=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
