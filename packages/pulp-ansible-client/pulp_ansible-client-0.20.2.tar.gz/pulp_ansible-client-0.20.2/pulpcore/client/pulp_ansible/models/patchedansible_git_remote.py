...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, password=None, proxy_password=None, client_key=None, client_cert=None, headers=None, proxy_url=None, rate_limit=None, username=None, proxy_username=None, max_retries=None, name=None, url=None, ca_cert=None, sock_read_timeout=None, tls_validation=None, pulp_labels=None, connect_timeout=None, sock_connect_timeout=None, download_concurrency=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
