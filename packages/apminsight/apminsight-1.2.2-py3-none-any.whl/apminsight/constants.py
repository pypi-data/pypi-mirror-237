...
int_components = [ django_comp, flask_comp, middleware, jinja_comp, mako_comp, genshi_comp, cherrypy_comp, bottle_comp, pyramid_comp ]
ext_components = [ mysql_comp, redis_comp, memcache_comp, postgres_comp, cassandra_comp, http_comp, sqlite_comp ]
