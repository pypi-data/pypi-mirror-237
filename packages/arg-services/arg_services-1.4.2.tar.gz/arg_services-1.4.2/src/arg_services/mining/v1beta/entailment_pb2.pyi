...
class EntailmentQuery(google.protobuf.message.Message):
    ...
    @property
    def context(self) -> global___EntailmentQueryContext: ...
    def __init__(
        self,
        *,
        premise_id: builtins.str = ...,
        claim_id: builtins.str = ...,
        context: global___EntailmentQueryContext | None = ...,
    ) -> None: ...
...
@typing_extensions.final
class EntailmentQueryContext(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["adu_id", b"adu_id", "weight", b"weight"]) -> None: ...

global___EntailmentQueryContext = EntailmentQueryContext
