...
class JobsFilterSettings(sgqlc.types.Input):
    __schema__ = crawlers_api_schema
    __field_names__ = ('job_status', 'input_value', 'projects', 'crawlers', 'creators', 'updaters', 'system_registration_date', 'system_update_date', 'periodic_jobs', 'collection_statuses', 'job_ids', 'start_time', 'end_time')
...
class Crawler(sgqlc.types.Type, RecordInterface):
    __schema__ = crawlers_api_schema
    __field_names__ = ('id', 'name', 'title', 'description', 'crawler_type', 'last_collection_date', 'avg_performance_time', 'pinned', 'project', 'periodic_jobs_num', 'onetime_jobs_num', 'settings', 'args', 'analytics', 'histogram_items', 'histogram_requests', 'job_stats', 'current_version', 'start_urls')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
    title = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='title')
    description = sgqlc.types.Field(String, graphql_name='description')
