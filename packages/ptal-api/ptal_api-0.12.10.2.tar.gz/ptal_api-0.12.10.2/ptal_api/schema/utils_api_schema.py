...
class Query(sgqlc.types.Type):
    __schema__ = utils_api_schema
    __field_names__ = ('mention_search', 'batch_mention_search', 'list_document_for_time_period', 'list_text_from_document_with_marker', 'pagination_concept_without_elastic', 'tdm', 'child_ids', 'concept_ids', 'pagination_concept', 'pagination_concept_property_type')
