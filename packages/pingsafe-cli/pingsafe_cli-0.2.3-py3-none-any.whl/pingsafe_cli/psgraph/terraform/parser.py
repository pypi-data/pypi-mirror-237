...
from pingsafe_cli.psgraph.common.runners.base_runner import filter_ignored_paths, IGNORE_HIDDEN_DIRECTORY_ENV, strtobool
from pingsafe_cli.psgraph.common.util.consts import DEFAULT_EXTERNAL_MODULES_DIR, RESOLVED_MODULE_ENTRY_NAME
from pingsafe_cli.psgraph.common.util.type_forcers import force_list
from pingsafe_cli.psgraph.common.variables.context import EvaluationContext
from pingsafe_cli.psgraph.terraform.graph_builder.graph_components.block_types import BlockType
from pingsafe_cli.psgraph.terraform.graph_builder.graph_components.module import Module
from pingsafe_cli.psgraph.terraform.module_loading.content import ModuleContent
from pingsafe_cli.psgraph.terraform.module_loading.module_finder import load_tf_modules
from pingsafe_cli.psgraph.terraform.module_loading.registry import module_loader_registry as default_ml_registry, \
    ModuleLoaderRegistry
from pingsafe_cli.psgraph.common.util.parser_utils import get_tf_definition_key_from_module_dependency, \
    TERRAFORM_NESTED_MODULE_PATH_ENDING, is_acceptable_module_param
from pingsafe_cli.psgraph.terraform.modules.module_utils import load_or_die_quietly, safe_index, \
...
class Parser:
    def __init__(self, module_class: type[Module] = Module) -> None:
        ...
        self.enable_nested_modules = strtobool(os.getenv('PINGSAFE_ENABLE_NESTED_MODULES', 'True'))
