...
from pingsafe_cli.psgraph.cloudformation import cfn_utils
from pingsafe_cli.psgraph.cloudformation.context_parser import ContextParser as CfnContextParser
...
from pingsafe_cli.psgraph.common.util.secrets import omit_secret_value_from_checks
from pingsafe_cli.psgraph.serverless.base_registry import EntityDetails
from pingsafe_cli.psgraph.serverless.parsers.context_parser import ContextParser as SlsContextParser
from pingsafe_cli.psgraph.cloudformation.checks.resource.registry import cfn_registry
from pingsafe_cli.psgraph.serverless.checks.complete.registry import complete_registry
from pingsafe_cli.psgraph.serverless.checks.custom.registry import custom_registry
from pingsafe_cli.psgraph.serverless.checks.function.registry import function_registry
from pingsafe_cli.psgraph.serverless.checks.layer.registry import layer_registry
from pingsafe_cli.psgraph.serverless.checks.package.registry import package_registry
from pingsafe_cli.psgraph.serverless.checks.plugin.registry import plugin_registry
from pingsafe_cli.psgraph.serverless.checks.provider.registry import provider_registry
from pingsafe_cli.psgraph.serverless.checks.service.registry import service_registry
...
from pingsafe_cli.psgraph.common.output.extra_resource import ExtraResource
from pingsafe_cli.psgraph.serverless.parsers.parser import parse
from pingsafe_cli.psgraph.common.parsers.node import DictNode
from pingsafe_cli.psgraph.serverless.parsers.parser import CFN_RESOURCES_TOKEN
...
class Runner(BaseRunner):
    ...
    def run(
        ...
        for sls_file, sls_file_data in definitions.items():
            ...
            # "Complete" checks
            # NOTE: Ignore codescanner content, no point in showing (could be long)
            entity_lines_range, entity_code_lines = sls_context_parser.extract_code_lines(sls_file_data)
