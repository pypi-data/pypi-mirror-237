...
from pingsafe_cli.psgraph.common.checks_infra.registry import get_graph_checks_registry
...
from pingsafe_cli.psgraph.common.output.github_actions_record import GithubActionsRecord
from pingsafe_cli.psgraph.common.output.record import Record
from pingsafe_cli.psgraph.common.output.report import Report, CheckType
from pingsafe_cli.psgraph.common.parallelizer.parallel_runner import parallel_runner
from pingsafe_cli.psgraph.common.runners.base_runner import BaseRunner, filter_ignored_paths, PINGSAFE_CREATE_GRAPH
from pingsafe_cli.psgraph.common.runners.graph_manager import ObjectGraphManager
...
from pingsafe_cli.psgraph.common.util.suppression import collect_suppressions_for_context

if TYPE_CHECKING:
    from pingsafe_cli.psgraph.common.checks.base_check_registry import BaseCheckRegistry
    from pingsafe_cli.psgraph.common.runners.graph_builder.local_graph import ObjectLocalGraph
    ...
    def run(
        ...
        if external_checks_dir:
            for directory in external_checks_dir:
                ...
                if PINGSAFE_CREATE_GRAPH and self.graph_registry:
        ...
        if not self.context or not self.definitions:
            ...
            if PINGSAFE_CREATE_GRAPH and self.graph_registry and self.graph_manager:
