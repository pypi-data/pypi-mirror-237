...
from pingsafe_cli.psgraph.common.graph.db_connectors.igraph.igraph_db_connector import IgraphConnector
from pingsafe_cli.psgraph.common.graph.db_connectors.networkx.networkx_db_connector import NetworkxConnector
...
if TYPE_CHECKING:
    from pingsafe_cli.psgraph.common.checks_infra.registry import Registry
    ...
    from pingsafe_cli.psgraph.common.typing import _CheckResult, LibraryGraphConnector
...
PINGSAFE_CREATE_GRAPH = strtobool(os.getenv("PINGSAFE_CREATE_GRAPH", "True"))
...
class BaseRunner(ABC, Generic[_GraphManager]):
    ...
    def __init__(self, file_extensions: Iterable[str] | None = None, file_names: Iterable[str] | None = None):
        ...
        graph_framework = os.getenv("PINGSAFE_GRAPH_FRAMEWORK", "NETWORKX")
