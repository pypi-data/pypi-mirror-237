    ...
    "multi_date": [
        {
            ...
            "value_map": {
                "level3": [
                    {'title': "Artifical Surface (unchanged)", 'abstract': "", 'values': [[216], [216]],
                     'color': '#801010', 'alpha': 1},
                    {'title': "Other -> Artifical Surface", 'abstract': "", 'values': [[], [216]],
                     'color': '#C02030', 'alpha': 1},
                    {'title': "Natural Bare Surface (unchanged)", 'abstract': "", 'values': [[215], [215]],
                     'color': '#404050', 'alpha': 1},
                    {'title': "Other -> Natural Bare Surface", 'abstract': "", 'values': [[], [215]],
                     'color': '#70707A', 'alpha': 1},

                    {'title': "Water/Aquatic veg", 'abstract': "", 'values': [[], [124,215,216,220]],
                     'color': '#4040A0', 'alpha': 1},

                    {'title': "Cultivated Terrestrial Veg -> Natural Veg", 'abstract': "", 'values': [[111], [112]],
                     'color': '#FFFFFF', 'alpha': 1},
                    {'title': "Natural Terrestrial Veg (unchanged)", 'abstract': "", 'values': [[112], [112]],
                     'color': '#109030', 'alpha': 1},
                    {'title': "Other -> Terrestrial Natural Veg", 'abstract': "", 'values': [[], [112]],
                     'color': '#80E080', 'alpha': 1},
                    {'title': "Natural Terrestrial Veg -> Cultivated Veg", 'abstract': "", 'values': [[112], [111]], 'color': '#80E0B0', 'alpha': 1},
                    {'title': "Other -> Cultivated Veg", 'abstract': "", 'values': [[], [111]], 'color': '#B0E0D0', 'alpha': 1},

                    {'title': "Everything else", 'abstract': "", 'values': [[], []], 'color': '#00FFFF', 'alpha': 1},
                ]
            },
            "legend": {
                "width": 3.5,
            ...
            "value_map": {
                "level3": [
                    ...
                    {'title': "Water/Aquatic veg", 'abstract': "", 'values': [[], [124,215,216,220]],
                     'color': '#4040A0', 'alpha': 1},
                    {'title': "Cultivated Terrestrial Veg -> Natural Veg", 'abstract': "", 'values': [[111], [112]],
                     'color': '#B0E080', 'alpha': 1},
                    {'title': "Natural Terrestrial Veg (unchanged)", 'abstract': "", 'values': [[112], [112]],
                     'color': '#109030', 'alpha': 1},
                    {'title': "Natural Terrestrial Veg -> Cultivated Veg", 'abstract': "", 'values': [[112], [111]], 'color': '#80E0B0', 'alpha': 1},
                    {'title': "Other -> Terrestrial Veg", 'abstract': "", 'values': [[], [112]],
                     'color': '#80E080', 'alpha': 1},
                    {'title': "Other -> Cultivated Veg", 'abstract': "", 'values': [[], [111]], 'color': '#B0E0D0', 'alpha': 1},
                    {'title': "Everything else", 'abstract': "", 'values': [[], []], 'color': '#00FFFF', 'alpha': 1},
                ]
    ...
    "multi_date": [
        {
            ...
            "allowed_count_range": [2, 2],
            "aggregator_function": {
                "function": f"{cfgbase}.lccs_local_cfg.lccs_delta.lccs_map_delta",
            },
            "value_map": {
                "level4": [
                    {'title': "", 'abstract': "", 'values': [0], 'color': '#FFFFFF', 'alpha': 0},
                    {'title': "Unchanged", 'abstract': "Changed", 'values': [255], 'color': '#000000'},
                    {'title': 'Cultivated Terrestrial Vegetated', 'abstract': '', 'values': [1], 'color': '#97bb1a',
                     'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Woody', 'abstract': '', 'values': [2],
                     'color': '#97bb1a', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Herbaceous', 'abstract': '', 'values': [3],
                     'color': '#d1e033', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Closed (> 65 %)', 'abstract': '', 'values': [4],
                     'color': '#c5a847', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Open (40 to 65 %)', 'abstract': '', 'values': [5],
                     'color': '#cdb54b', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Open (15 to 40 %)', 'abstract': '', 'values': [6],
                     'color': '#d5c14f', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Sparse (4 to 15 %)', 'abstract': '', 'values': [7],
                     'color': '#e4d26c', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Scattered (1 to 4 %)', 'abstract': '', 'values': [8],
                     'color': '#f2e38a', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Woody Closed (> 65 %)', 'abstract': '', 'values': [9],
                     'color': '#c5a847', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Woody Open (40 to 65 %)', 'abstract': '',
                     'values': [10], 'color': '#cdb54b', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Woody Open (15 to 40 %)', 'abstract': '',
                     'values': [11], 'color': '#d5c14f', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Woody Sparse (4 to 15 %)', 'abstract': '',
                     'values': [12], 'color': '#e4d26c', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Woody Scattered (1 to 4 %)', 'abstract': '',
                     'values': [13], 'color': '#f2e38a', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Herbaceous Closed (> 65 %)', 'abstract': '',
                     'values': [14], 'color': '#e4e034', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Herbaceous Open (40 to 65 %)', 'abstract': '',
                     'values': [15], 'color': '#ebe854', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Herbaceous Open (15 to 40 %)', 'abstract': '',
                     'values': [16], 'color': '#f2f07f', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Herbaceous Sparse (4 to 15 %)', 'abstract': '',
                     'values': [17], 'color': '#f9f7ae', 'alpha': 1},
                    {'title': 'Cultivated Terrestrial Vegetated: Herbaceous Scattered (1 to 4 %)', 'abstract': '',
                     'values': [18], 'color': '#fffede', 'alpha': 1},
                    {'title': '', 'abstract': '', 'values': [19], 'color': '#0e7912', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Woody', 'abstract': '', 'values': [20],
                     'color': '#1ab157', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Herbaceous', 'abstract': '', 'values': [21],
                     'color': '#5eb31f', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Closed (> 65 %)', 'abstract': '', 'values': [22],
                     'color': '#0e7912', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Open (40 to 65 %)', 'abstract': '', 'values': [23],
                     'color': '#2d8d2f', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Open (15 to 40 %)', 'abstract': '', 'values': [24],
                     'color': '#50a052', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Sparse (4 to 15 %)', 'abstract': '', 'values': [25],
                     'color': '#75b476', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Scattered (1 to 4 %)', 'abstract': '', 'values': [26],
                     'color': '#9ac79c', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Woody Closed (> 65 %)', 'abstract': '', 'values': [27],
                     'color': '#0e7912', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Woody Open (40 to 65 %)', 'abstract': '', 'values': [28],
                     'color': '#2d8d2f', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Woody Open (15 to 40 %)', 'abstract': '', 'values': [29],
                     'color': '#50a052', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Woody Sparse (4 to 15 %)', 'abstract': '', 'values': [30],
                     'color': '#75b476', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Woody Scattered (1 to 4 %)', 'abstract': '',
                     'values': [31], 'color': '#9ac79c', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Herbaceous Closed (> 65 %)', 'abstract': '',
                     'values': [32], 'color': '#77a71e', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Herbaceous Open (40 to 65 %)', 'abstract': '',
                     'values': [33], 'color': '#88b633', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Herbaceous Open (15 to 40 %)', 'abstract': '',
                     'values': [34], 'color': '#99c450', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Herbaceous Sparse (4 to 15 %)', 'abstract': '',
                     'values': [35], 'color': '#aad471', 'alpha': 1},
                    {'title': 'Natural Terrestrial Vegetated: Herbaceous Scattered (1 to 4 %)', 'abstract': '',
                     'values': [36], 'color': '#bae292', 'alpha': 1},
                    {'title': '', 'abstract': '', 'values': [37], 'color': '#56ece7', 'alpha': 1},
                    # {'title': 'Cultivated Aquatic Vegetated: Woody', 'abstract': '', 'values': [38], 'color': '#3daa8c', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Herbaceous', 'abstract': '', 'values': [39],
                     'color': '#52e7ac', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Closed (> 65 %)', 'abstract': '', 'values': [40],
                     'color': '#2bd2cb', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Open (40 to 65 %)', 'abstract': '', 'values': [41],
                     'color': '#49ded8', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Open (15 to 40 %)', 'abstract': '', 'values': [42],
                     'color': '#6ee9e4', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Sparse (4 to 15 %)', 'abstract': '', 'values': [43],
                     'color': '#95f4f0', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Scattered (1 to 4 %)', 'abstract': '', 'values': [44],
                     'color': '#bbfffc', 'alpha': 1},
                    # {'title': 'Cultivated Aquatic Vegetated: Woody Closed (> 65 %)', 'abstract': '', 'values': [45], 'color': '#2bd2cb', 'alpha': 1},
                    # {'title': 'Cultivated Aquatic Vegetated: Woody Open (40 to 65 %)', 'abstract': '', 'values': [46], 'color': '#49ded8', 'alpha': 1},
                    # {'title': 'Cultivated Aquatic Vegetated: Woody Open (15 to 40 %)', 'abstract': '', 'values': [47], 'color': '#6ee9e4', 'alpha': 1},
                    # {'title': 'Cultivated Aquatic Vegetated: Woody Sparse (4 to 15 %)', 'abstract': '', 'values': [48], 'color': '#95f4f0', 'alpha': 1},
                    # {'title': 'Cultivated Aquatic Vegetated: Woody Scattered (1 to 4 %)', 'abstract': '', 'values': [49], 'color': '#bbfffc', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Herbaceous Closed (> 65 %)', 'abstract': '',
                     'values': [50], 'color': '#52e7c4', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Herbaceous Open (40 to 65 %)', 'abstract': '',
                     'values': [51], 'color': '#71edd0', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Herbaceous Open (15 to 40 %)', 'abstract': '',
                     'values': [52], 'color': '#90f3dc', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Herbaceous Sparse (4 to 15 %)', 'abstract': '',
                     'values': [53], 'color': '#aff9e8', 'alpha': 1},
                    {'title': 'Cultivated Aquatic Vegetated: Herbaceous Scattered (1 to 4 %)', 'abstract': '',
                     'values': [54], 'color': '#cffff4', 'alpha': 1},
                    {'title': '', 'abstract': '', 'values': [55], 'color': '#1ebf79', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody', 'abstract': '', 'values': [56], 'color': '#128e94',
                     'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Herbaceous', 'abstract': '', 'values': [57],
                     'color': '#70ea86', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Closed (> 65 %)', 'abstract': '', 'values': [58],
                     'color': '#19ad6d', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Open (40 to 65 %)', 'abstract': '', 'values': [59],
                     'color': '#35b884', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Open (15 to 40 %)', 'abstract': '', 'values': [60],
                     'color': '#5dc39b', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Sparse (4 to 15 %)', 'abstract': '', 'values': [61],
                     'color': '#87ceb2', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Scattered (1 to 4 %)', 'abstract': '', 'values': [62],
                     'color': '#b0dac9', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Closed (> 65 %)', 'abstract': '', 'values': [63],
                     'color': '#19ad6d', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Closed (> 65 %) Water > 3 months (semi-) permenant',
                     'abstract': '', 'values': [64], 'color': '#19ad6d', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Woody Closed (> 65 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [65], 'color': '#19ad6d', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Open (40 to 65 %)', 'abstract': '', 'values': [66],
                     'color': '#35b884', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Open (40 to 65 %) Water > 3 months (semi-) permenant',
                     'abstract': '', 'values': [67], 'color': '#35b884', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Woody Open (40 to 65 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [68], 'color': '#35b884', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Open (15 to 40 %)', 'abstract': '', 'values': [69],
                     'color': '#5dc39b', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Open (15 to 40 %) Water > 3 months (semi-) permenant',
                     'abstract': '', 'values': [70], 'color': '#5dc39b', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Woody Open (15 to 40 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [71], 'color': '#5dc39b', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Sparse (4 to 15 %)', 'abstract': '', 'values': [72],
                     'color': '#87ceb2', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Sparse (4 to 15 %) Water > 3 months (semi-) permenant',
                     'abstract': '', 'values': [73], 'color': '#87ceb2', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Woody Sparse (4 to 15 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [74], 'color': '#87ceb2', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Woody Scattered (1 to 4 %)', 'abstract': '', 'values': [75],
                     'color': '#b0dac9', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Woody Scattered (1 to 4 %) Water > 3 months (semi-) permenant',
                        'abstract': '', 'values': [76], 'color': '#b0dac9', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Woody Scattered (1 to 4 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [77], 'color': '#b0dac9', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Herbaceous Closed (> 65 %)', 'abstract': '', 'values': [78],
                     'color': '#27cc8b', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Closed (> 65 %) Water > 3 months (semi-) permenant',
                        'abstract': '', 'values': [79], 'color': '#27cc8b', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Closed (> 65 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [80], 'color': '#27cc8b', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Herbaceous Open (40 to 65 %)', 'abstract': '', 'values': [81],
                     'color': '#42d89f', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Open (40 to 65 %) Water > 3 months (semi-) permenant',
                        'abstract': '', 'values': [82], 'color': '#42d89f', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Open (40 to 65 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [83], 'color': '#42d89f', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Herbaceous Open (15 to 40 %)', 'abstract': '', 'values': [84],
                     'color': '#63e3b4', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Open (15 to 40 %) Water > 3 months (semi-) permenant',
                        'abstract': '', 'values': [85], 'color': '#63e3b4', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Open (15 to 40 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [86], 'color': '#63e3b4', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Herbaceous Sparse (4 to 15 %)', 'abstract': '',
                     'values': [87], 'color': '#87efc9', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Sparse (4 to 15 %) Water > 3 months (semi-) permenant',
                        'abstract': '', 'values': [88], 'color': '#87efc9', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Sparse (4 to 15 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [89], 'color': '#87efc9', 'alpha': 1},
                    {'title': 'Natural Aquatic Vegetated: Herbaceous Scattered (1 to 4 %)', 'abstract': '',
                     'values': [90], 'color': '#abfadd', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Scattered (1 to 4 %) Water > 3 months (semi-) permenant',
                        'abstract': '', 'values': [91], 'color': '#abfadd', 'alpha': 1},
                    {
                        'title': 'Natural Aquatic Vegetated: Herbaceous Scattered (1 to 4 %) Water < 3 months (temporary or seasonal)',
                        'abstract': '', 'values': [92], 'color': '#abfadd', 'alpha': 1},
                    {'title': 'Artificial Surface', 'abstract': '', 'values': [93], 'color': '#da5c69', 'alpha': 1},
                    {'title': '', 'abstract': '', 'values': [94], 'color': '#f3ab69', 'alpha': 1},
                    {'title': 'Natural Surface: Sparsely vegetated', 'abstract': '', 'values': [95], 'color': '#ffe68c',
                     'alpha': 1},
                    {'title': 'Natural Surface: Very sparsely vegetated', 'abstract': '', 'values': [96],
                     'color': '#fad26e', 'alpha': 1},
                    {'title': 'Natural Surface: Bare areas, unvegetated', 'abstract': '', 'values': [97],
                     'color': '#f3ab69', 'alpha': 1},
                    {'title': 'Water', 'abstract': '', 'values': [98], 'color': '#4d9fdc', 'alpha': 1},
                    {'title': '', 'abstract': '', 'values': [99], 'color': '#4d9fdc', 'alpha': 1},
                    {'title': 'Water: Tidal area', 'abstract': '', 'values': [100], 'color': '#bbdce9', 'alpha': 1},
                    {'title': 'Water: Perennial (> 9 months)', 'abstract': '', 'values': [101], 'color': '#1b55ba',
                     'alpha': 1},
                    {'title': 'Water: Non-perennial (7 to 9 months)', 'abstract': '', 'values': [102],
                     'color': '#3479c9', 'alpha': 1},
                    {'title': 'Water: Non-perennial (4 to 6 months)', 'abstract': '', 'values': [103],
                     'color': '#4f9dd9', 'alpha': 1},
                    {'title': 'Water: Non-perennial (1 to 3 months)', 'abstract': '', 'values': [104],
                     'color': '#85cafd', 'alpha': 1},
                    # {'title': 'Water: (Snow)', 'abstract': '', 'values': [105], 'color': '#fafafa', 'alpha': 1},
    ...
    "layers": [
        ...
        """,
            ...
            "styling": {
                ...
                "styles": [style_c2_level4, style_c2_level3, style_c2_level3_test]
           },
            "feature_info": {
                "include_custom": {
                    "description": {
                        "function": f"{cfgbase}.lccs_local_cfg.lc_class_desc.class_labels",
                    }
                }
            },
        },
        ...
        """,
            ...
            "feature_info": {
                "include_custom": {
                    "description": {
                        "function": f"{cfgbase}.lccs_local_cfg.lc_class_desc.env_descriptor_labels",
                    }
                }
            }
        }
