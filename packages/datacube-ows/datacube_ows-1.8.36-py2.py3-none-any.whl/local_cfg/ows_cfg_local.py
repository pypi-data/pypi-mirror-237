...
from local_cfg.c3_local_cfg.bands import bands_s2_ls_combo
from local_cfg.c3_local_cfg.styles import styles_c3_ls_common
...
#               "renderer": "datacube_ows.wcs_utils.get_tiff",
    ...
    "layers": [
        ...
        {
            "include": f"{cfgbase}.c3_local_cfg.folder_c3_landsat",
            "type": "python"
        },
        {
            "include": f"{cfgbase}.lccs_local_cfg.lccs_cfg.layers",
            "type": "python"
        },
        {
            "include": f"{cfgbase}.s2_c3_local_cfg.layers.folder_c3_s2",
            "type": "python"
        },
        {
            "include": f"{cfgbase}.c3_local_cfg.folder_c3_s2",
            "type": "python"
        },
        {
            "name": "s2_ls_latest_mosaic",
            "title": "Sentinel-2/Landsat Combined Imagery (visible bands only)",
            "abstract": """S2 + LS = fun!  Mosaics""",
            "multi_product": True,
            "product_names": [
                "ga_s2am_ard_3",
                "ga_s2bm_ard_3",
            ...
            "mosaic_date_func": {
                "function": f"{cfgbase}.c3_mosaic_cfg.utils.rolling_window_6day",
                "pass_layer_cfg": True
            },
            "bands": bands_s2_ls_combo,
        ...
        {
            "name": "s2_ls_combined",
            "title": "Sentinel-2/Landsat Combined Imagery",
            "abstract": """S2 + LS = fun! """,
            "multi_product": True,
            "product_names": [
                "ga_s2am_ard_3",
        ...
        {  # GROK
            ...
            "bands": {
                ...
                "nbart_nir_1": ["nbart_nir_1", "nir", "nir_1"],
            },
            "resource_limits": reslim_s2_ard,
            "flags": [{
                "band": "land",
        ...
        {  # GROK
            "name": "ls_combined",
            "title": "Landsat Combined Imagery (visible bands only)",
            "abstract": """LS = fun! """,
            "multi_product": True,
            "product_names": [
               # "ga_ls5t_ard_3",
            ...
            "styling": {
                ...
                "styles": [
                    ...
                    {
                        "name": "blue",
                        "title": "Blue Band Only",
                        "abstract": "Blue band only (monochrome)",
                        "components": {
                            "red": {
                                "blue": 1.0
                            },
                    ...
                    {
                        "name": "green",
                        "title": "Green Band Only",
                        "abstract": "Green band only (monochrome)",
                        "components": {
                            "red": {
                                "green": 1.0
                            },
                    ...
                    },
                    {
                        "name": "red",
                        "title": "Red Band Only",
                        "abstract": "Red band only (monochrome)",
                        "components": {
                            "red": {
                                "red": 1.0
                            },
...
For service status information, see https://status.dea.ga.gov.au""",
                ...
                "styling": {
                    ...
                    "styles": [
                        style_ls_simple_rgb, 
                        style_ls_irr, style_ls_irg, style_ls_jacktest, style_ls_ndvi, style_ls_ndvi_expr, style_ls_ndwi, style_ls_mndwi,
