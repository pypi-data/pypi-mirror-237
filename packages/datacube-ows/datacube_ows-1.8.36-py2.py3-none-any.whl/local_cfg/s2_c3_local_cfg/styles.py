...
style_s2_blackcloud = {
    "name": "s2dark_cloud",
    "title": "S2 Darken clouds",
    "abstract": "S2 Cloudless Probabilities given for s2cloudless_mask classification",
    "include_in_feature_info": False,
    "additional_bands": ["s2cloudless_prob", "red", "green", "blue"],
    "components": {
        "red": {
            "function": f"{cfgbase}.s2_c3_local_cfg.utils.black_cloud",
            "mapped_bands": True,
            "kwargs": {
                "band": "red",
                "scale_from": [0, 3000]
...
style_s2_cloudless_prob = {
    ...
    "components": {
        ...
        "alpha": {
            "function": f"{cfgbase}.s2_c3_local_cfg.utils.invert_alpha"
        }
    }
}
