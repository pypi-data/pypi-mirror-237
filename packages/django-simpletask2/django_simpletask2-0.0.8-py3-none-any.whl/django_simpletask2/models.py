...
from .lock import SimpleRedisLock
...
class SimpleTask(models.Model):
    ...
    def push_to_mq(self):
        ...
        task_queue_name = DJANGO_SIMPLETASK2_CHANNEL_NAME_TEMPLATE.format(
        ...
        task_flags = DJANGO_SIMPLETASK2_CHANNEL_FLAGS_TEMPLATE.format(
            channel=channel_name
        )
        redis_conn = self.get_redis_conn()
        redis_conn.sadd(task_flags, task_info)
