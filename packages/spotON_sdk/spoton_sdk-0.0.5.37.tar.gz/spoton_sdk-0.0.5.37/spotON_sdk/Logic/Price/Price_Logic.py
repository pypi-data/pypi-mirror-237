...
class Price_Logic(CustomBaseModel):
    ...
    def __init__(self, **data):
        super().__init__(**data)
        self.market: Market  # This annotation tells the linter that `market` is of type `Market`

        if data.get("pricefinding") is not None:
            self.pricefinding = data["pricefinding"]
    ...
    def unpack(details: dict[str, Any]) -> "Price_Logic":
        ...
        print(f"pricefinding after unpacking: {price_logic.pricefinding}")
