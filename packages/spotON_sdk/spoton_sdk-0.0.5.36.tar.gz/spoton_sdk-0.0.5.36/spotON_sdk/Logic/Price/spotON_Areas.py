...
class spotON_Area(Enum):
    ...
    AT = Area_details(name='AT',code='10YAT-APG------L',tz='Europe/Vienna',currency=euro)
    BA = Area_details(name='BA',code='10YBA-JPCC-----D',tz='Europe/Sarajevo')
    BE = Area_details(name='BE',code='10YBE----------2',tz='Europe/Brussels')
    BG = Area_details(name='BG',code='10YCA-BULGARIA-R',tz='Europe/Sofia',currency=bulgarian_lev)
    ...
    CZ = Area_details(name='CZ',code='10YCZ-CEPS-----N',tz='Europe/Prague',currency=czech_koruna)
    CZ_DE_SK = Area_details(name='CZ_DE_SK',code='10YDOM-CZ-DE-SKK',tz='Europe/Prague',currency=czech_koruna)
    ...
    DK = Area_details(name='DK',code='10Y1001A1001A65H',tz='Europe/Copenhagen',currency=danish_krone)
    DK_1 = Area_details(name='DK_1',code='10YDK-1--------W',tz='Europe/Copenhagen',currency=danish_krone)
    DK_1_NO_1 = Area_details(name='DK_1_NO_1',code='46Y000000000007M',tz='Europe/Copenhagen',currency=danish_krone)
    DK_2 = Area_details(name='DK_2',code='10YDK-2--------M',tz='Europe/Copenhagen',currency=danish_krone)
    DK_CA = Area_details(name='DK_CA',code='10Y1001A1001A796',tz='Europe/Copenhagen',currency=danish_krone)
    ...
    HR = Area_details(name='HR',code='10YHR-HEP------M',tz='Europe/Zagreb',currency=croatian_kuna)
    HU = Area_details(name='HU',code='10YHU-MAVIR----U',tz='Europe/Budapest',currency=hungarian_forint)
    ...
    PL = Area_details(name='PL',code='10YPL-AREA-----S',tz='Europe/Warsaw',currency=polish_zloty)
    PL_CZ = Area_details(name='PL_CZ',code='10YDOM-1001A082L',tz='Europe/Warsaw',currency=polish_zloty)
    PT = Area_details(name='PT',code='10YPT-REN------W',tz='Europe/Lisbon')
    RO = Area_details(name='RO',code='10YRO-TEL------P',tz='Europe/Bucharest',currency=romanian_leu)
    ...
    SE = Area_details(name='SE',code='10YSE-1--------K',tz='Europe/Stockholm',currency=swedish_krona)
    SE_1 = Area_details(name='SE_1',code='10Y1001A1001A44P',tz='Europe/Stockholm',currency=swedish_krona)
    SE_2 = Area_details(name='SE_2',code='10Y1001A1001A45N',tz='Europe/Stockholm',currency=swedish_krona)
    SE_3 = Area_details(name='SE_3',code='10Y1001A1001A46L',tz='Europe/Stockholm',currency=swedish_krona)
    SE_4 = Area_details(name='SE_4',code='10Y1001A1001A47J',tz='Europe/Stockholm',currency=swedish_krona)
