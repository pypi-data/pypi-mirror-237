...
class MonteCarloConfigService:
    ...
    def convert_to_mac(
        ...
        namespace: str,
        project_dir: str,
        monitor_uuids: Optional[List[str]] = None,
        ...
        if not dry_run:
            if not click.confirm(
                ...
                "If you proceed, your monitors will no longer be editable through the UI and you'll need to edit "
                "and apply the monitor configuration to perform changes.",
                abort=False,
            ):
                return
        convert_to_mac = """
