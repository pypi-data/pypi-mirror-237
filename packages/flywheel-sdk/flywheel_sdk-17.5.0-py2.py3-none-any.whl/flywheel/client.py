...
class Client(object):
    def __init__(self, api_key=None, **kwargs):
        ...
        disable_auth_check = kwargs.pop('disable_auth_check', False)
    ...
    def download_zip(self, containers, dest_file, include_types=None, exclude_types=None):
        ...
        :return: A summary of the download
        """
        return self._fw.download_zip(containers, dest_file, include_types=include_types, exclude_types=exclude_types)
