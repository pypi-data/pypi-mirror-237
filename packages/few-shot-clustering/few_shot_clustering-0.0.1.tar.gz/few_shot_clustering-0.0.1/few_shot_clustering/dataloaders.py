...
def load_tweet(data_path, cache_path = "/projects/ogma1/vijayv/few-shot-clustering/few_shot_clustering/file/tweet_dataset_cache.pkl"):
...
_ = '''
def load_tweet(data_path, cache_path = "/projects/ogma1/vijayv/few-shot-clustering/few_shot_clustering/file/tweet_dataset_cache_instructor.pkl"):
    data = pd.read_csv(data_path, sep="\t")
    if os.path.exists(cache_path):
        embeddings = pickle.load(open(cache_path, 'rb'))
    else:
...
def load_clinc(cache_path = "/projects/ogma1/vijayv/few-shot-clustering/few_shot_clustering/file/clinc_dataset_cache.pkl"):
...
def load_bank77(cache_path = "/projects/ogma1/vijayv/few-shot-clustering/few_shot_clustering/file/bank77_dataset_cache.pkl"):
