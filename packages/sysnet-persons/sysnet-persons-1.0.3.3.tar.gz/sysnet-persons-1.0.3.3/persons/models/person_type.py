...
class PersonType(object):
    ...
    def __init__(self, identifier=None, pid=None, code=None, registry=None, ico=None, person_type=None, name=None, full_name=None, headquarters=None, department=None, addresses=None, address_printable=None, representative=None, contacts=None, admins=None, members=None, issuing=None, linked_persons=None, tags=None, document=None):  # noqa: E501
