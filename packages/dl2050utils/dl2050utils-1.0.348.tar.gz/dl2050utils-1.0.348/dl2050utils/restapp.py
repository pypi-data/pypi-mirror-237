...
class App():
    ...
    async def upload_req(self, request):
        """
            ...
            TODO: Include method to select the use of File Server or GCS.
        ...
        FILE_SERVER_PROVIDER = 'FS'
        if FILE_SERVER_PROVIDER=='FS':
            url = fs_upload_signed_url(self.fs_secret, f'{request.url.host}', args['bucket'], key, args['size'], timeout=timeout)
        else:
