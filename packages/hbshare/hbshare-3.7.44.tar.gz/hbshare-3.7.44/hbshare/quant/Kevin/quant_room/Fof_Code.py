...
def calc_fof_volatility(start_date, end_date):
    year_list = [str(x) for x in range(2020, 2024)]
    month_list = [str(x).zfill(2) for x in range(1, 13)]
    data_list = []
    for year in year_list:
        if year == "2023":
            month_list = month_list[:5]
        for month in month_list:
            t_date = year + month
            sql_script = "SELECT * FROM st_hedge.t_st_sm_zsyb WHERE jjfl = '1002' and tjyf = {}".format(t_date)
...
def calc_benchmark_h1_n1(start_date, end_date):
    ...
    benchmark_nav = hb_index.dot(weight)
...
if __name__ == '__main__':
    ...
    # calc_fof_volatility("20191227", "20230602")
    ...
    #     "20221230", "20230915", "6832a6fc6c7e40a8815a5572eddd4536")

    # calc_benchmark_h1_n1("20230728", "20230901")
