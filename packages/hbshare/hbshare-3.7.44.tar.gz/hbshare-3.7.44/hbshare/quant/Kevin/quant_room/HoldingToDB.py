    ...
    def _load_portfolio_weight(self):
        ...
        for name in filenames:
            ...
            if self.fund_name in ['因诺聚配中证500指数增强', '凡二中证500增强9号1期', '赫富500指数增强一号', '赫富1000指数增强一号',
                                  ...
                                  '盛冠达股票量化2号', '致邃-量化6号', '玄信500指增', '玄信1000指增']:
                context = "市值占净值%"
                if self.fund_name in ['伯兄建康', '伯兄熙宁', '伯兄至道', '宽德飞虹1号', '盛冠达股票量化2号', '致邃-量化6号']:
                    hd = 2
                    context = "市值占净值(%)"
                ...
                if self.fund_name in ['稳博对冲18号', '黑翼优选成长1号']:
            ...
            # 招商
                                    ...
                                    '联海星辰1号', '益清证金中证500指数增强一号', '卓胜中证500指数增强一号']:
...
if __name__ == '__main__':
    ...
    HoldingExtractor(data_path='D:\\估值表基地\\{}'.format(name_outer), table_name="private_fund_holding",
                     fund_name=name_outer, fund_type="量化多头").writeToDB()
    # holding_to_db_by()