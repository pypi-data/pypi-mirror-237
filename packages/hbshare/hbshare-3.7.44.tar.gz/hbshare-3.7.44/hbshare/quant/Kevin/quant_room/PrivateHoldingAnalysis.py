...
if __name__ == '__main__':
    tmp = HoldingAnalysor(
        "半鞅量化精选", "20230928", "000852").get_construct_result(isPlot=False)

    # dis_df = HoldingDistribution('20221220', '20230331', '因诺聚配中证500指数增强').get_construct_result()
    # print(dis_df)

    # name_list = ['因诺聚配中证500指数增强', '衍复臻选指数增强一号', '星阔广厦1号中证500指数增强', '顽岩中证500指数增强5号',
    #              '乾象中证500指数增强1号', '宽德九臻', '概率500指增2号', '伯兄熙宁', '白鹭精选量化鲲鹏十号', '赫富500指数增强一号',
    #              '千衍六和3号', '超量子500增强2号', "信弘征程2号"]
    # name_list = ['伯兄至道', '伯兄熙宁', '超量子500增强2号', '磐松500指增', '白鹭精选量化鲲鹏十号', '赫富500指数增强一号',
    #               '乾象中证500指数增强1号', '千衍六和3号', '博普万维指数增强1号', '因诺聚配中证500指数增强',
    #               '本利达利磐八号', '新方程量化中小盘']
    # HoldingCompare('20230331', '000905', name_list).run()
    # concept_compare("20230331", name_list)
    # small_cap_stocks_counts("20220531", ['TEST'])
    ...
    # res = prediction_test("20230430", ['因诺聚配中证500指数增强', '顽岩中证500指数增强5号', '乾象中证500指数增强1号'])
    # print(res)
