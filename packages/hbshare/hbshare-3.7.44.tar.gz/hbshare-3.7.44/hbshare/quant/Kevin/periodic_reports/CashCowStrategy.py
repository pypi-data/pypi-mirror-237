...
if __name__ == '__main__':
    # 更新
    # results = BigMomStrategy("20230920", "20230928").update_portfolio(
    #     "20230928", "20230928")
    ...
    # save_30_minutes_data_to_csv(weight, "20230820", "20230928")
    calc_signal_matrix(weight, "20200720", "20230927", type="monthly")