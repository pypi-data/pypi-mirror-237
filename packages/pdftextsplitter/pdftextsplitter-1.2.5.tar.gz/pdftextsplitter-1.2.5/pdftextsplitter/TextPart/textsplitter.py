...
class textsplitter(textpart):
    ...
    def __init__(self):
        ...
        self.VERSION = "1.2.5"                # To keep track on which version (selection rules) was used in the analysis.
    ...
    def process(self, verbose_option = 0) -> int:
        ...
        self.shiftcontents()
        self.calculatetree()
        num_errors = self.layered_summary(verbose_option) # NOTE: Verbose-options -1, 0, 1, 2, 3, ...
