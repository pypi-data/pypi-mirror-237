...
def RegressionTest_h(use_dummy_summary: bool) -> bool:
    ...
    print("\n This Regression test (AVERE) is still under development ad, therefore, not to be trusted!\n")
...
def RegressionTest_i(use_dummy_summary: bool) -> bool:
    ...
    print("\n This Regression test (EU_soil_proposal) is still under development ad, therefore, not to be trusted!\n")
...
def RegressionTest_j(use_dummy_summary: bool) -> bool:
    ...
    print("\n This Regression test (Kamerbrief_circulaire_economie) is still under development ad, therefore, not to be trusted!\n")
...
def RegressionTest_k(use_dummy_summary: bool) -> bool:
    ...
    print("\n This Regression test (kamerbrief_emissie_luchtvaart) is still under development ad, therefore, not to be trusted!\n")
...
def RegressionTest_l(use_dummy_summary: bool) -> bool:
    ...
    print("\n This Regression test (Kamerbrief_innovatie_missie) is still under development ad, therefore, not to be trusted!\n")
...
def RegressionTest_m(use_dummy_summary: bool) -> bool:
    ...
    print("\n This Regression test (Kamerbrief_water_en_Bodem) is still under development ad, therefore, not to be trusted!\n")
...
def RegressionTests(use_dummy_summary: bool) -> bool:
    ...
    #if not RegressionTest_h(use_dummy_summary): Answer=False
    #print("RegressionTest_h()...")
    #if not RegressionTest_i(use_dummy_summary): Answer=False
    #print("RegressionTest_i()...")
    #if not RegressionTest_j(use_dummy_summary): Answer=False
    #print("RegressionTest_j()...")
    #if not RegressionTest_k(use_dummy_summary): Answer=False
    #print("RegressionTest_k()...")
    #if not RegressionTest_l(use_dummy_summary): Answer=False
    #print("RegressionTest_l()...")
    #if not RegressionTest_m(use_dummy_summary): Answer=False
    #print("RegressionTest_m()...")
