...
use crate::optimisers::{
    default_optimiser, default_optimiser_details, inertial_optimiser, simple_optimiser, Results, simple_optimiser_details, gradiant_descent,
};
    ...
    fn py_optim_final(
        ...
        let res = match optimiser {
            ...
            "gradient_descent" => {
                ...
                match c.record {
                    false => gradiant_descent(&mut c, step_size, levels),
