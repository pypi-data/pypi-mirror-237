...
def generate_openapi_file(server_url, file_path, enable_login):
    """
...
def setup_openapi(config: Configurator, *, enable_login: bool):
    """
    ...
    generate_openapi_file(server_url, file_path, enable_login)
