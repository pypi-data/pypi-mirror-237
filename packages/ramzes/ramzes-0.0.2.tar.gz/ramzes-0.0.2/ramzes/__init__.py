class posos:
    def info():
        a=['в группе учатся. дисперсию центральный момент',
'в группе учатся. математическое ожидание дисперсию',
'распределение баллов на. математическое ожидание стандартное отклонение',
'две игральные кости. математическое ожидание стандартное отклонение',
'имеется пронумерованных монет. математическое ожидание дисперсию',
'эмпирическое распределение признаков. математическое ожидание дисперсию',
'эмпирическое распределение признаков. математическое ожидание стандартное отклонение',
'в группе учится. среднюю положительную оценку в группе медиану положительных оценок в группе',
'следующие чисел это. среднее арифметическое ПД эмпирическое стандартное отклонение ПД',
'в группе учатся. ковариацию коэффициент корреляции',
'поток состоит из. среднее значение эмпирическое стандартное отклонение']
        print(a)
    def smeshnoy(task=''):
        #1
        sklad = {
