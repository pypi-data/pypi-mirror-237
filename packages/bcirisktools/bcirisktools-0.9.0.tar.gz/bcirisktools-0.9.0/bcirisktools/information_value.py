...
def trainModel(X, y, 
               ...
               params = {"random_state":42, "max_depth":2}
              ):
...
def univariateIV(dataset,
    ...
    params.setdefault("min_samples_leaf", 0.05)
    ...
    plt.savefig(f"./plot/count_features.png", bbox_inches='tight')
    plt.close()
    ...
    for it, feature in enumerate(valid_cols):
        ...
        clf = trainModel(X, y, feature=feature, params=params)
    ...
    plt.savefig(f"./plot/iv_features.png", bbox_inches='tight')
    plt.close()
