...
class DeepchecksCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(self, *args, logger: logging.Logger = None, ext_interaction_id: UUID | None = None, **kwargs):
    ...
    @property
    def ext_interaction_id(self) -> UUID | None:
        return self._ext_interaction_id
    ...
    def on_chain_start(
        ...
        if parent_run_id is None:
            ...
            self._user_input = inputs.get('input') if isinstance(inputs, dict) else inputs

    def on_chain_end(self, outputs: Dict[str, Any], **kwargs: Any) -> Any:
        """Run when chain ends running."""
        self.logger.debug('on_chain_end', kwargs)
        if kwargs.get('parent_run_id', None) is None:
            self._user_response = outputs.get('text') if isinstance(outputs, dict) else outputs
    ...
    def _log_interaction(self):
        ...
        _client.log_interaction(
            model_response=self._user_response,
            ext_interaction_id=self._ext_interaction_id,
