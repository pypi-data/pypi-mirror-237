...
/* harmony import */ var _prompt__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./prompt */ "./lib/prompt.js");
 ...
 */
class PromptContentFactory extends _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_1__.NotebookPanel.ContentFactory {
    constructor(options) {
        super(options);
    }
    createCellHeader() {
 ...
 */
class PromptCellHeader extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_2__.Widget {
    constructor() {
        super();
        this._prompt = null;
    ...
    openPrompt(type, commands, metadata) {
        if (!this.cell || !this.notebook || !(this.layout instanceof _lumino_widgets__WEBPACK_IMPORTED_MODULE_2__.PanelLayout)) {
            return;
        }
        ...
        this.closePrompt();
        this._prompt = new _prompt__WEBPACK_IMPORTED_MODULE_3__.Prompt({
            type,
            commands,
            cell: this.cell,
...
const einblickAiPromptExtension = {
    ...
    description: 'Made for data tasks. Generate, modify, and fix code.',
    autoStart: true,
...
(function (PromptModel) {
     ...
     */
    class Model extends _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_3__.VDomModel {
        constructor(type, cell, notebook, translator, metadata) {
            super();
            this._metadata = null;
            this._placeholder = '';
            this._userInput = '';
        ...
        async getCellContext() {
            ...
            return _utils__WEBPACK_IMPORTED_MODULE_6__.PromptContextUtil.GetContextForActiveNotebookCellBasedOnRadius(this._cell, this._notebook, 1000, this._cancelToken);
        }
        async generate(input, cancelToken) {
            ...
            const agentRequest = {
                Prompt: this.limitInputSize(input),
                Context: context,
        ...
        async fix(cancelToken) {
            ...
            await this.modify(`Please edit the code to fix the following error:\n${traceback}`, cancelToken);
        }
        limitInputSize(input) {
...
class Prompt extends _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_3__.VDomRenderer {
     ...
     */
    constructor(opts) {
        super(new _model__WEBPACK_IMPORTED_MODULE_5__.PromptModel.Model(opts.type, opts.cell, opts.notebook, opts.translator, opts.metadata));
...
/* harmony export */ });
/* harmony import */ var web_tree_sitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! web-tree-sitter */ "webpack/sharing/consume/default/web-tree-sitter/web-tree-sitter");
/* harmony import */ var web_tree_sitter__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(web_tree_sitter__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _cancellablePromise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cancellablePromise */ "./lib/cancellablePromise.js");
...
const executeCode = (kernel, code, ...cancelTokens) => {
    ...
    return (0,_cancellablePromise__WEBPACK_IMPORTED_MODULE_0__.CancellablePromise)(resolve => {
...
const loadPythonParser = async (...cancelTokens) => {
    ...
    try {
        await (0,_cancellablePromise__WEBPACK_IMPORTED_MODULE_0__.CancellablePromiseRace)([
            web_tree_sitter__WEBPACK_IMPORTED_MODULE_1___default().init({
                locateFile: (fileName) => {
        ...
        pythonParser = new (web_tree_sitter__WEBPACK_IMPORTED_MODULE_1___default())();
        const languageWasmFileResponse = await (0,_cancellablePromise__WEBPACK_IMPORTED_MODULE_0__.CancellablePromiseRace)([
        ...
        const arrayBuffer = await (0,_cancellablePromise__WEBPACK_IMPORTED_MODULE_0__.CancellablePromiseRace)([languageWasmFileResponse.arrayBuffer()], ...cancelTokens);
        if (cancelTokens.some(token => token.IsCancelled)) {
            return undefined;
        }
        else if (!arrayBuffer) {
        ...
        language =
            (_a = (await (0,_cancellablePromise__WEBPACK_IMPORTED_MODULE_0__.CancellablePromiseRace)([web_tree_sitter__WEBPACK_IMPORTED_MODULE_1___default().Language.load(languageFileBinary)], ...cancelTokens))) !== null && _a !== void 0 ? _a : null;
        if (cancelTokens.some(token => token.IsCancelled)) {
            return undefined;
        }
        else if (!language) {
...
class PromptContextUtil {
    static async GetContextForActiveNotebookCellBasedOnRadius(activeCell, notebookPanel, radius = 1000, ...cancelTokens) {
        var _a, _b;
        const context = {
            dfs: [],
            vars: [],
...
//# sourceMappingURL=lib_index_js.9fafd2ca0332653436bf.js.map