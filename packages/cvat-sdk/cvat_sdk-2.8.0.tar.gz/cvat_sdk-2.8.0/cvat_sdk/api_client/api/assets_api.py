...
class AssetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_public_endpoint = _Endpoint(
            settings={
                'response_schema': (AssetRead,),
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/assets/{uuid}/public',
                'operation_id': 'retrieve_public',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_public(
        ...
        **kwargs,
        ...
        """retrieve_public  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.retrieve_public(uuid, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['uuid'] = uuid
        return self.retrieve_public_endpoint.call_with_http_info(**kwargs)
