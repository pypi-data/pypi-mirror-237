...
class CfnApplicationV2(
    ...
    def __init__(
        ...
        *,
        ...
        :param application_name: The name of the application.
        :param run_configuration: Identifies the run configuration (start parameters) of a Kinesis Data Analytics application. This section is evaluated only on stack updates for applications in running RUNNING state and has no effect during manual application start.
    ...
    class ApplicationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param sql_application_configuration: The creation and update parameters for a SQL-based Managed Service for Apache Flink application.
