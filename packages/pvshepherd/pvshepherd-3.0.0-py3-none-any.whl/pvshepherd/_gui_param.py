...
LIST_BOX_COMMON_PARAMS_CONFIG = dict(font=FONT, width=40, rowheight=25)

LIST_BOX_COMMON_PARAMS_MAP = dict(background=[("selected", GREEN)], forground=[("selected", WHITE)])
...
ENTRY_PARAMS_ttk = dict(width=30, font=(FONT[0], int(FONT[1] * 1.5)))
...
NOTEBOOK_ACTIVE_TAB_PARAMS = dict(background=[("selected", BLUE)], foreground=[("selected", WHITE)])

NOTEBOOK_PARAMS = dict(background=SOFT_GREY, tabposition="n")
