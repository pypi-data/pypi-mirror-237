...
def local_datas_full_analyse(data_path, data_names, analysis_save_path=None, analyse_param=None):
    ...
    for i, data_name in enumerate(data_names):
        ...
        if not (os.path.exists(os.path.join(data_path, data_name+"/eeg.eeg")) or os.path.exists(os.path.join(data_path, data_name+"/eeg.qle"))):
...
if __name__ == '__main__':
    ...
    local_data_concat_and_analyse(r'E:\dataset\x7_XSR\黄_思蓓之女@20231011_091512\20231011',
                             ["13661579002_1011-10_13_41_1011-14_32_26_0.00_5",
                              "13661579002_1011-14_38_31_1011-16_13_02_0.00_5"],
                             r'E:\dataset\x7_XSR\黄_思蓓之女@20231011_091512\20231011', analyse_param=analyse_param)
