...
def local_datas_full_analyse(data_path, data_names, analysis_save_path=None, analyse_param=None):
    ...
    for i, data_name in enumerate(data_names):
        ...
        if not os.path.exists(os.path.join(data_path, data_name+"/eeg.eeg")):
...
if __name__ == '__main__':
    ...
    local_datas_full_analyse(r'E:\dataset\X7-PSG\JZ_data\20230722',
                             [
                                 "20230722_212527_YCM212V0"
                             ],
                             r'E:\dataset\X7-PSG\JZ_data\20230722', analyse_param=analyse_param)
