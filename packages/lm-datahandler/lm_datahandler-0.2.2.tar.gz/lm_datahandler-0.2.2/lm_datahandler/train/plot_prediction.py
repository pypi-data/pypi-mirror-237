...
if __name__ == '__main__':
    path = r"E:\dataset\X7-PSG\JZ_data\20230714\20230714_221325_YCM191V0"
    ...
    prediction = loadmat(os.path.join(path, "prediction.mat"))['prediction'].squeeze()
    ...
    savemat(os.path.join(r"E:\dataset\X7-PSG\JZ_data\label_and_prediction\4c", "20230714_YCM191.mat"),
            {
