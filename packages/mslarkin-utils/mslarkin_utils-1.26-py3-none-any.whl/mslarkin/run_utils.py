...
def get_service_min_instances(service=None, project_id=None, region=None):
...
def set_service_min_instances(instances, service=None, project_id=None, region=None):
