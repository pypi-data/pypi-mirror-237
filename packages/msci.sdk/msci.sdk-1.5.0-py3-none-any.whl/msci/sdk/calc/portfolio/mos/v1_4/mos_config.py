...
class Strategy:
    ...
    def __init__(self, ref_universe, node_list, node_list_multi_account: List[NodeListPerAccount] = None,
                 trigger_calendar=TriggerCalendarEnum.FIRST_DAY_OF_MONTH):
        ...
        self.universe = self.ref_universe.get_univ(self.ref_universe.universe) if self.ref_universe.universe else [
            'UNX000000034908161']
        ...
        self.benchmark = self.ref_universe.get_univ(self.ref_universe.benchmark) if self.ref_universe.benchmark else [
            'UNX000000034908161']
