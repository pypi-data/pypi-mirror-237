...
def subscribe(symbols, frequency=None, count=1, wait_group=False, wait_group_timeout='10s', unsubscribe_previous=False):
    ...
    for symbol in symbols:
        if symbol.startswith("NEEQ") and frequency is None:
            raise GmError(1027, "exchange为NEEQ时的订阅频率frequency必填")
