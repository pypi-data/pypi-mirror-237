...
class PAModel(Model):
    ...
    def calculate_sum_of_enzymes(self):
        ...
        :return: sum: float: sum of all enzyme variables in mmol/gcdw/h
        """
    ...
    def validata_sensitivity_coefficients(self):
        ...
        sum_FCSC = sum(self.capacity_sensitivity_coefficients[
            self.capacity_sensitivity_coefficients['constraint']=='flux_lb' |
        ...
        sum_ECSC = sum(self.capacity_sensitivity_coefficients[
            ...
            self.capacity_sensitivity_coefficients['constraint']=='enzyme_max'].coefficient)
        ...
        PCSC = self.capacity_sensitivity_coefficients[
            self.capacity_sensitivity_coefficients['constraint']=='proteome'].iloc[0]
        ...
        if round(alpha, 2) == 1.0 and enzyme_flux_sum>= 1+feasibility_deviation and enzyme_flux_sum<= 1-feasibility_deviation:
        ...
        if round(alpha, 2) == 1.0 and enzyme_flux_sum>= 0+feasibility_deviation and enzyme_flux_sum<= 0-feasibility_deviation:
            print('Protein space is fully utilized and variable sensitivity relation is within bounds')
