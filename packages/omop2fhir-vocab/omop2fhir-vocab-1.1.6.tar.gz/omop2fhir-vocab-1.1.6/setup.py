...
DESCRIPTION = 'Convert OMOP vocab to FHIR.'
URL = 'https://github.com/HOT-Ecosystem/omop2fhir-vocab'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'omop2fhir-vocab = omop2fhir_vocab.__main__:cli'
        ]
    },
)
