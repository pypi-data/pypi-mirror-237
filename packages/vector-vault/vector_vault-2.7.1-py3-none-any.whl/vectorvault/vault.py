...
class Vault:
    ...
    def delete_item(self, item_id : int):
        '''
            Deletes the item for the item id passed in
        '''
        if self.verbose == True:
        ...
        for i in range((num_existing_items - 1)):
            if i == item_id:
    ...
    def split_text(self, text, min_threshold=1000, max_threshold=16000, summary=False, summary_final_length=1000):
        ...
        current_length = 0
        sentence_start = 0
        if summary == True: # generate a summary of the text being passed in, and add it to the text
