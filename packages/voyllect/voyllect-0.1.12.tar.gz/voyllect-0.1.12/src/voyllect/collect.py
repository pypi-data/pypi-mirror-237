    ...
    for url_to_collect_dict in urls_to_collect_dicts:
        if url_to_collect_dict['collected'] == urls_to_collect_status:
            ...
            # --------------------------------------------------------
                ...
                print("[LOG] Saving product URL key in 'urls_to_collect_dicts_object_name' file...")
            ...
            print("[LOG] 'urls_to_collect_dicts_object_name' has been saved.")
...
def evaluate_collect_progression(urls_to_collect_object_name):
    ...
    print(f"[LOG] Time: {datetime.datetime.now()}")
