...
class AWSManagedPolicies(enum.Enum):
    ...
    :stability: experimental
    '''
    AMAZON_DATA_ZONE_PROJECT_ROLE_PERMISSIONS_BOUNDARY = "AMAZON_DATA_ZONE_PROJECT_ROLE_PERMISSIONS_BOUNDARY"
    '''
    :stability: experimental
    '''
    AMAZON_DATA_ZONE_PROJECT_DEPLOYMENT_PERMISSIONS_BOUNDARY = "AMAZON_DATA_ZONE_PROJECT_DEPLOYMENT_PERMISSIONS_BOUNDARY"
    '''
    :stability: experimental
    '''
