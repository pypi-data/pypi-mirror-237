...
def test_parse_args(capfd):
    ...
    args_list = [
        ["python3", "../src/char_count_vp/command_line.py", "--string", "d"],
        ["python3", "../src/char_count_vp/command_line.py", "--file", "../src/char_count_vp/x.txt"],
        [
            "python3",
            "../src/char_count_vp/command_line.py",
            "--string",
            "ab",
            "--file",
