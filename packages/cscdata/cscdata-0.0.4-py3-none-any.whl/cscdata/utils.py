...
def clickhosue_create_materialized_table(table_name:str, source_table:str, function:list, order_by:list ,engine:str = 'MergeTee', settings_cur_table:list = None, setting_source_table:list = None):
    """基于base数据生成物化视图"""
