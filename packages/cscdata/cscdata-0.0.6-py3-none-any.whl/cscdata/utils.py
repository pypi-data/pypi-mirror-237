...
def clickhouse_create_file_table_sql(table_name:str ,file_path:str, schema:str or dict, ck_schema = False):
    """
    ...
    if file_path.endswith('.parquet'):
        ...
        raise Exception(f"{file_path}, format not support or wrong path")
