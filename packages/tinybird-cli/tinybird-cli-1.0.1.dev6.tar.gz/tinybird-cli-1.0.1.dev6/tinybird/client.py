...
class TinyB(object):
    ...
    async def create_workspace_branch(
        ...
        params = {
            "name": branch_name,
            "async": "true" if _async else "false",
    ...
    async def validate_s3_connection(self, params: Dict[str, Any]) -> bool:
        params = {"service": "s3", "dry_run": "true", **params}
        bucket_list = None
        try:
    ...
    async def preview_s3_bucket(self, connector: str, bucket_uri: str):
