...
def _score_rag_evaluation(
    ...
    try:
        ...
        for conversation_num, each_conversation in enumerate(y_pred):
                ...
                if persona == "user":
                    ...
                    if "context" in each_turn:
                        ...
                        if "citations" in context:
                            ...
                            retrieved_documents_per_conversation.append(retrieved_documents)
                            logger.debug("Extracting citations from assistant's response.")
                        else:
            ...
            if len(processed_y_pred["model_result"]) != len(processed_y_pred["retrieved_documents"]):
...
def _score_qa(
        ...
        openai_params: Optional[dict] = None,
        use_chat_completion_api: Optional = None,
