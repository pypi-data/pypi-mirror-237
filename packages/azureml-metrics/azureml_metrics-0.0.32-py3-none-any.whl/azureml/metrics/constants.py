...
class Metric:
    ...
    AdaCosineSimilarity = 'ada_cosine_similarity'
    BERTScore = "bertscore"
    ...
    QA_GPT_METRICS_SET = {GPTCoherence, GPTGroundedness, GPTFluency, GPTRelevance, GPTSimilarity, AdaCosineSimilarity}
    ...
    NONSCALAR_CHAT_COMPLETION_SET = NONSCALAR_FILL_MASK_SET | CONVERSATION_RAI_SET
