...
from faust_prometheus.collectors import AsyncioCollector, FaustCollector
...
class FaustPrometheusExporter(object):
    ...
    def __init__(
        ...
        self.registry.register(AsyncioCollector())
        self.registry.register(FaustCollector(faust_app))
