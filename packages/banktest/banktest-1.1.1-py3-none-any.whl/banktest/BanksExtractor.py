...
from banktest.banks_utils import *
from banktest.banks import Banks
import banktest.constants as const
from banktest.Incom_expense import Incom_expense
    ...
    def __process_pdf_and_detect_labels(self, pdf_content, confidence_threshold=0.85):
        try:
            ...
            if images:
                ...
                model_path = pkg_resources.resource_filename('banktest', 'models/best.pt')
