...
from kubernetes_utils import EnhancedKubernetesClient
        ...
        while True:
            try:
                ...
                if retry.exception is None:
                    ...
                    # NOTE: we exponentially backoff and sleep
                    # _before_ checking if the pod has failed to give
                    # it more time to actually record any failure in
                    # the Kubernetes API.
                    #
                    ...
                    logger.debug(
                        "Got an exception that we want to catch, "
