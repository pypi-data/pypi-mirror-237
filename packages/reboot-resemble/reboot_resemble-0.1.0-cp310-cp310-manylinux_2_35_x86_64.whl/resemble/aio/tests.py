...
from respect.logging import CRITICAL, set_log_level
...
class Resemble:
    ...
    def __init__(self):
        ...
        self._channel_manager = _ChannelManager(self._resolver)
    ...
    def https_localhost_direct_uri(
        ...
        return f'https://localhost.direct:{envoy.port}{path}'
    ...
    def resolve(
        ...
        """
        if servicer not in self._servicers:
            raise ValueError('Servicer has not been brought up')

        return self._resolver.resolve(servicer, actor_id)
