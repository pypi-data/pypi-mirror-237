...
filters = Filter()
filters.add(TimestampFilter(gte="2022-03-15T00:00:00Z", lte="2023-07-15T00:00:00Z"))

# create test_session object of TestSession instance
test_session = TestSession(project_name="testingProject", run_name = "AB-event-unlabelled-20231020071110", access_key="LGXJjQFD899MtVSrNHGH", secret_key="TC466Qu9PhpOjTuLu5aGkXyGbM7SSBeAzYH6HpcP", host="http://3.111.106.226:8080")
...
model_comparison_check = event_ab_test(test_session=test_session, 
                                       dataset_name="test-lm-loader-20-oct-v1",
