...
class ServerConnectionMonitor(object):
    ...
    def tick(self, connection_probe: Callable[..., bool]) -> ConnectionStatus:
    ...
    def _on_ping_result(self, success: bool) -> ConnectionStatus:
        ...
        self.has_server_connection = success
