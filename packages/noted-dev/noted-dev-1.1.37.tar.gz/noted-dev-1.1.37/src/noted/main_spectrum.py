...
# carmen@itcs-wifi-macbook noted % python3 noted/src/noted/main_spectrum.py
...
def main(): 
    ...
    while True:
        ...
        # df_filter.loc[2] = ['1693986182', 'NaN', 'OUT LOAD THRESHOLD EXCEEDED', 'l513-e-rjup1-1', '172.24.46.116', 'MINOR', '', 'irb.3530'] # @remove: just for testing pourposes. NOTE: irb.3541 is a backup link
        ...
        list_timestamp = [item.split('_', 1)[0] for item in list_old_alarms] # Not remove from herre
