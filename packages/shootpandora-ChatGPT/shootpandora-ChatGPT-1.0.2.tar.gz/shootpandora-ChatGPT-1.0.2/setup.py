...
from src.shootpandora import __version__
...
setup(
    ...
    extras_require={
        ...
        'cloud': ['shootpandora-cloud~=1.0.2'],
    },
    entry_points={
        'console_scripts': [
    ...
    project_urls={
        'Source': 'https://github.com/shoot82003/shootpandora',
        'Tracker': 'https://github.com/shoot82003/shootpandora/issues',
    },
    classifiers=[
