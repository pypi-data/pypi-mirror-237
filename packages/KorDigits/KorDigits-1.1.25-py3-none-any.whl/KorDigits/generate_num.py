...
class Label2Num:
    ...
    def _label_0(self, tagging):
        ...
        output = output.replace("~", " 에서 ").replace(".", "쩜").replace("공공분", "")
...
if __name__ == '__main__':
    ...
    print(label2num.generate("이날 청주 공군 제17전투 비행단 기지에 안착한 에프 삼십오 A 두 대는 수직꼬리날개에 007 008 번호가 부여된 전투기로 지난 3월 29일에 도입한 005 006에 이어 두 번째다."))
