    ...
    def sample_model(
        ...
        **kwargs,
        ...
        Args:
            ...
            parameters (Optional[JijLeapHybridCQMParameters]): Parameters used in Dwave Leap Hybrid CQMSampler. If `None`, the default value of the JijDA3SolverParameters will be set.
