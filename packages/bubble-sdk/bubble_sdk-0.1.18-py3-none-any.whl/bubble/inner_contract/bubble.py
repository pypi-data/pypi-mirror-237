...
class Bubble(InnerContract):
    ...
    def create_bubble(self):
        ...
        """
        return self.function(InnerFunction.bubble_createBubble)

    def release_bubble(self, bubble_id: int):
        """
        release bubble.
        """
        return self.function(InnerFunction.bubble_releaseBubble, bubble_id=bubble_id)
