...
from company import act, foundation_one, guardant_360, oncomine
...
def get_test_name(pdf_file_path: str, txt_file_path: str, xml_file_path: str) -> str:
    ...
    try:
        if txt_file_path is None and xml_file_path is None:
            return oncomine.parse_assay(pdf_file_path)
        elif txt_file_path is not None:
...
def batch(args):
    ...
    vcf = VCF(genome, transcripts, cds, nm_to_ens, args.ref, args.ref_gene) if gen_vcf else None
