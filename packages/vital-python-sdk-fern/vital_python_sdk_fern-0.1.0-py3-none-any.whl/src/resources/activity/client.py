...
class ActivityClient:
    ...
    def get(
        ...
        *,
        ...
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment.value}/", f"v2/summary/activity/{user_id}"),
    ...
    def get_raw(
        ...
        *,
        ...
        _response = httpx.request(
            "GET",
            urllib.parse.urljoin(f"{self._environment.value}/", f"v2/summary/activity/{user_id}/raw"),
            params={"provider": provider, "start_date": start_date, "end_date": end_date},
            headers=remove_none_from_headers({"x-vital-api-key": self.api_key}),
            timeout=60,
        )
