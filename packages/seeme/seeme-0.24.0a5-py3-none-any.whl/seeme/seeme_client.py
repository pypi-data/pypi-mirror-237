...
class Client():
  ...
  def get_model_versions(self, model_id) -> List[ModelVersion]:
    self.requires_login()
  ...
  def get_model_version(self, model_id, version_id) -> ModelVersion:
    self.requires_login()
  ...
  def create_model_version(self, model_id, version) -> ModelVersion:
    self.requires_login()
  ...
  def update_model_version(self, version) -> ModelVersion:
    self.requires_login()
  ...
  def delete_model_version(self, model_id, version_id) -> str:
    self.requires_login()
  ...
  def upload_model_version(self, version, folder:str="data", filename:str="export.pkl") -> ModelVersion:
  ...
  def upload_model_version_logo(self, model_id, version_id, folder:str="data", filename:str="logo.jpg") -> ModelVersion:
    if filename.endswith("jpg"):
      content_type="image/jpg"
    elif filename.endswith("jpeg"):
      content_type="image/jpeg"
  ...
  # -- Share model --
  def share_model(self, model_id, email, send_invite=False) -> Share:
    self.requires_login()
  ...
  def delete_model_share(self, model_id, share_id) -> str:
    self.requires_login()
  ...
  # -- CRUD JOBS --
  def get_jobs(self, application_id="", states=[JobStatus.WAITING, JobStatus.STARTED,JobStatus.FINISHED, JobStatus.ERROR], job_types=[JobType.TRAINING]) -> List[Job]:
    self.requires_login()
  ...
  def predict(self, model_id:str, item, input_type="image_classification") -> Inference:
      return self.inference(model_id, item, input_type)

  def inference(self, model_id:str, item, input_type="image_classification") -> Inference:
    self.requires_login()
  ...
  def version_predict(self, version, item, input_type="image_classification") -> Inference:
    return self.version_inference(version, item, input_type)

  # Obsolete, will be replaced by version_predict
  def version_inference(self, version, item, input_type="image_classification") -> Inference:
    self.requires_login()
  ...
  def update_inference(self, inference) -> Inference:
    self.requires_login()
  ...
  def get_inferences(self, model_id:str, model_version_ids=[], page_count=0, page_size=25, include_already_added=False, show_hidden=False) -> List[Inference]:
    self.requires_login()
  ...
  def add_inferences(self, dataset_id, dataset_version_id, dataset_split_id, add_inferences) -> AddInferences:
    self.requires_login()
  ...
  def get_inference_stats(self, model_id ) -> float:
    self.requires_login()
  ...
  def create_dataset_version(self, dataset_id, dataset_version) -> DatasetVersion:
    self.requires_login()
  ...
  def delete_dataset_version(self, dataset_id, dataset_version) -> str:
    self.requires_login()
  ...
  def delete_dataset_label(self, dataset_id, dataset_version_id, label) -> str:
    self.requires_login()
  ...
  def delete_dataset_split(self, dataset_id, dataset_version_id, split) -> str:
    self.requires_login()
  ...
  def download_dataset(self, dataset_id, dataset_version_id, split_id="", extract_to_folder="data", download_file="dataset.zip", remove_download_file=True, export_format:DatasetFormat=None):
    self.requires_login()
  ...
  def upload_dataset_version(self, dataset_id, dataset_version_id, folder="data", filename="dataset.zip", format:DatasetFormat=None) -> DatasetVersion:
    self.requires_login()
    ...
    if format:
      if format in self.supported_dataset_import_formats:
        dataset_api = f"{dataset_api}/{format.value}"
      else:
  ...
  def find_label_with_name(self, labels, name) -> Label:
    return self.find_item_in_array(labels, "name", name, first_item=True, t=Label)
  
  def find_split_with_name(self, splits, name) -> DatasetSplit:
