...
from typing import TYPE_CHECKING, Any, Callable, ClassVar, Dict, Iterator, List, Optional, Sequence, Tuple, Type, cast
...
class FeaturesMeta(type):
    ...
    def __getitem__(cls, item: Any) -> Any:
        ...
        new_features = list([*getattr(cls, "features", ()), *item])
    ...
    def __sub__(self, other):
        if isinstance(other, type) and issubclass(other, Features):
...
class FeaturesImpl(metaclass=FeaturesMeta):
    ...
    __chalk_class_definition__: ClassVar[str]
    ...
    __chalk_primary__: ClassVar[Feature]  # The primary key feature
