...
class TestBalanceService:
    ...
    def test_native_token_balance_success(self, client: CovalentClient):
        ...
        native_token = client.balance_service.get_native_token_balance("eth-mainnet", "demo.eth", "AUD")
    ...
    def test_erc20_token_transfer_by_page_fail(self, client: CovalentClient):
        ...
        native_token_balance_fail = client.balance_service.get_erc20_transfers_for_wallet_address_by_page("eth-mainnet", "demo")
        assert native_token_balance_fail.error is True
