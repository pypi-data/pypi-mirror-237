...
class ServiceProcessor:
    ...
    def _replace_artifact_data(self, data_service, data_artifact, artifact_type):
    ...
    def import_command(self, data_config, file_path, update_artifact, service_name='', version_name='', icon='',
        ...
        if data_config.get(constant.ARTIFACT):
            ...
            if constant.FILE_ARTIFACT_RELATION in deploy_metadata_config.get(constant.SUPPLIER_DEPLOY_METADATA, {}):
                service_config = self._replace_artifact_data(service_config, data_artifact,
                                                             constant.FILE_ARTIFACT_RELATION)
            elif constant.ARTIFACT_RELATION in deploy_metadata_config.get(constant.SUPPLIER_DEPLOY_METADATA, {}):
                service_config = self._replace_artifact_data(service_config, data_artifact, constant.ARTIFACT_RELATION)
            elif constant.ACR_IMAGE_ARTIFACT_RELATION in deploy_metadata_config.get(constant.SUPPLIER_DEPLOY_METADATA,
                                                                                    {}):
                service_config = self._replace_artifact_data(service_config, data_artifact,
                                                             constant.ACR_IMAGE_ARTIFACT_RELATION)
            elif constant.HELM_CHART_ARTIFACT_RELATION in deploy_metadata_config.get(constant.SUPPLIER_DEPLOY_METADATA,
                                                                                     {}):
                service_config = self._replace_artifact_data(service_config, data_artifact,
    ...
    def export_command(self, service_name, file_path):
