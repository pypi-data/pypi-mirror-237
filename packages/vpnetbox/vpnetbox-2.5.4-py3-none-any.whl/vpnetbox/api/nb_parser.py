...
from vpnetbox.api import wrappers
...
class NbParser:
    ...
    def strict_int(self, *keys) -> int:
        ...
        :raise NbParserError: If the value is not a int or key is absent or value is 0.
        """
        return self.get_int(*keys)
