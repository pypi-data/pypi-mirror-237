...
class Addresses(Base):
    ...
    def get(self, **kwargs) -> LDAny:
        ...
        Finding parameters that are present in the WEB UI:
        --------------------------------------------------
        ...
        :param vrf_id: Unique ID of the assigned VRF.
        :type vrf_id: int or List[int]
        :example vrf_id: [1, 2]

        :param present_in_vrf_id: Unique ID of the present in VRF.
        :type present_in_vrf_id: int or List[int]
        :example present_in_vrf_id: [1, 2]

        :param tenant_id: Unique ID of the tenant.
        :type tenant_id: int or List[int]
        :example tenant_id: [1, 2]

        :param tenant_group_id: Unique ID of the tenant group.
        :type tenant_group_id: int or List[int]
        :example tenant_group_id: [1, 2]

        :param device_id: Unique ID of the assigned device.
        :type device_id: int or List[int]
        :example device_id: [1, 2]

        :param virtual_machine_id: Unique ID of the virtual machine.
