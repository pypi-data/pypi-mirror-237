...
class NbHandler:
    ...
    def __copy__(self) -> NbHandler:
        ...
        """
        api_params = getattr(self.api.addresses, "_init_params")
        params_d = {s: getattr(self.api.addresses, s) for s in api_params}
    ...
    def get_circuit_types(self, **kwargs) -> None:
        ...
        :param kwargs: Finding parameters are described in the CircuitTypes object.
        :return: None. Update self object.
        """
        self.nbd.circuit_types = self.api.circuit_types.get(**kwargs)
