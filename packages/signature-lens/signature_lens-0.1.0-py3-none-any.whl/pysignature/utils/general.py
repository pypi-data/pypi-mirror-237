...
from pysignature.utils import TryExcept, emojis
from pysignature.utils.downloads import curl_download, gsutil_getsize
from pysignature.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from pysignature.models.common import AutoShape, DetectMultiBackend
