...
from signatureLens.utils import TryExcept, emojis
from signatureLens.utils.downloads import curl_download, gsutil_getsize
from signatureLens.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from signatureLens.models.common import AutoShape, DetectMultiBackend
