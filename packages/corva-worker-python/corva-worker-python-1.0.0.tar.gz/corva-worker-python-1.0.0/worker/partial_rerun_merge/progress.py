...
class MergingProgress:
    ...
    def __init__(self, partial_rerun_id: int, app_id: int, api: API):
        """
        ...
        Returns:
            None
        """
        self.partial_rerun_id = partial_rerun_id
        self.app_id = app_id
    ...
    def get_url_path(self) -> str:
        ...
        """
        return f"/v2/partial_reruns/{self.partial_rerun_id}/app_progress/{self.app_id}"
    ...
    def to_dict(self) -> dict:
        ...
        return dict(app_progress=dict(status=self.status.value, dataset_progresses=dataset_progresses))
    ...
    def update_status(self) -> None:
        ...
        body = self.to_dict()
        self.api.patch(url_path, data=body)
