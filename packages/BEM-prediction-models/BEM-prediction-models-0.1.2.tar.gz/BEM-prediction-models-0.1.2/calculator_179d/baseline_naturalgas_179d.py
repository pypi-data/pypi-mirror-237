...
class baseline_naturalgas_179d():
    ...
    def estimate_annual_naturalgas(self, calculator_user_inputs):
        ...
        baseline_naturalgas_179d_normalized = self.baseline_naturalgas_model.predict(
            input_array
        )[0]
        baseline_naturalgas_179d_value = (
            baseline_naturalgas_179d_normalized*
            calculator_user_inputs['gross_floor_area']
        )

        return baseline_naturalgas_179d_value