...
class proposed_electricity_179d():
        ...
        def estimate_annual_electricity(self, calculator_user_inputs):
            ...
            proposed_electricity_179d_normalized = self.proposed_electricity_model.predict(
                input_array
            )[0]
            proposed_electricity_179d_value = (
                proposed_electricity_179d_normalized*
                calculator_user_inputs['gross_floor_area']
            )

            return proposed_electricity_179d_value