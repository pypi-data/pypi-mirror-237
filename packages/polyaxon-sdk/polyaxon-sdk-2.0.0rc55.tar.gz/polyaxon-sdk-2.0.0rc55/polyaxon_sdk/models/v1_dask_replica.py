...
class V1DaskReplica(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1DaskReplica:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1DaskReplica:
        """Create an instance of V1DaskReplica from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return V1DaskReplica.parse_obj(obj)

        _obj = V1DaskReplica.parse_obj({
