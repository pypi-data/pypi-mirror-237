...
class ServiceAccountsV1Api(object):
    ...
    def create_service_account(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], body : Annotated[V1ServiceAccount, Field(..., description="ServiceAccount body")], **kwargs) -> V1ServiceAccount:  # noqa: E501
        ...
        >>> thread = api.create_service_account(owner, body, async_req=True)
        >>> result = thread.get()
    ...
    def create_service_account_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], body : Annotated[V1ServiceAccount, Field(..., description="ServiceAccount body")], **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_service_account_with_http_info(owner, body, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def create_service_account_token(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Rntity")], body : Annotated[V1Token, Field(..., description="Token body")], **kwargs) -> V1Token:  # noqa: E501
        """Create service account token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_service_account_token(owner, entity, body, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def create_service_account_token_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Rntity")], body : Annotated[V1Token, Field(..., description="Token body")], **kwargs):  # noqa: E501
        """Create service account token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_service_account_token_with_http_info(owner, entity, body, async_req=True)
        >>> result = thread.get()
    ...
    def get_service_account(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the entity")], **kwargs) -> V1ServiceAccount:  # noqa: E501
        ...
        >>> thread = api.get_service_account(owner, uuid, async_req=True)
        >>> result = thread.get()
    ...
    def get_service_account_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the entity")], **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_service_account_with_http_info(owner, uuid, async_req=True)
        >>> result = thread.get()
    ...
    def get_service_account_token(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Entity: project name, hub name, registry name, ...")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the sub-entity")], **kwargs) -> V1Token:  # noqa: E501
        ...
        >>> thread = api.get_service_account_token(owner, entity, uuid, async_req=True)
        >>> result = thread.get()
    ...
    def get_service_account_token_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Entity: project name, hub name, registry name, ...")], uuid : Annotated[StrictStr, Field(..., description="Uuid identifier of the sub-entity")], **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_service_account_token_with_http_info(owner, entity, uuid, async_req=True)
        >>> result = thread.get()
    ...
    def patch_service_account(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], sa_uuid : Annotated[StrictStr, Field(..., description="UUID")], body : Annotated[V1ServiceAccount, Field(..., description="ServiceAccount body")], **kwargs) -> V1ServiceAccount:  # noqa: E501
        ...
        >>> thread = api.patch_service_account(owner, sa_uuid, body, async_req=True)
        >>> result = thread.get()

        :param owner: Owner of the namespace (required)
        :type owner: str
        :param sa_uuid: UUID (required)
        :type sa_uuid: str
        :param body: ServiceAccount body (required)
        :type body: V1ServiceAccount
        :param async_req: Whether to execute the request asynchronously.
    ...
    def patch_service_account_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], sa_uuid : Annotated[StrictStr, Field(..., description="UUID")], body : Annotated[V1ServiceAccount, Field(..., description="ServiceAccount body")], **kwargs):  # noqa: E501
        ...
        >>> thread = api.patch_service_account_with_http_info(owner, sa_uuid, body, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def patch_service_account_token(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Rntity")], token_uuid : Annotated[StrictStr, Field(..., description="UUID")], body : Annotated[V1Token, Field(..., description="Token body")], **kwargs) -> V1Token:  # noqa: E501
        """Patch service account token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_service_account_token(owner, entity, token_uuid, body, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def patch_service_account_token_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Rntity")], token_uuid : Annotated[StrictStr, Field(..., description="UUID")], body : Annotated[V1Token, Field(..., description="Token body")], **kwargs):  # noqa: E501
        """Patch service account token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_service_account_token_with_http_info(owner, entity, token_uuid, body, async_req=True)
        >>> result = thread.get()
    ...
    def update_service_account(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], sa_uuid : Annotated[StrictStr, Field(..., description="UUID")], body : Annotated[V1ServiceAccount, Field(..., description="ServiceAccount body")], **kwargs) -> V1ServiceAccount:  # noqa: E501
        ...
        >>> thread = api.update_service_account(owner, sa_uuid, body, async_req=True)
        >>> result = thread.get()
    ...
    def update_service_account_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], sa_uuid : Annotated[StrictStr, Field(..., description="UUID")], body : Annotated[V1ServiceAccount, Field(..., description="ServiceAccount body")], **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_service_account_with_http_info(owner, sa_uuid, body, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def update_service_account_token(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Rntity")], token_uuid : Annotated[StrictStr, Field(..., description="UUID")], body : Annotated[V1Token, Field(..., description="Token body")], **kwargs) -> V1Token:  # noqa: E501
        """Update service account token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_service_account_token(owner, entity, token_uuid, body, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def update_service_account_token_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="Owner of the namespace")], entity : Annotated[StrictStr, Field(..., description="Rntity")], token_uuid : Annotated[StrictStr, Field(..., description="UUID")], body : Annotated[V1Token, Field(..., description="Token body")], **kwargs):  # noqa: E501
        """Update service account token  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_service_account_token_with_http_info(owner, entity, token_uuid, body, async_req=True)
        >>> result = thread.get()
