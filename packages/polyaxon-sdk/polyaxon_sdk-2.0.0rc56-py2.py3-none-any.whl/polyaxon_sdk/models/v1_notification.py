...
class V1Notification(BaseModel):
    ...
    __properties = ["connections", "trigger"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1Notification:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1Notification:
        """Create an instance of V1Notification from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return V1Notification.parse_obj(obj)

        _obj = V1Notification.parse_obj({
