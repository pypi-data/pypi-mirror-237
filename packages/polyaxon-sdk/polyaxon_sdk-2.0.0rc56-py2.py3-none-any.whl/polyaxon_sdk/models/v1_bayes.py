...
class V1Bayes(BaseModel):
    """
    V1Bayes
    """
    kind: Optional[StrictStr] = 'bayes'
    params: Optional[Dict[str, Dict[str, Any]]] = None
    num_initial_runs: Optional[StrictInt] = Field(None, alias="numInitialRuns")
    max_iterations: Optional[StrictInt] = Field(None, alias="maxIterations")
    utility_function: Optional[Dict[str, Any]] = Field(None, alias="utilityFunction")
    ...
    __properties = ["kind", "params", "numInitialRuns", "maxIterations", "utilityFunction", "metric", "seed", "concurrency", "tuner", "earlyStopping"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1Bayes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1Bayes:
        """Create an instance of V1Bayes from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return V1Bayes.parse_obj(obj)

        _obj = V1Bayes.parse_obj({
            "kind": obj.get("kind") if obj.get("kind") is not None else 'bayes',
            "params": obj.get("params"),
            "num_initial_runs": obj.get("numInitialRuns"),
            "max_iterations": obj.get("maxIterations"),
            "utility_function": obj.get("utilityFunction"),
