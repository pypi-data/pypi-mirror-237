...
class V1EntityStatusBodyRequest(BaseModel):
    """
    ...
    __properties = ["owner", "project", "uuid", "condition", "force"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1EntityStatusBodyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1EntityStatusBodyRequest:
        """Create an instance of V1EntityStatusBodyRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return V1EntityStatusBodyRequest.parse_obj(obj)

        _obj = V1EntityStatusBodyRequest.parse_obj({
            "owner": obj.get("owner"),
