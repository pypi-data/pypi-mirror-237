...
def lokaleDagsorden(self, kunAktuelAfdeling=True):
    ...
    for _ in range(requests):
        urls.append(
            f"https://www.lectio.dk/lectio/681/SkemaAvanceret.aspx?type=ShowListAll&starttime={today}T00:00:00&endtime={tomorrow}T00:00:00&dagsbemaerk=0&lokalesel={','.join(lokaler[0:30]).replace('RO', '')}"
        )
        lokaler = lokaler[30:]
