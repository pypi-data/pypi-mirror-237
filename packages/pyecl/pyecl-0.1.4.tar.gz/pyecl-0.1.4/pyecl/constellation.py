...
class Constellation:
    ...
    def _download_cloud_file(
        ...
        Default byte_size is None, in which case file will download in a single request.
        Note, byte ranges are inclusive, so getting 0-1024, and then 1024-2048 would downlaod the 1024th byte twice."""
