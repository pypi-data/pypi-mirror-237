...
from profiler.spark_setup import spark
...
class Profiler:
    ...
    def __init__(self, dictionary):
        ...
        self.file_name = dictionary['name']
    ...
    def config(self, output_format=None):
        ...
        for index, name in enumerate(cols_names, start=1):
            ...
            config_dict[column_name] = column_dict
        return config_dict
    ...
    def global_report(self):
        ...
        global_stats['file_name'] = self.file_name
    ...
    def column_report(self, config=None):
        ...
        data_stats = {}
        data_stats['file_name'] = self.file_name
        ...
        for df_col, vals in eval_dict.items():
            ...
            d['data_type'] = df.schema[df_col].dataType
            ...
            for calc, params in vals.items():
                ...
                if calc == 'outlier':
                    ...
                    if test_val != None:
                        ...
                        # filtered dataframe
                        df_filt = df.select(df_col).groupBy(df_col).count()\
    ...
    def column_pattern(self, config=None):
        ...
        col_pattern = {}
        col_pattern['file_name'] = self.file_name
