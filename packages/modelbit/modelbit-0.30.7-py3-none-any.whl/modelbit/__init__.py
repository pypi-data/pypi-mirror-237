...
@errorHandler("Unable to copy deployment.")
def copy_deployment(deployment_name: str, to_branch: str, from_branch: Optional[str] = None):
  """
  https://doc.modelbit.com/api-reference/copy_deployment
  """
