...
class PurchaseOrderLineItemRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, tracking_categories, *args, **kwargs):  # noqa: E501
        """PurchaseOrderLineItemRequest - a model defined in OpenAPI

        Args:
            tracking_categories ([str]): The purchase order line item's associated tracking categories.
        ...
        Keyword Args:
            ...
            description (str, none_type): A description of the good being purchased.. [optional]  # noqa: E501
            ...
            exchange_rate (str, none_type): The purchase order line item's exchange rate.. [optional]  # noqa: E501
            company (str, none_type): The company the purchase order line item belongs to.. [optional]  # noqa: E501
