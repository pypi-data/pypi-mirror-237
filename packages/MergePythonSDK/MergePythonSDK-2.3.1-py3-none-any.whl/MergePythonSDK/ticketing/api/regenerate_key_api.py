...
class RegenerateKeyApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.regenerate_key_create_endpoint = _Endpoint(
            settings={
                'response_type': (RemoteKey,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/ticketing/v1/regenerate-key',
            ...
            root_map={
                ...
                'location_map': {
                    'remote_key_for_regeneration_request': 'body',
                },
    ...
    def regenerate_key_create(
        ...
        **kwargs
        ...
        >>> thread = api.regenerate_key_create(remote_key_for_regeneration_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['remote_key_for_regeneration_request'] = \
            remote_key_for_regeneration_request
        return self.regenerate_key_create_endpoint.call_with_http_info(**kwargs)
