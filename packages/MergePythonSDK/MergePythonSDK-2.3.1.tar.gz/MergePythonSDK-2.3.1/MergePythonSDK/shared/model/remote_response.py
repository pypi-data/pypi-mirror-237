...
class RemoteResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, method, path, status, response, *args, **kwargs):  # noqa: E501
        """RemoteResponse - a model defined in OpenAPI
        ...
        self.response_headers = kwargs.get("response_headers", None)
    ...
    @convert_js_args_to_python_args
    def __init__(self, method, path, status, response, *args, **kwargs):  # noqa: E501
        """RemoteResponse - a model defined in OpenAPI
        ...
        self.status = status
        self.response = response
        self.response_headers = kwargs.get("response_headers", dict())
