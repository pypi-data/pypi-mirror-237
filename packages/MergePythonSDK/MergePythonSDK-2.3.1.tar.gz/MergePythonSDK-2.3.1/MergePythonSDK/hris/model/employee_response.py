...
class EmployeeResponse(ModelNormal):
    ...
    def __init__(self, model, warnings, errors, *args, **kwargs):  # noqa: E501
        ...
        self.model: Union["Employee", {"company": "Company", "employments": "Employment", "groups": "Group", "home_location": "Location", "manager": "Employee", "pay_group": "PayGroup", "team": "Team", "work_location": "Location"}] = model
