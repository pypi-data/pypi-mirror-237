...
class Collection(ModelNormal):
    ...
    def openapi_types():
        ...
        defined_types = {
            ...
            'collection_type': (CollectionTypeEnum, str, none_type,),
            'parent_collection': (str, none_type, none_type,),  # noqa: E501
            'remote_was_deleted': (bool, none_type,),  # noqa: E501
            'access_level': (AccessLevelEnum, str, none_type,),
            'modified_at': (datetime, none_type,),  # noqa: E501
            'field_mappings': ({str: (bool, dict, float, int, list, str, none_type)}, none_type, none_type,),  # noqa: E501
            'remote_data': ([RemoteData], none_type, none_type,),  # noqa: E501
        }
        expands_types = {"parent_collection": "Collection"}
    ...
    attribute_map = {
        ...
        'parent_collection': 'parent_collection',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str, none_type): The collection's name.. [optional]  # noqa: E501
            description (str, none_type): The collection's description.. [optional]  # noqa: E501
            collection_type (bool, dict, float, int, list, str, none_type): The collection's type.  * `LIST` - LIST * `PROJECT` - PROJECT. [optional]  # noqa: E501
            parent_collection (str, none_type): The parent collection for this collection.. [optional]  # noqa: E501
            remote_was_deleted (bool): Indicates whether or not this object has been deleted by third party webhooks.. [optional]  # noqa: E501
            access_level (bool, dict, float, int, list, str, none_type): The level of access a User has to the Collection and its sub-objects.  * `PRIVATE` - PRIVATE * `COMPANY` - COMPANY * `PUBLIC` - PUBLIC. [optional]  # noqa: E501
        ...
        self.parent_collection = kwargs.get("parent_collection", None)
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        self.collection_type: Union[bool, dict, float, int, list, str, none_type] = kwargs.get("collection_type", None)
        self.parent_collection: Union[str, none_type] = kwargs.get("parent_collection", None)
        self.remote_was_deleted: Union[bool] = kwargs.get("remote_was_deleted", bool())
        self.access_level: Union[bool, dict, float, int, list, str, none_type] = kwargs.get("access_level", None)
