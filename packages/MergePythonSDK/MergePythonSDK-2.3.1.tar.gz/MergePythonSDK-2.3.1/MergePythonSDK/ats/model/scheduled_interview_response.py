...
class ScheduledInterviewResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, model, warnings, errors, *args, **kwargs):  # noqa: E501
        """ScheduledInterviewResponse - a model defined in OpenAPI
    ...
    def __init__(self, model, warnings, errors, *args, **kwargs):  # noqa: E501
        ...
        self.model: Union["ScheduledInterview", {"application": "Application", "interviewers": "RemoteUser", "job_interview_stage": "JobInterviewStage", "organizer": "RemoteUser"}] = model
