...
class TestPurchaseOrderResponse(unittest.TestCase):
    ...
    def testPurchaseOrderResponse(self):
        ...
        # model = PurchaseOrderResponse()  # noqa: E501

        """
        No test json responses were defined for PurchaseOrderResponse
        """
        raw_json = None
        ...
        deserialized = ApiClient().deserialize(response_mock, (PurchaseOrderResponse,), False)
