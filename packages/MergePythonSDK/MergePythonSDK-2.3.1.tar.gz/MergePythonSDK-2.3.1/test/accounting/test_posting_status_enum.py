...
class TestPostingStatusEnum(unittest.TestCase):
    """PostingStatusEnum unit test stubs"""
    ...
    def testPostingStatusEnum(self):
        """Test PostingStatusEnum"""
        # FIXME: construct object with mandatory attributes with example values
        # model = PostingStatusEnum()  # noqa: E501
