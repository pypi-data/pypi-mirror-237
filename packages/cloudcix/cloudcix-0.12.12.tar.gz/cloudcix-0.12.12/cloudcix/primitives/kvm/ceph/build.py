...
def build(host_ip: str, device_size: int, device_name: str, pool_name: str) -> Tuple[int, str]:
    logger = logging.getLogger(__name__)
    logger.debug('Compiling data for ceph.build')
    ...
    template = JINJA_ENV.get_template('kvm/ceph/build.sh.j2')
