...
def quiesce(host_ip: str, vm_name: str) -> Tuple[int, str]:
    logger = logging.getLogger(__name__)
    logger.debug('Compiling data for vm.quiesce')
    ...
    if undefined_vars:
        return False, f'The following variables were not passed to the kvm.vm.quiesce template : {undefined_vars}'
