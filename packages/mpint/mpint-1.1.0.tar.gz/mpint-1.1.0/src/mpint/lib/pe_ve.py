...
peaks = {
    ...
    'VitE_1210' : peak(x_pos = 1210, x_min = 1200, x_max = 1220),
    'VitE_1260' : peak(x_pos = 1260, x_min = 1240, x_max = 1280)}
"""
