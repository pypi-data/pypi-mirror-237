...
class Object:
    ...
    def calculate (self):
        ...
        self.df = pd.DataFrame({'Source': [self.Timestamp,self.Outlet.fluid,self.Ti_degC,self.Pi_bar,self.F_Sm3h,self.F_m3h,self.F_kgh,self.F_kgs,self.F_m3s,self.F_Sm3s,], },
                      index = ['Timestamp','src_fluid','src_Ti_degC','src_Pi_bar','src_F_Sm3h','src_F_m3h', 'src_F_kgh','src_F_kgs','src_F_m3s','src_F_Sm3s'])
