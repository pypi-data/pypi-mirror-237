...
class Project(APIObject, BrowserMixin):
    ...
    @deprecated(
        deprecated_since_version="v2.28.2",
        will_remove_version="v3.0.0",
        message="The use of get_leaderboard_ui_permalink is deprecated. Use get_uri instead.",
    )
    ...
    @deprecated(
        deprecated_since_version="v2.28.2",
        will_remove_version="v3.0.0",
        message="The use of open_leaderboard_browser is deprecated. Use open_in_browser instead.",
    )
