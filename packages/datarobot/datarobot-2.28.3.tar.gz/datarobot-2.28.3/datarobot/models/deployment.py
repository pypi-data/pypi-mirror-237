...
class Deployment(APIObject, DeploymentQueryBuilderMixin):
    ...
    def validate_replacement_model(self, new_model_id):
        ...
        status : str
            ...
            If the status is passing or warning, use
            :meth:`~datarobot.models.Deployment.replace_model` to perform a model replacement. If
            the status is failing, refer to ``checks`` for more detail on why the new model cannot
