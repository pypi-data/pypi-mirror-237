...
This release subsumes 2.28.2.

New Features
************
- Added a new method for getting the canonical URI for a class :meth:`Project.get_uri <datarobot.models.Project.get_uri>` & :meth:`Model.get_uri <datarobot.models.Model.get_uri>`
- Added a new method for opening a class in a browser per their URI :meth:`Project.get_uri <datarobot.models.Project.open_in_browser>` & :meth:`Model.open_in_browser <datarobot.models.Model.open_in_browser>`
...
- Removed ICE plots from Feature Effects/Feature Fit as they were experimental APIs.

API Changes
***********
- The Python client will now output a `ProjectDeprecationWarning` when you attempt to access certain resources (projects, models, deployments, etc.) that are deprecated or disabled by the DataRobot platform migration to Python 3.

Deprecation Summary
*******************
- ``Model.get_leaderboard_ui_permalink`` was marked as deprecated and will be removed in v3.0.0.
  Please use :meth:`Model.get_uri <datarobot.models.Model.get_uri>` instead.
- ``Model.open_model_browser`` was marked as deprecated and will be removed in v3.0.0.
  Please use :meth:`Model.open_in_browser <datarobot.models.Model.open_in_browser>` instead.
- ``Project.get_leaderboard_ui_permalink`` was marked as deprecated and will be removed in v3.0.0.
  Please use :meth:`Project.get_uri <datarobot.models.Project.get_uri>` instead.
- ``Project.open_leaderboard_browser`` was marked as deprecated and will be removed in v3.0.0.
  Please use :meth:`Project.open_in_browser <datarobot.models.Project.open_in_browser>` instead.
...
- Deployment Improvements:
  ...
  - :meth:`Deployment.create_from_custom_model_image<datarobot.models.Deployment.create_from_custom_model_image>` can be used to create a deployment from a custom model image.
