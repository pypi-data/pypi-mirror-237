...
def fetch_data_table(api_key, show_progress,  coid, mdate, columns):
    ...
    try :
        data = TejToolAPI.get_history_data(ticker = coid, columns = columns, start = mdate['gte'], end = mdate['lte'])
        # TejToolAPI.get_dask_df
...
def CreateFundamentalSchema(engine, schema_name, db_name):
    # Create DB schema（if not exists）
    with engine.connect() as connection:
        connection.execute(f"""
            CREATE SCHEMA IF NOT EXISTS {schema_name};
            CREATE TABLE IF NOT EXISTS {schema_name}.{db_name} (
            coid VARCHAR(20) NOT NULL,
            mdate DATETIME NOT NULL,
            Open FLOAT,
            Market_Cap_Dollars FLOAT,
            ROI FLOAT,
            Close FLOAT,
            Common_Stock_Shares_Issued_Thousand_Shares FLOAT,
            Qfii_Diff_Amt FLOAT,
            Industry_Eng VARCHAR,
            YoY_Monthly_Sales FLOAT,
            Gross_Margin_Growth_Rate_A FLOAT,
            Total_Assets_A FLOAT,
            Total_Asets_Turnover_A FLOAT,
            Cash_Flow_from_Operating_Activities_A FLOAT,
            Return_on_Total_Assets_A_percent_A FLOAT,
            Current_Ratio_A FLOAT,
            Total_Non_current_Liabilities_A FLOAT,
            Basic_Earnings_Per_Share_A FLOAT,
            Common_Stock_Shares_Issued_Thousand_Shares_A FLOAT,
            Gross_Margin_Growth_Rate_Q FLOAT,
            Total_Assets_Q FLOAT,
            Total_Assets_Turnover_Q FLOAT,
            Cash_Flow_from_Operating_Activities_Q FLOAT,
            Return_on_Total_Assets_A_percent_Q FLOAT,
            Current_Ratio_Q FLOAT,
            Total_Non_current_Liabilities_Q FLOAT,
            Basic_Earnings_Per_Share_Q FLOAT,
            Common_Stock_Shares_Issued_Thousand_Shares_Q FLOAT,
            Gross_Margin_Growth_Rate_TTM VARCHAR,
            Total_Assets_TTM VARCHAR,
            Total_Assets_Turnover_TTM FLOAT,
            Cash_Flow_from_Operating_Activities_TTM FLOAT,
            Return_on_Total_Assets_A_percent_TTM FLOAT,
            Current_Ratio_TTM VARCHAR,
            Total_Non_current_Liabilities_TTM VARCHAR,
            Basic_Earnings_Per_Share_TTM VARCHAR,
            Common_Stock_Shares_Issued_Thousand_Shares_TTM VARCHAR,
...
def tej_bundle(
    ...
    raw_data = fetch_data_table(
        api_key, show_progress , coid , mdate, columns
    )
    ...
    raw_data.to_sql(name = fundamental_schema.name,
                    con = engine,
                    index=False,
...
#     sa.Column("Market_Cap_Dollars", sa.Float),
#     sa.Column("ROI", sa.Float),
#     sa.Column("Close", sa.Float),
#     sa.Column("Common_Stock_Shares_Issued_Thousand_Shares", sa.Float),
#     sa.Column("Qfii_Diff_Amt", sa.Float),
#     sa.Column("Industry_Eng", sa.String),
#     sa.Column("YoY_Monthly_Sales", sa.Float),
#     sa.Column("Gross_Margin_Growth_Rate_A", sa.Float),
#     sa.Column("Total_Assets_A", sa.Float),
#     sa.Column("Total_Asets_Turnover_A", sa.Float),
#     sa.Column("Cash_Flow_from_Operating_Activities_A", sa.Float),
#     sa.Column("Return_on_Total_Assets_A_percent_A", sa.Float),
#     sa.Column("Current_Ratio_A", sa.Float),
#     sa.Column("Total_Non_current_Liabilities_A", sa.Float),
#     sa.Column("Basic_Earnings_Per_Share_A", sa.Float),
#     sa.Column("Common_Stock_Shares_Issued_Thousand_Shares_A", sa.Float),
#     sa.Column("Gross_Margin_Growth_Rate_Q", sa.Float),
#     sa.Column("Total_Assets_Q", sa.Float),
#     sa.Column("Total_Assets_Turnover_Q", sa.Float),
#     sa.Column("Cash_Flow_from_Operating_Activities_Q", sa.Float),
#     sa.Column("Return_on_Total_Assets_A_percent_Q", sa.Float),
#     sa.Column("Current_Ratio_Q", sa.Float),
#     sa.Column("Total_Non_current_Liabilities_Q", sa.Float),
#     sa.Column("Basic_Earnings_Per_Share_Q", sa.Float),
#     sa.Column("Common_Stock_Shares_Issued_Thousand_Shares_Q", sa.Float),
#     sa.Column("Gross_Margin_Growth_Rate_TTM", sa.String),
#     sa.Column("Total_Assets_TTM", sa.String),
#     sa.Column("Total_Assets_Turnover_TTM", sa.Float),
#     sa.Column("Cash_Flow_from_Operating_Activities_TTM", sa.Float),
#     sa.Column("Return_on_Total_Assets_A_percent_TTM", sa.Float),
#     sa.Column("Current_Ratio_TTM", sa.String),
#     sa.Column("Total_Non_current_Liabilities_TTM", sa.String),
#     sa.Column("Basic_Earnings_Per_Share_TTM", sa.String),
#     sa.Column("Common_Stock_Shares_Issued_Thousand_Shares_TTM", sa.String)
# )
fundamental_schema = sa.Table(
    "factor_table",  # 資料表名稱
    metadata,  # 元資料
    sa.Column("coid", sa.String, primary_key=True, nullable=False),  # 公司 ID，字串，主鍵
    sa.Column("mdate", sa.DateTime, primary_key=True, nullable=False),  # 年/月，日期時間，主鍵
