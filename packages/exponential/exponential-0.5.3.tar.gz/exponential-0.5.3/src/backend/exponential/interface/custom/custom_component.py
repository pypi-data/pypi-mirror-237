...
from exponential.interface.custom.component import Component
from exponential.interface.custom.directory_reader import DirectoryReader
from exponential.services.getters import get_db_service
...
class CustomComponent(Component, extra=Extra.allow):
    ...
    def load_flow(self, flow_id: str, tweaks: Optional[dict] = None) -> Any:
        from exponential.processing.process import build_sorted_vertices
        from exponential.processing.process import process_tweaks
