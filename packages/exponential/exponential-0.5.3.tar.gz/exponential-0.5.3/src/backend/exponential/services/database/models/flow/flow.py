# Path: src/backend/exponential/database/models/flow.py

from exponential.services.database.models.base import SQLModelSerializable
...
if TYPE_CHECKING:
    from exponential.services.database.models.user import User
