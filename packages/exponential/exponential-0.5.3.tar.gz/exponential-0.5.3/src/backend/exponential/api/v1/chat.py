...
from exponential.api.utils import build_input_keys_response
from exponential.api.v1.schemas import BuildStatus, BuiltResponse, InitResponse, StreamData

from exponential.graph.graph.base import Graph
from exponential.services.auth.utils import get_current_active_user, get_current_user
from exponential.services.cache.utils import update_build_status
from loguru import logger
from exponential.services.getters import get_chat_service, get_session, get_cache_service
...
def try_running_celery_task(vertex):
    ...
    try:
        from exponential.worker import build_vertex
