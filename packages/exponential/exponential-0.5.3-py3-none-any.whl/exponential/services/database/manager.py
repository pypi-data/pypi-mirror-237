...
from exponential.services.base import Service
from exponential.services.database.models.user.crud import get_user_by_username
from exponential.services.database.utils import Result, TableResults
from exponential.services.getters import get_settings_service
...
from exponential.services.database import models  # noqa
...
class DatabaseService(Service):
    ...
    def __init__(self, database_url: str):
        ...
        # This file is in exponential.services.database.manager.py
        # the ini is in exponential
        exponential_dir = Path(__file__).parent.parent.parent
        self.script_location = exponential_dir / "alembic"
        self.alembic_cfg_path = exponential_dir / "alembic.ini"
