...
from exponential.api import router


from exponential.interface.utils import setup_llm_caching
from exponential.services.utils import initialize_services
from exponential.services.plugins.langfuse import LangfuseInstance
from exponential.services.utils import (
    teardown_services,
)
from exponential.utils.logger import configure
...
def get_static_files_dir():
    """Get the static files directory relative to exponential's main.py file."""
...
if __name__ == "__main__":
    import uvicorn
    from exponential.__main__ import get_number_of_workers
