...
def resample_interpolate_grid(grid, interp_method="linear", espg_code="3035"):
    ...
    print(f"EPSG:{espg_code}")

    aoi_extent = get_extent(proj=espg_code)
    print(aoi_extent)
...
def compute_anomalies(
    ...
    for itime in sm_year.time.values:
        ...
        if not outfile_path.is_file():
            ...
            res_grid = resample_interpolate_grid(anom_day)
