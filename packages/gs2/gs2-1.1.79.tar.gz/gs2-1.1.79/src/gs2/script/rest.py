...
class Gs2ScriptRestClient(rest.AbstractGs2RestClient):
    ...
    def _describe_scripts(
        ...
        _job = rest.NetworkJob(
            url=url,
            method='GET',
            result_type=DescribeScriptsResult,
            callback=callback,
            headers=headers,
            query_strings=query_strings,
        )
    ...
    async def describe_scripts_async(
        self,
        request: DescribeScriptsRequest,
    ) -> DescribeScriptsResult:
        async_result = []
    ...
    def _create_script(
        ...
        _job = rest.NetworkJob(
            url=url,
            method='POST',
            result_type=CreateScriptResult,
            callback=callback,
            headers=headers,
            body=body,
        )
    ...
    def _create_script_from_git_hub(
        self,
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='script',
            region=self.session.region,
        ) + "/{namespaceName}/script/from_git_hub".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
        )
        ...
        _job = rest.NetworkJob(
            url=url,
            method='POST',
            result_type=CreateScriptFromGitHubResult,
            callback=callback,
            headers=headers,
            body=body,
        )
    ...
    def create_script_from_git_hub(
        ...
        async_result = []
        with timeout(30):
            self._create_script_from_git_hub(
                request,
                lambda result: async_result.append(result),
                is_blocking=True,
            )
    ...
    async def create_script_from_git_hub_async(
        self,
        request: CreateScriptFromGitHubRequest,
    ) -> CreateScriptFromGitHubResult:
        async_result = []
    ...
    def _get_script(
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='script',
            region=self.session.region,
        ) + "/{namespaceName}/script/{scriptName}".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            scriptName=request.script_name if request.script_name is not None and request.script_name != '' else 'null',
        )
    ...
    def _update_script(
        ...
        _job = rest.NetworkJob(
            url=url,
            method='PUT',
            result_type=UpdateScriptResult,
            callback=callback,
            headers=headers,
            body=body,
        )
    ...
    def _update_script_from_git_hub(
        self,
        ...
        url = Gs2Constant.ENDPOINT_HOST.format(
            service='script',
            region=self.session.region,
        ) + "/{namespaceName}/script/{scriptName}/from_git_hub".format(
            namespaceName=request.namespace_name if request.namespace_name is not None and request.namespace_name != '' else 'null',
            scriptName=request.script_name if request.script_name is not None and request.script_name != '' else 'null',
        )
        ...
        _job = rest.NetworkJob(
            url=url,
            method='PUT',
            result_type=UpdateScriptFromGitHubResult,
            callback=callback,
            headers=headers,
            body=body,
        )
    ...
    def update_script_from_git_hub(
        self,
        request: UpdateScriptFromGitHubRequest,
    ) -> UpdateScriptFromGitHubResult:
        async_result = []
        with timeout(30):
            self._update_script_from_git_hub(
                request,
                lambda result: async_result.append(result),
                is_blocking=True,
            )
    ...
    async def update_script_from_git_hub_async(
        self,
        request: UpdateScriptFromGitHubRequest,
    ) -> UpdateScriptFromGitHubResult:
        async_result = []
    ...
    def _delete_script(
        ...
        _job = rest.NetworkJob(
            url=url,
            method='DELETE',
            result_type=DeleteScriptResult,
            callback=callback,
            headers=headers,
            query_strings=query_strings,
        )
    ...
    def _invoke_script(
        ...
        _job = rest.NetworkJob(
            url=url,
            method='POST',
            result_type=InvokeScriptResult,
            callback=callback,
            headers=headers,
            body=body,
        )
