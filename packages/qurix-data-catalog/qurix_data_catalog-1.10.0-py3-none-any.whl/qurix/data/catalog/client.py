...
class DataCatalogClient:
        ...
        try:
            ...
            if catalog_data_source.data_loader is not None:
                ...
                row_count = catalog_data_source.data_loader.get_row_count(
                    **kwargs)
                text_information = catalog_data_source.data_loader.get_table_comment(
                    **kwargs)
    ...
    def _get_dc_entry_attributes(self, dc_entry: CatalogDataSource) -> tuple[str, str, str, str, bool, bool, str]:
        internal_name = self._clean_name(dc_entry.name)
