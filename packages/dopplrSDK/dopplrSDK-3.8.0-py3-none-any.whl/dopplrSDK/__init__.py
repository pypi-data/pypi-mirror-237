...
join doppler.\"DopplerProject\" P on P.\"UserKey\"=Du.\"UserKey\" where Du.\"LoginName\"='{0}' and p.\"ProjectName\"='{1}'".format(loginName,Project_name)
        ...
        results = cur.fetchone()
        if results[0]<1:     
            insert_query = "INSERT INTO doppler.\"DopplerLake\"(\"UserKey\", \"TableName\",\"ResourceType\",\"DopplerConnectionDetailsKey\",\"Projectid\",\"Status\") VALUES ("+str(UserKey)+",'"+Targetname+"','folder',null,'"+str(ProjectKey)+"','Ready')"
            cur.execute(insert_query)
        ...
        update_query = "UPDATE doppler.\"DopplerLake\" set \"ConnectionString\"='"+ConnectionString+"',"+"\"Schema\"='"+loginName+'_schema'+"',\"Source\"= 'folder' ,\"CreatedTs\"=CURRENT_TIMESTAMP where \"SourceKey\"="+str(SourceKey)
        cur2=cnxn.cursor()
