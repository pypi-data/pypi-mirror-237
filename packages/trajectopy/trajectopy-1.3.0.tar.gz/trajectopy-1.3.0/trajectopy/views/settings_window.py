...
class SettingsGUI(QtWidgets.QMainWindow):
    ...
    def setupUi(self) -> None:
        ...
        self.k_nearest_matching_label = QtWidgets.QLabel(self.comparisonVerticalLayoutWidget)
        self.k_nearest_matching_label.setObjectName("k_nearest_matching_label")
        self.comparisonFormLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.k_nearest_matching_label)
        self.matchingKNearest = QtWidgets.QSpinBox(self.comparisonVerticalLayoutWidget)
        self.matchingKNearest.setMinimum(2)
        self.matchingKNearest.setProperty("value", 10)
        self.matchingKNearest.setObjectName("matchingKNearest")
        self.comparisonFormLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.matchingKNearest)
        ...
        self.comparisonFormLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.relative_label)
        ...
        self.comparisonFormLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.relative_min_dist_label)
        ...
        self.comparisonFormLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.relativeMinDist)
        ...
        self.comparisonFormLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.relative_max_dist_label)
        ...
        self.comparisonFormLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.relativeMaxDist)
        ...
        self.comparisonFormLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.relative_dist_step_label)
        ...
        self.comparisonFormLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.relativeDistStep)
        ...
        self.comparisonFormLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.relative_dist_unit_label)
        ...
        self.relativeDistUnit.addItem("")
        self.comparisonFormLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.relativeDistUnit)
        ...
        self.comparisonFormLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.LabelRole, self.relative_all_pairs_label)
        ...
        self.comparisonFormLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.FieldRole, self.relativeAllPairs)
    ...
    def retranslateUi(self) -> None:
        ...
        self.k_nearest_label.setText(_translate("MainWindow", "k-nearest voxels:"))
        ...
        self.k_nearest_matching_label.setText(_translate("MainWindow", "k-nearest neighbors (spatial interpolation):"))
    ...
    def update_comparison_view(self) -> None:
        ...
        self.matchingKNearest.setValue(self.trajectory_entry.settings.matching.k_nearest)
    ...
    def update_comparison_model(self) -> None:
        ...
        self.trajectory_entry.settings.matching.k_nearest = self.matchingKNearest.value()
