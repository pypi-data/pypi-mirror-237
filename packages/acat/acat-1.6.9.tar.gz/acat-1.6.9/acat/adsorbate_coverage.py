...
class ClusterAdsorbateCoverage(object):
    ...
    **'label'**: the updated label with the name of the occupying adsorbate
    ...
    adsorption_sites : acat.adsorption_sites.ClusterAdsorptionSites object \
        or its pickle file path, default None
    ...
    def populate_hetero_site_list(self):
        ...
        for adsid in self.ads_ids:            
            ...
            if bl > self.dmax:
                continue
            if st['normal'][2] > 0:
                if (bl > 0.5) and (st['position'][2] > adspos[2]):
                    continue
            else:
                if (bl > 0.5) and (st['position'][2] < adspos[2]):
                    continue
    ...
    **'label'**: the updated label with the name of the occupying adsorbate
    ...
    .. code-block:: python
        ...
        [{'site': '3fold', 'surface': CustomSurface, 'morphology': 'sc-tc', 
          ...
          'composition': None, 'subsurf_index': None, 'subsurf_element': None, 'label': 0, 
...
def enumerate_updated_sites(atoms, adsorption_sites=None,
    ...
    adsorption_sites : acat.adsorption_sites.ClusterAdsorptionSites \  
        object or acat.adsorption_sites.SlabAdsorptionSites object or \
        the corresponding pickle file path, default None
