...
class Workbench:
	__CUSTOM_WORKFLOW_SOURCE_NAME = "PRIVATE"
	...
	def get_workflow(self, workflow_name: str, workflow_type: Optional[str] = __CUSTOM_WORKFLOW_SOURCE_NAME) -> Workflow:
		for workflow in self._get_workflow_client().list_workflows(source=workflow_type):
