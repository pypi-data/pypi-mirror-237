...
# 20230907 (by MRC) for spyder
def _is_running_in_spyder():
    """
    檢查程式執行路徑有沒有經過spyder，如果有就判定他是使用spyder IDE
    """
...
def print_table(
    ...
    if not _is_running_in_spyder():                                                     # 20230907 (by MRC) for spyder
    ...
    else:                                                                              # 20230907 (by MRC) for spyder
        print(table)
