...
from eventix.functions.task_scheduler import LSoftJSONEncoder
from pydantic_db_backend_common.utils import utcnow
from webexception.webexception import WebException

from eventix.contexts import worker_id_context, namespace_provider, worker_id_provider, task_priority_provider
    ...
    def task_write_back(cls, task: TaskModel) -> TaskModel | None:
        try:
            ...
            if task.expires is not None and task.expires < utcnow():  # gammel
                ...
                r = cls.interface.put(f'/task/{task.uid}', data=a)
