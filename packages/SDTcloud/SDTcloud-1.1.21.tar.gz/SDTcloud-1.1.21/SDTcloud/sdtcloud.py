...
class SDTcloud():
    ...
    def gitConfigInit(self):
        response = requests.request('GET', f"{self.giteamanager_url}/stackbase/v1/gitea-manager/users/{self.namespace}")
    ...
    def minioGetObject(self, bucket_name, file_name):
        ...
        try:
            ...
            if meta_data.get('HTTPStatusCode') == HTTPStatusCode.NO_CONTENT.value:
                return HTTPStatusCode.OK.value            
        except botocore.exceptions.NoSuchKey as noSuchKey:
