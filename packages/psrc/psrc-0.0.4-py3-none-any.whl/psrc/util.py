...
# %% auto 0
__all__ = ['path2str', 'aspath', 'fullpath', 'joinpaths', 'selfpath', 'fspath', 'mkdirs', 'ls', 'dirdirs', 'pathsort', 'dirfile',
           'dropext', 'text2clip']
...
from nlit import (PATH, __FSPATH__, PBCOPY, CLIP, ECHO, POSIX, NT)
from chck import isfile, isdir
