...
class TzcldCommunityIdentity(Model):
    ...
    birth_date =  models.DateField(verbose_name="Project birth date", blank=True, null=True)
    ...
    class Meta(Model.Meta):
        ...
        serializer_fields = ['@id', 'community', 'deputy', 'circonscription', 'origin_mobilization', 'application_date', 'signatory_structure', 'birth_date', 'last_contribution_date', 'territories_project_team_memebers', 'territories_trainings', 'conversations', 'tzcld_admins_community_shared_notes', 'tzcld_admins_community_shared_files', 'date', 'author']
...
class TzcldTerritorySynthesisFollowed(Model):
    ...
    class Meta(Model.Meta):
        ...
        serializer_fields = ['@id', 'context', 'strongPoints', 'questions', 'needs', 'targetdate', 'community', 'tzcld_referents_community_shared_notes', 'date', 'author']
