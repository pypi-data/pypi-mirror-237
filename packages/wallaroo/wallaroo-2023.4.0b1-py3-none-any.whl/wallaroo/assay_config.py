...
class FixedWindowBaselineBuilder(BaselineBuilder):
    ...
    def add_locations(self, locations: List[str]) -> "FixedWindowBaselineBuilder":
...
class WindowBuilder(object):
    ...
    def add_locations(self, locations: List[str] = []):
        self.locations = locations
        return self
...
class AssayBuilder(object):
    ...
    def add_locations(self, locations: List[str]):
        self.locations = locations
        self.window_builder_.add_locations(locations)
        self.baseline_builder.add_locations(locations)
        return self
