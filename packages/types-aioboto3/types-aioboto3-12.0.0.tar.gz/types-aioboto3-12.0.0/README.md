...
Type annotations for [aioboto3 12.0.0](https://pypi.org/project/aioboto3/)
...
- `types-aioboto3[all]` - Type annotations for all 358 services.
...
- `types-aioboto3[gamelift]` - Type annotations for
  ...
  service.
- `types-aioboto3[gamesparks]` - Type annotations for
...
- `types-aioboto3[machinelearning]` - Type annotations for
  ...
  service.
- `types-aioboto3[macie]` - Type annotations for
