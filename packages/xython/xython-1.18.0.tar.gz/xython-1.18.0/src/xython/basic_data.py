...
class basic_data:
	...
	def __init__(self):
		...
		self.vars["dic_선위치_vs_번호"] = self.vars["dic_lineposition_num_forexcel"] = {"basic": [7,8,9,10],"all": [7,8,9,10], "": [7,8,9,10], "/": 6, "\\": 5, "left": 7, "top": 8, "bottom": 9, "right": 10, "inside-h": 11, "inside-v": 12, "대각선오른쪽": 6, "대각선왼쪽": 5, "왼쪽": 7, "위쪽": 8, "아래쪽": 9, "오른쪽": 10, "안쪽세로": 11, "안쪽가로": 12, }
		self.vars["dic_선굵기_vs_번호"] = self.vars["excel_line_thickness_dic"] = {"-": -4115, "-.": 4, "-..": 5, ".": -4118, "=": -4119, "no": -4142, "/.": 13, "실선": 1, "점선": 2, "가는점선": 1, "굵은실선": 6, "hairline": 1, "basic": -4138, "": -4138, "thick": 4, "thin": 2, "t-2": 1, "t0": -4138, "t1": 4, "t-1": 2, "매우가는선": 1, "일반": -4138, "굵은선": 4, "가는선": 2, "": 1, "..": -4115, "/..": 13,"2": 4, "1": 2,}
		self.vars["dic_선형태_vs_번호"] = self.vars["dic_linestyle_num_forexcel"] = {"basic": 1, "": 1, "-": -4115, "-.": 4, "-..": 5, ".": -4118, "=": -4119, "no": -4142, "/.": 13, "실선": 1, "점선": 2, "가는점선": 1, "굵은실선": 6, }
