...
class CloudFunctionalVerificationController(BaseController):
    ...
    def get_or_create_cluster_compute(
        ...
        raise ClickException(
            "Timed out waiting for cluster compute to be created. Please try again."
        )
    ...
    def verify_service(  # noqa: PLR0911
        ...
        # Terminate service
        allowed_status_set.add(ServiceEventCurrentState.TERMINATED)
        allowed_status_set.add(ServiceEventCurrentState.TERMINATING)
        with self._create_task(
