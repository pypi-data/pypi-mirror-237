...
from protectremote.file import read_protectremote_file
...
def has_ip_access(ip: str)->bool:
    ...
    if settings.DEBUG_MODE:
        ...
        IPAddr =  ip
    # get api rules from file
    data = read_protectremote_file()


    if data is None or "rules" not in data:
        print(".protectremote da data mevcut değil")
        return False
