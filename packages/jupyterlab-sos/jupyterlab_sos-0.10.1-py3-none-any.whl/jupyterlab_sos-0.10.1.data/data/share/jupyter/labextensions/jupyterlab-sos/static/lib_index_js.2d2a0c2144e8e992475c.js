...
function changeStyleOnKernel(cell, kernel, info) {
    ...
    if (!base_mode || base_mode === 'sos') {
        cell.editorWidget.editor.model.mimeType = 'python';
    }
    else {
        cell.editorWidget.editor.model.mimeType = base_mode;
    }
}
...
//# sourceMappingURL=lib_index_js.2d2a0c2144e8e992475c.js.map