...
class ImageInference(FireworksClient):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model = model
        self.endpoint_base_uri = f"{self.base_url}/image_generation/accounts/{self.account}/models/{self.model}"
    ...
    def text_to_image(
        ...
        with httpx.Client(
            ...
            **self.client_kwargs,
            ...
            response = client.post(self.endpoint_base_uri, json=payload_dict)
    ...
    def control_net(
        ...
        with httpx.Client(
            ...
            **self.client_kwargs,
            ...
            response = client.post(
                f"{self.endpoint_base_uri}/control_net",
                data=payload_dict,
                files=files,
            )
            self._error_handling(response)
    ...
    def canny_edge_detection(
        ...
        with httpx.Client(
            ...
            **self.client_kwargs,
            ...
            response = client.post(
                f"{self.endpoint_base_uri}/canny_edge_detection",
                files=files,
