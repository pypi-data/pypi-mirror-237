...
class SubjectOnDisk():
    ...
    def getForcePlateCorners(self, trial: int, forcePlate: int) -> list[numpy.ndarray[numpy.float64, _Shape[3, 1]]]: 
        ...
        """
    def getForceplateCutoffs(self, trial: int, processingPass: int) -> list[float]: 
        """
    ...
    def loadAllFrames(self) -> None: 
        ...
        """
    def readForcePlates(self, arg0: int) -> list[ForcePlate]: 
        """
...
class SubjectOnDiskHeader():
    ...
    def setTrials(self, trials: list[SubjectOnDiskTrial]) -> None: ...
    pass
...
class SubjectOnDiskTrialPass():
    ...
    def computeValuesFromForcePlates(self, skel: nimblephysics_libs._nimblephysics.dynamics.Skeleton, timestep: float, poses: numpy.ndarray[numpy.float64, _Shape[m, n]], footBodyNames: list[str], forcePlates: list[ForcePlate], rootHistoryLen: int = 5, rootHistoryStride: int = 1, explicitVels: numpy.ndarray[numpy.float64, _Shape[m, n]] = array([], shape=(0, 0), dtype=float64), explicitAccs: numpy.ndarray[numpy.float64, _Shape[m, n]] = array([], shape=(0, 0), dtype=float64)) -> None: ...
    ...
    def setForcePlateCutoffs(self, cutoffs: list[float]) -> None: ...
