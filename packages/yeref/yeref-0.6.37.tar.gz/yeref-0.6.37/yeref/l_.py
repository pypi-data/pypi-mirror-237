...
l_post_button_chn = {
    'ru': "✏️ 3. <b>Введи названия</b> для кнопок и <b>ссылки</b> в формате (одну или несколько; кликни на образец ниже, чтобы скопировать):\n\n<code>[🐳 Boost | https://t.me/XXXXX?boost]\n\n[❤️ Like][🔗 | https://t.me/share/url?url=https://t.me/XXXXX&text=™️]</code>\n\n(<i>или нажми «➡️️/Next», чтобы пропустить этот шаг</i>)",
    'en': "✏️ 3. <b>Enter button names</b> and <b>links</b> in the format (one or more; click on the sample below to copy):\n\n[🐳 Link | https://t.me/XXXXX]\n\nor\n\n[❤️ Интересно][💔 Не пиши]\n\n( <i>or press &quot;➡️️/Next&quot; to skip this step</i> )",
    'es': "✏️ 3. <b>Ingrese los nombres de los botones</b> y <b>los enlaces</b> en el formato (uno o más; haga clic en la muestra a continuación para copiar):\n\n[🐳 Link | https://t.me/XXXXX]\n\ni\n\n[❤️ Интересно][💔 Не пиши]\n\n( <i>o presiona &quot;➡️️/Siguiente&quot; para omitir este paso</i> )",
    'fr': "✏️ 3. <b>Saisissez les noms des boutons</b> et <b>les liens</b> au format (un ou plusieurs ; cliquez sur l&#x27;exemple ci-dessous pour le copier) :\n\n[🐳 Link | https://t.me/XXXXX]\n\nor\n\n[❤️ Интересно][💔 Не пиши]\n\n( <i>ou appuyez sur &quot;➡️️/Suivant&quot; pour ignorer cette étape</i> )",
    'zh': "✏️ 3.<b>输入按钮名称</b>和<b>链接</b>格式（一个或多个；点击下方示例复制）：\n\n[🐳 Link | https://t.me/XXXXX]\n\nor\n\n[❤️ Интересно][💔 Не пиши]\n\n（<i>或按“➡️️/Next”跳过这一步</i>）",
...
l_bot_transfer_text = {
    ...
    'en': "👩🏽‍💻 To transfer channel admin rights to @{0}-bot, use the command: /transfer ID-ПОЛЬЗОВАТЕЛЯ (/id), where user: channel administrator and member of @{0}-bot\n\n⚙️ <b>Commands</b> /cmd",
    'es': "👩🏽‍💻 Para transferir los derechos de administrador del canal a @{0}-bot, usa el comando: /transfer ID-ПОЛЬЗОВАТЕЛЯ (/id), donde usuario: administrador del canal y miembro de @{0}-bot\n\n⚙️ <b>Comandos</b> /cmd",
    'fr': "👩🏽‍💻 Pour transférer les droits d'administrateur du canal à @{0}-bot, utilisez la commande : /transfer ID-ПОЛЬЗОВАТЕЛЯ (/id), où utilisateur : administrateur du canal et membre de @{0}-bot\n\n⚙️ <b>Commandes</b> /cmd",
    'zh': "👩🏽‍💻 要将频道管理员权限转移给@{0}-bot，请使用命令： /transfer ID-ПОЛЬЗОВАТЕЛЯ (/id)，其中用户：频道管理员和@{0}-bot 的成员\n\n⚙️<b>命令</b>/cmd",
    'ar': "👩🏽‍💻 لنقل حقوق مسؤول القناة إلى @ {0} -bot ، استخدم الأمر: /transfer ID-ПОЛЬЗОВАТЕЛЯ (/ id) ، حيث المستخدم: مسؤول القناة وعضو @ {0} -bot\n\n⚙️ <b>Commands</b> / cmd",
}
# endregion
...
l_transfer_start = {
    ...
    'en': "👩🏽‍💻 User {0} must /start-start @{1}",
    'es': "👩🏽‍💻 El usuario {0} debe /start-start @{1}",
    'fr': "👩🏽‍💻 L'utilisateur {0} doit /start-start @{1}",
    'zh': "👩🏽‍💻 用户 {0} 必须 /start-start @{1}",
    'ar': "👩🏽‍💻 المستخدم {0} must / start-start @ {1}",
}
l_transfer_admin = {
    'ru': "👩🏽‍💻 <b>Пользователь</b> {0} должен быть <b>администратором</b> в <b>{1}</b>",
    'en': "👩🏽‍💻 User {0} must be <b>an administrator</b> in <b>{1}</b>",
    'es': "👩🏽‍💻 El usuario {0} debe ser <b>administrador</b> en <b>{1}</b>",
    'fr': "👩🏽‍💻 L'utilisateur {0} doit être <b>administrateur</b> dans <b>{1}</b>",
    'zh': "👩🏽‍💻 用户 {0} 必须是<b>{1}</b>的<b>管理员</b>",
    'ar': "👩🏽‍💻 يجب أن يكون المستخدم {0} <b>مسؤولاً</b> في <b>{1}</b>",
}
l_transfer_transfer = {
    'ru': "👩🏽‍💻 <b>Передать</b> <b>admin</b>-права на <b>{0}</b> пользователю {1} в @{2}-боте?",
    'en': "👩🏽‍💻 Transfer <b>admin</b> rights to <b>{0}</b> to user {1} in @{2}-bot?",
    'es': "👩🏽‍💻 ¿Transferir los derechos <b>de administrador</b> de <b>{0}</b> al usuario {1} en @{2}-bot?",
    'fr': "👩🏽‍💻 Transférer les droits <b>d&#x27;administrateur</b> de <b>{0}</b> à l'utilisateur {1} dans @{2}-bot ?",
    'zh': "👩🏽‍💻 在@{2}-bot 中将<b>{0}的管理员</b>权限转让给用户 {1}？",
    'ar': "👩🏽‍💻 نقل حقوق <b>المسؤول</b> إلى <b>{0}</b> إلى المستخدم {1} في @ {2} -bot؟",
}
l_transfer_text = {
...
l_transfer_done_to = {
    ...
    'es': "👩🏽‍💻 Derechos <b>de administrador</b> de [<b>{0}</b>] transferidos con éxito a {1}",
    'fr': "👩🏽‍💻 Les droits <b>d&#x27;administrateur</b> de [<b>{0}</b>] ont été transférés avec succès à {1}",
    'zh': "👩🏽‍💻 [<b>{0}</b>] 的<b>管理员</b>权限已成功转移给 {1}",
    'ar': "👩🏽‍💻 تم نقل حقوق <b>المسؤول</b> لـ [<b>{0}</b>] بنجاح إلى {1}",
}
l_transfer_done_from = {
    ...
    'es': "👩🏽‍💻 Derechos <b>de administrador</b> para [<b>{0}</b>] obtenidos con éxito de {1}",
    'fr': "👩🏽‍💻 Les droits <b>d&#x27;administrateur</b> de [<b>{0}</b>] ont été obtenus avec succès auprès de {1}",
    'zh': "👩🏽‍💻 已成功从 {1} 获得 [<b>{0}</b>] 的<b>管理员</b>权限",
    'ar': "👩🏽‍💻 تم الحصول على حقوق <b>المسؤول</b> لـ [<b>{0}</b>] بنجاح من {1}",
}
l_chn_check = {
...
l_status_for = {
    ...
    'en': "👩🏽‍💻 Status <b>{0}</b> for {1}:\n\n",
    'es': "👩🏽‍💻 Estado <b>{0}</b> para {1}:\n\n",
    'fr': "👩🏽‍💻 Statut <b>{0}</b> pour {1} :\n\n",
    'zh': "👩🏽‍💻 {1} 的状态<b>{0}</b> ：\n\n",
    'ar': "👩🏽‍💻 الحالة <b>{0}</b> لـ {1}:\n\n",
}

l_transfer_reply = {
    'ru': "👩🏽‍💻 <b>Используй</b> команду /transfer в <b>ответном</b> сообщении пользователя, которому вы хоти передать права",
    'en': "👩🏽‍💻 Use the /transfer command in <b>the response</b> message of the user you want to transfer rights to",
    'es': "👩🏽‍💻 Use el comando /transfer en <b>el mensaje de respuesta</b> del usuario al que desea transferir los derechos",
    'fr': "👩🏽‍💻 Utilisez la commande /transfer dans <b>le message de réponse</b> de l'utilisateur à qui vous souhaitez transférer les droits",
    'zh': "👩🏽‍💻 在你想转让权限的用户的<b>响应</b>消息中使用 /transfer 命令",
    'ar': "👩🏽‍💻 استخدم الأمر / transfer في رسالة <b>استجابة</b> المستخدم الذي تريد نقل الحقوق إليه",
}
l_button_handler = {
...
l_warn_handler = {
    ...
    'en': "👩🏽‍💻 Warning {1}{2} on behalf of group <b>{0}</b>",
    'es': "👩🏽‍💻 Advertencia {1}{2} en nombre del grupo <b>{0}</b>",
    'fr': "👩🏽‍💻 Avertissement {1}{2} de la part du groupe <b>{0}</b>",
    'zh': "👩🏽‍💻 代表<b>{0}</b>组警告{1}{2}",
    'ar': "👩🏽‍💻 تحذير {1} {2} نيابة عن المجموعة <b>{0}</b>",
}
l_status_pin = {
    'ru': "Закреп сообщ",
    'en': "Fix message",
...
l_len_text = {
    'ru': "👩🏽‍💻 <b>Введи</b> корректную <i>длину</i> текста в сообщении\n\n👩🏽‍💻 <b>Текущее</b> значение <code>/len {0}</code>\n<code>/len 160</code> (max-длина сообщения 160 символов)\n<code>/len 0</code>   отключение опции",
    'en': "💬 Please <b>enter</b> a valid <i>number</i> of messages from <u>3</u> to <u>10</u>\n\n👩🏽‍💻 <b>Current</b> value /flood {0}\n\n👩🏽‍💻 For example, /flood 3 (identifies 3 messages in a row as a flood)\n/flood 0 (disables options)",
    'es': "💬 <b>Ingrese</b> un <i>número</i> válido de mensajes de <u>3</u> a <u>10</u>\n\n👩🏽‍💻 Valor <b>actual</b> /flood {0}\n\n👩🏽‍💻 Por ejemplo, /inundación 3 (identifica 3 mensajes seguidos como una inundación)\n/inundación 0 (deshabilita opciones)",
    'fr': "💬 Veuillez <b>entrer</b> un <i>nombre</i> valide de messages de <u>3</u> à <u>10</u>\n\n👩🏽‍💻 Valeur <b>actuelle</b> /flood {0}\n\n👩🏽‍💻 Par exemple, /flood 3 (identifie 3 messages à la suite comme une inondation)\n/flood 0 (désactive les options)",
    'zh': "💬<b>请输入</b><u>3</u>到<u>10</u>之间的有效消息<i>数</i>\n\n👉🏼<b>当前</b>值/flood {0}\n\n👩🏽‍💻 例如 /flood 3（连续 3 条消息标识为洪水）\n/flood 0（禁用选项）",
...
l_len_on = {
    'ru': "👩🏽‍💻 <b>Установлен</b> /len-режим: {0} max длина сообщения",
    'en': "💬 Set flood mode: {0} messages in a row",
    'es': "💬 Establecer modo de inundación: {0} mensajes seguidos",
    'fr': "💬 Définir le mode flood : {0} messages d'affilée",
    'zh': "💬 设置泛洪模式：连续 {0} 条消息",
...
# region cchannel_
l_cchannel_text = {
    'ru': "🫥 <b>Жми</b> на ✅/☑️, чтобы <b>Вкл/Выкл</b> <i>разрешение</i> для канала (к которому привязана эта группа) публиковать посты, а также для пользователя в группе писать <i>анонимно</i> (от имени <b>его</b> канала)",
...
l_post_welcome = {
    'ru': "🌱 <b>{0}</b>, добро пожаловать в <i>лендинг-бот</i> для создания креативных постов\n▪️<b>кнопочный</b> счетчик\n▪️инлайн-<b>телескопы</b>\n▪️<b>уведомления</b> о кликах\n▪️<b>шёпот</b>-сообщения\n\n❗️<b>Регулярно</b>-обновляемый /content",
...
l_ads_welcome = {
    'ru': "🌱 <b>{0}</b>, добро пожаловать в <i>лендинг-бот</i> для создания креативных постов <b>Ferey</b>\n\n▪️️реклама во всех Ferey-ботах\n▪️️заказ рекламы на канале\n\n❗️<b>Регулярно</b>-обновляемый /content",
...
l_demo_welcome = {
    'ru': "🌱 <b>{0}</b>, добро пожаловать в <i>лендинг-бот</i> проекта <b>Ferey</b>:\n\n▪️<b>информация</b> обо всех проектах\n▪️<b>telegraph</b>-/blog\n\n❗️<b>Регулярно</b>-обновляемый /content",
