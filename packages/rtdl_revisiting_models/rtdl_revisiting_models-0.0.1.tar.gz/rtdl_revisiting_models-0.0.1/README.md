...
This package provides the official easy-to-use
(re)implementation of the main things from the paper.

> [!IMPORTANT]
>
> <details>
> <summary>This package VS The implementation in <code>bin/</code></summary>
>
> - The code in `bin/` and `lib/` is the original implementation used to obtain
>   numbers reported in the paper.
> - Overall, this package is expected to be preferred over the original implementation,
>   but there is nothing wrong in using the original implementation:
...
- Is is possible to explore the published tuned hyperparameter configurations for the
  datasets used in the paper as described [here](../README.md#hyperparameters).
