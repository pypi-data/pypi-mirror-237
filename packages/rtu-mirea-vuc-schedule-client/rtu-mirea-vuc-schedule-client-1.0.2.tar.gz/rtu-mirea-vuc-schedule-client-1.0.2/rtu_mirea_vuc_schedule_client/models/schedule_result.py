...
class ScheduleResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["week", "schedule"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "week": obj.get("week"),
            "schedule": [WeekScheduleResult.from_dict(_item) for _item in obj.get("schedule")] if obj.get("schedule") is not None else None
        })
        return _obj
