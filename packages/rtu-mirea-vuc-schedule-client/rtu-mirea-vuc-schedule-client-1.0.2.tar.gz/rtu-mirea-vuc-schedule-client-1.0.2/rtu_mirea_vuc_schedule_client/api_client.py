...
import rtu_mirea_vuc_schedule_client.models
from rtu_mirea_vuc_schedule_client import rest
from rtu_mirea_vuc_schedule_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(rtu_mirea_vuc_schedule_client.models, klass)
