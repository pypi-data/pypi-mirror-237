...
from rtu_mirea_vuc_schedule_client.models.week_date import WeekDate
...
class ScheduleApi:
    ...
    @validate_call
    async def get_days_week_api_v1_schedule_day_week_get(
        self,
        course: StrictInt,
        ...
        **kwargs,
        ...
        return await self.get_days_week_api_v1_schedule_day_week_get_with_http_info.raw_function(
            course,
            platoon,
            **kwargs,
        )
    ...
    @validate_call
    async def get_days_week_api_v1_schedule_day_week_get_with_http_info(
        self,
        course: StrictInt,
        platoon: Optional[StrictInt] = None,
        **kwargs,
