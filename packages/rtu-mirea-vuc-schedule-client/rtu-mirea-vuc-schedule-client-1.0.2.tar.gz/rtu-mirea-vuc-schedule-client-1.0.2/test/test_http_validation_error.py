...
from rtu_mirea_vuc_schedule_client.models.http_validation_error import HTTPValidationError  # noqa: E501
    ...
    def make_instance(self, include_optional) -> HTTPValidationError:
        ...
        if include_optional:
            return HTTPValidationError(
                detail = [
                    rtu_mirea_vuc_schedule_client.models.validation_error.ValidationError(
                        loc = [
                            null
                            ], 
                        msg = '', 
