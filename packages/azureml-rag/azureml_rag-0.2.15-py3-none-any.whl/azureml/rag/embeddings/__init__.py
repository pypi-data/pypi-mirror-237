...
class EmbeddingsContainer:
            ...
            for i in range(table.num_rows):
                ...
                self._document_embeddings[doc_id] = \
                    ReferenceEmbeddedDocument(
                        doc_id, mtime, document_hash, path_to_data, index_of_data, embeddings_container_path, metadata, is_local)
    ...
    @staticmethod
    def load_latest_snapshot(local_embeddings_cache: Path, metadata_only: bool = False, documents_only: bool = False, activity_logger=None) -> "EmbeddingsContainer":
        ...
        if embeddings_container_dir_name is not None:
            ...
            try:
                embeddings_container = EmbeddingsContainer.load(
                    embeddings_container_dir_name, str(local_embeddings_cache), metadata_only=metadata_only, documents_only=documents_only)
