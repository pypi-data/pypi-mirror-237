...
from azureml.rag.langchain.vendor.docstore.base import AddableMixin, Docstore
...
from azureml.rag.langchain.vendor.vectorstores.utils import maximal_marginal_relevance
