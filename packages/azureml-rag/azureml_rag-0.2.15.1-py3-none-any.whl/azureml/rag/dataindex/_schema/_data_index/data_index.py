...
class CitationRegexSchema(metaclass=PatchedSchemaMeta):
    ...
    def make(self, data, **kwargs):
        from azureml.rag.dataindex.entities.data_index import CitationRegex
...
class IndexSourceSchema(metaclass=PatchedSchemaMeta):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azureml.rag.dataindex.entities.data_index import IndexSource
...
class EmbeddingSchema(metaclass=PatchedSchemaMeta):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azureml.rag.dataindex.entities.data_index import Embedding
...
class IndexStoreSchema(metaclass=PatchedSchemaMeta):
    ...
    @post_load
    def make(self, data, **kwargs):
        from azureml.rag.dataindex.entities.data_index import IndexStore
