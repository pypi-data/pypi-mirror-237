...
class HttpJike(object):
    ...
    # scrapy 代理选择 数据返回
    def proxies_choose_dict(self, p):
...
class ModeFunc:
    ...
    def ttwid_cookie_tt():
        cookie_tt = []
        sql = 'SELECT douyin_cookie_ttwid FROM `cd_douyin_cookie1_ttwid` where douyin_cookie_ttwid is not null order by rand() limit 4000'
