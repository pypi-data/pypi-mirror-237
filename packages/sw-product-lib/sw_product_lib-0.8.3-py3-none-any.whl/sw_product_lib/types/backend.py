...
class BackendTypeInput(BaseModel):
    ...
    def model_dump(self, **kwargs):
        ...
        if "data" in dump and isinstance(dump.get("data"), dict):
            dump["data"] = json.dumps(dump.get("data"))
        return dump
...
class Backend(BackendBase):
    ...
    def from_dict(cls, res: dict):
        if "data" in res and isinstance(res.get("data"), str):
            res["data"] = json.loads(res.get("data"))
        return cls(**res)
