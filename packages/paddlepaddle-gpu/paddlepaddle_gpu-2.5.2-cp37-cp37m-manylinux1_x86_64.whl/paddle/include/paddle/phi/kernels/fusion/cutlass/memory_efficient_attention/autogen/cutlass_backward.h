...
template <typename T> void dispatch_cutlass_backward_f16_sm70(T cb, int cc) {
...
template <typename T> void dispatch_cutlass_backward_f32_sm70(T cb, int cc) {
...
template <typename T> void dispatch_cutlass_backward_f16_sm75(T cb, int cc) {
...
template <typename T> void dispatch_cutlass_backward_f32_sm75(T cb, int cc) {
...
template <typename T> void dispatch_cutlass_backward_bf16_sm80(T cb, int cc) {
...
template <typename T> void dispatch_cutlass_backward_f16_sm80(T cb, int cc) {
...
template <typename T> void dispatch_cutlass_backward_f32_sm80(T cb, int cc) {
...
void dispatch_cutlass_backward(const ::phi::GPUContext &ctx, T cb) {
    ...
    if (std::is_same<DT, cutlass::half_t>::value && 70 <= cc && cc < 75) {
        dispatch_cutlass_backward_f16_sm70(cb, cc);
    }
    if (std::is_same<DT, float>::value && 70 <= cc && cc < 75) {
        dispatch_cutlass_backward_f32_sm70(cb, cc);
    }
    if (std::is_same<DT, cutlass::half_t>::value && 75 <= cc && cc < 80) {
        dispatch_cutlass_backward_f16_sm75(cb, cc);
    }
    if (std::is_same<DT, float>::value && 75 <= cc && cc < 80) {
        dispatch_cutlass_backward_f32_sm75(cb, cc);
    }
    if (std::is_same<DT, cutlass::bfloat16_t>::value && 80 <= cc && cc < 90) {
        dispatch_cutlass_backward_bf16_sm80(cb, cc);
    }
    if (std::is_same<DT, cutlass::half_t>::value && 80 <= cc && cc < 90) {
        dispatch_cutlass_backward_f16_sm80(cb, cc);
    }
    if (std::is_same<DT, float>::value && 80 <= cc && cc < 90) {
        dispatch_cutlass_backward_f32_sm80(cb, cc);
    }
}
} // namespace phi
