...
from kelvin.app import ControlChange, KelvinApp, Recommendation, filters
...
async def main() -> None:
    ...
    await app.connect()
    print("App and asset parameters available after connect", app.app_parameters, app.asset_parameters)
