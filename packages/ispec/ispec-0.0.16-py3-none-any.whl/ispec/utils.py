...
__all__ = ['key1st', 'idx1st', 'arg1st', 'getattrs', 'safemake', 'typenone', 'tryattrs', 'safegetspec', 'safegetsig',
           'dropna_args', 'dropcls_args', 'filterargvals', 'funkws', 'kwskws', 'kwsopt', 'kwsadd', 'kwsobj', 'objtype',
           'unpack_optout']
...
from atyp import AnyQ, CallQ, DictQ, TypeQ, IntQ, BoolQ, FlagFunc
...
def objtype(obj: AnyQ, **kwargs) -> TypeQ:
