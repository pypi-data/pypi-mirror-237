...
class PolyMeasure:
    ...
    @classmethod
    def op(cls, operator, column, name=None, include=None, where=None):
        """
        ...
        return cls(measure_name, f"{operator}({column})", include=include, where=where)

    @classmethod
    def size(cls, where=None):
        return cls.op('count', '*', 'size', where=where)
    ...
    @classmethod
    def count_all(cls, where=None):
        return cls.op('count', '*', 'size', where=where)

    @classmethod
    def count_nonnull(cls, column, where=None):
        return cls.op('count', column, where=where)

    @classmethod
    def sum(cls, column, where=None):
        return cls.op('sum', column, where=where)

    @classmethod
    def mean(cls, column, where=None):
        return cls.op('mean', column, where=where)

    @classmethod
    def var(cls, column, where=None):
        return cls.op('var_pop', column, where=where)

    @classmethod
    def min(cls, column, where=None):
        return cls.op('min', column, where=where)

    @classmethod
    def max(cls, column, where=None):
        return cls.op('max', column, where=where)
