...
class ChatConfig(object):
    ...
    def __init__(self, system_prompt='''Do your best to answer the questions.
Use any tools available to look up relevant information, only if necessary.''', moderation=None, tools=None, local_vars_configuration=None):  # noqa: E501
