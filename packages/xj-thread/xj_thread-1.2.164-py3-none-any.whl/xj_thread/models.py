...
class Thread(models.Model):
    ...
    thread_no = models.CharField(verbose_name='信息编号', max_length=128, blank=True, null=True, db_index=True,
    ...
    author = models.CharField(verbose_name='作者/主办者', max_length=128, blank=True, null=True,
                              help_text='')  # add-2022-05-20
    region_code = models.CharField(verbose_name='所属行政区划编码', max_length=12, blank=True, null=True,
    ...
    update_time = models.DateTimeField(verbose_name='更新时间', blank=True, null=True, auto_now=True,
                                       help_text='')  # 不显示，系统自动填。
    is_deleted = models.BooleanField(verbose_name='是否删除', blank=True, null=True, default=0)
    # 主表扩展字段
