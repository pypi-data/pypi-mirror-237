...
class EntityLoadPropertiesModel():
  def __init__(self, consolidation_mode, generate_delta_table, id_table_format, data_preview, has_encryption, null_text, re_create_table_on_deployment, pii_detection, pii_detection_language):
