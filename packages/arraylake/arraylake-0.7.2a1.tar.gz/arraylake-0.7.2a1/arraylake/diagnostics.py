...
def get_service_info(service_uri: Optional[str]) -> Dict[str, str]:
...
def get_config_info() -> Dict[str, str]:
    ...
    """
    info = {}
    for k in ["user.org", "chunkstore.hash_method", "log_level", "http_max_retries", "http_timeout", "max_commit_attempts"]:
...
def get_diagnostics(service_uri: Optional[str] = None) -> UserDiagnostics:
    ...
    if service_uri is not None:
        try:
            ...
            logger.error("failed to get service diagnostics")
