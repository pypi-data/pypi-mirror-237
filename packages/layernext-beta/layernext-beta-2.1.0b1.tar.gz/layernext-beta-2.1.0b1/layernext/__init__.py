...
class LayerNextClient:
    ...
    def auto_tag_collection(
        ...
        _automatic_analysis_client = automatic_analysis.AutomaticAnalysisClient(
            self.encoded_key_secret, self.layernext_url)
        _automatic_analysis_client.model_tag_collection(
            collection_id, model_id, input_resolution,confidence_threshold)
    ...
    def generate_auto_tags_to_metalake(
        ...
        _automatic_analysis_client = automatic_analysis.AutomaticAnalysisClient(
            self.encoded_key_secret, self.layernext_url)
        _automatic_analysis_client.model_tag_population(
            item_type, model_id, input_resolution, confidence_threshold)
    ...
    def auto_annotate_project(
        ...
        _automatic_analysis_client.model_annotate_collection(
            project_id, model_id, prompt, annotation_type, confidence_threshold)
