...
class ReverseAddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ReverseAddressGeocoder_f5a3fecd96bd_error",
        ...
        outputCol="ReverseAddressGeocoder_f5a3fecd96bd_output",
        pollingDelay=300,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.geospatial.ReverseAddressGeocoder", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(backoffs=[100,500,1000])
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="ReverseAddressGeocoder_f5a3fecd96bd_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="ReverseAddressGeocoder_f5a3fecd96bd_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.geospatial.ReverseAddressGeocoder"
