...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_e0be755ea973_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_e0be755ea973_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.geospatial.CheckPointInPolygon", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="CheckPointInPolygon_e0be755ea973_error")
        self._setDefault(outputCol="CheckPointInPolygon_e0be755ea973_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.geospatial.CheckPointInPolygon"
