...
class _BingImageSearch(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        count=None,
        countCol=None,
        errorCol="BingImageSearch_7b0127811426_error",
        freshness=None,
        freshnessCol=None,
        handler=None,
        height=None,
        ...
        offset=None,
        offsetCol=None,
        outputCol="BingImageSearch_7b0127811426_output",
        q=None,
        qCol=None,
        size=None,
        sizeCol=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.bing.BingImageSearch", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="BingImageSearch_7b0127811426_error")
        self._setDefault(outputCol="BingImageSearch_7b0127811426_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.bing.BingImageSearch"
