...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Translate_2bcbdf168b28_error",
        fromLanguage=None,
        ...
        outputCol="Translate_2bcbdf168b28_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.translate.Translate", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="Translate_2bcbdf168b28_error")
        self._setDefault(outputCol="Translate_2bcbdf168b28_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.translate.Translate"
