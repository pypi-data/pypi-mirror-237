...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="FindSimilarFace_29359de78e99_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_29359de78e99_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_29359de78e99_error")
        self._setDefault(outputCol="FindSimilarFace_29359de78e99_output")
