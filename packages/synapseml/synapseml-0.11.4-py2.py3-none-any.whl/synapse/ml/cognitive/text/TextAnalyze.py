...
class TextAnalyze(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TextAnalyze_f875f8d8fcb9_error",
        ...
        outputCol="TextAnalyze_f875f8d8fcb9_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.text.TextAnalyze", self.uid)
        else:
        ...
        self._setDefault(errorCol="TextAnalyze_f875f8d8fcb9_error")
        ...
        self._setDefault(outputCol="TextAnalyze_f875f8d8fcb9_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.text.TextAnalyze"
