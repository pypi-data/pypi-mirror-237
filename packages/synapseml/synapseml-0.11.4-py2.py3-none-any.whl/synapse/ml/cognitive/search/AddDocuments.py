...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AddDocuments_3e51d542d439_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_3e51d542d439_output",
        serviceName=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.search.AddDocuments", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(actionCol="@search.action")
        self._setDefault(batchSize=100)
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="AddDocuments_3e51d542d439_error")
        self._setDefault(outputCol="AddDocuments_3e51d542d439_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.search.AddDocuments"
