...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OpenAIEmbedding_8d0ba0b60939_error",
        handler=None,
        outputCol="OpenAIEmbedding_8d0ba0b60939_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.openai.OpenAIEmbedding", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="OpenAIEmbedding_8d0ba0b60939_error")
        self._setDefault(outputCol="OpenAIEmbedding_8d0ba0b60939_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.openai.OpenAIEmbedding"
