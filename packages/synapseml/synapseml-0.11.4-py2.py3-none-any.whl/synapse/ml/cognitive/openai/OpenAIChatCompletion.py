...
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_96193a057aa5_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_96193a057aa5_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.openai.OpenAIChatCompletion", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="OpenAIChatCompletion_96193a057aa5_error")
        self._setDefault(outputCol="OpenAIChatCompletion_96193a057aa5_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.openai.OpenAIChatCompletion"
