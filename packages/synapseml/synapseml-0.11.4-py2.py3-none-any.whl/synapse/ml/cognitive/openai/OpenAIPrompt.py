...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    dropPrompt = Param(Params._dummy(), "dropPrompt", "whether to drop the column of prompts after templating", typeConverter=TypeConverters.toBoolean)
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_78b1a9b5b0c7_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_78b1a9b5b0c7_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_78b1a9b5b0c7_error")
        self._setDefault(outputCol="OpenAIPrompt_78b1a9b5b0c7_output")
