...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_82a234aafe75_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_82a234aafe75_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.form.ListCustomModels", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="ListCustomModels_82a234aafe75_error")
        self._setDefault(outputCol="ListCustomModels_82a234aafe75_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.form.ListCustomModels"
