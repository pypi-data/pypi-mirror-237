...
from synapse.ml.cognitive.anomaly.SimpleDetectMultivariateAnomaly import SimpleDetectMultivariateAnomaly
...
class SimpleFitMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    ...
    def __init__(
        ...
        displayName=None,
        endTime=None,
        errorCol="SimpleFitMultivariateAnomaly_d7e8f5cb134e_error",
        fillNAMethod="Linear",
        initialPollingDelay=300,
        inputCols=None,
        intermediateSaveDir=None,
        maxPollingRetries=1000,
        outputCol="SimpleFitMultivariateAnomaly_d7e8f5cb134e_output",
        paddingValue=None,
        pollingDelay=300,
        slidingWindow=300,
        startTime=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.anomaly.SimpleFitMultivariateAnomaly", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(alignMode="Outer")
        self._setDefault(backoffs=[100,500,1000])
        self._setDefault(errorCol="SimpleFitMultivariateAnomaly_d7e8f5cb134e_error")
        self._setDefault(fillNAMethod="Linear")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="SimpleFitMultivariateAnomaly_d7e8f5cb134e_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.anomaly.SimpleFitMultivariateAnomaly"
