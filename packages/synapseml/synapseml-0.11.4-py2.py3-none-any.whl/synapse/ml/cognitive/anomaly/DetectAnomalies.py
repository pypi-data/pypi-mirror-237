...
class DetectAnomalies(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DetectAnomalies_8d9265915502_error",
        granularity=None,
        granularityCol=None,
        handler=None,
        ...
        outputCol="DetectAnomalies_8d9265915502_output",
        period=None,
        periodCol=None,
        sensitivity=None,
        sensitivityCol=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.anomaly.DetectAnomalies", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="DetectAnomalies_8d9265915502_error")
        self._setDefault(outputCol="DetectAnomalies_8d9265915502_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.anomaly.DetectAnomalies"
