...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_282b6b9a8708_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_282b6b9a8708_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.cognitive.vision.AnalyzeImage", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="AnalyzeImage_282b6b9a8708_error")
        self._setDefault(outputCol="AnalyzeImage_282b6b9a8708_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.cognitive.vision.AnalyzeImage"
