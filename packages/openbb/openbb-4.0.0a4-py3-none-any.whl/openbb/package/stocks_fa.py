...
"""  # noqa: E501
    ...
    @validate
    def cash(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: typing_extensions.Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Time period of the data to return.')] = 'annual', limit: typing_extensions.Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 12, provider: Union[Literal['fmp', 'intrinio', 'polygon', 'yfinance'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def cash_growth(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], limit: typing_extensions.Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 10, provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def comp(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def comsplit(self, start_date: typing_extensions.Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: typing_extensions.Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def divs(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def emp(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def income(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: typing_extensions.Annotated[Literal['annual', 'quarter'], OpenBBCustomParameter(description='Time period of the data to return.')] = 'annual', limit: typing_extensions.Annotated[int, OpenBBCustomParameter(description='The number of data entries to return.')] = 12, provider: Union[Literal['fmp', 'intrinio', 'polygon', 'yfinance'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"symbol": ",".join(symbol) if isinstance(symbol, list) else symbol, "transactionType": transactionType, "page": page, },
            extra_params=kwargs,
        )
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"symbol": ",".join(symbol) if isinstance(symbol, list) else symbol, "include_current_quarter": include_current_quarter, "date": date, },
            extra_params=kwargs,
        )
...
"""  # noqa: E501
    ...
    @validate
    def mgmt(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def overview(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[Data]:
...
"""  # noqa: E501
    ...
    @validate
    def pt(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[Data]:
...
"""  # noqa: E501
    ...
    @validate
    def pta(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def revseg(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], period: typing_extensions.Annotated[Literal['quarter', 'annual'], OpenBBCustomParameter(description='Time period of the data to return.')] = 'annual', structure: typing_extensions.Annotated[Literal['hierarchical', 'flat'], OpenBBCustomParameter(description='Structure of the returned data.')] = 'flat', provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def shrs(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def split(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"symbol": ",".join(symbol) if isinstance(symbol, list) else symbol, "year": year, "quarter": quarter, },
            extra_params=kwargs,
        )
