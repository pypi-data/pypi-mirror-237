...
sp500_multiples
    ...
    @validate
    def available_indices(self, provider: Union[Literal['cboe', 'fmp', 'yfinance'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def const(self, index: typing_extensions.Annotated[Literal['nasdaq', 'sp500', 'dowjones'], OpenBBCustomParameter(description='Index for which we want to fetch the constituents.')] = 'dowjones', provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def cot(self, provider: Union[Literal['quandl'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def cot_search(self, query: typing_extensions.Annotated[str, OpenBBCustomParameter(description='Search query.')] = '', provider: Union[Literal['quandl'], None] = None, **kwargs) -> OBBject[List[Data]]:
        """
...
"""  # noqa: E501
    ...
    @validate
    def econcal(self, start_date: typing_extensions.Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='Start date of the data, in YYYY-MM-DD format.')] = None, end_date: typing_extensions.Annotated[Union[datetime.date, None, str], OpenBBCustomParameter(description='End date of the data, in YYYY-MM-DD format.')] = None, importance: typing_extensions.Annotated[Literal['Low', 'Medium', 'High'], OpenBBCustomParameter(description='Importance of the event.')] = None, group: typing_extensions.Annotated[Literal['interest rate', 'inflation', 'bonds', 'consumer', 'gdp', 'government', 'housing', 'labour', 'markets', 'money', 'prices', 'trade', 'business'], OpenBBCustomParameter(description='Grouping of events')] = None, country: typing_extensions.Annotated[Union[List[str], str, None], OpenBBCustomParameter(description='Country of the event')] = None, provider: Union[Literal['tradingeconomics'], None] = None, **kwargs) -> OBBject[List[Data]]:
        """GDP Data.
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"start_date": start_date, "end_date": end_date, "importance": importance, "group": group, "country": country, },
            extra_params=kwargs,
        )
...
"""  # noqa: E501
    ...
    @validate
    def european_index_constituents(self, symbol: typing_extensions.Annotated[Union[str, List[str]], OpenBBCustomParameter(description='Symbol to get data for.')], provider: Union[Literal['cboe'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def index_search(self, query: typing_extensions.Annotated[str, OpenBBCustomParameter(description='Search query.')] = '', is_symbol: typing_extensions.Annotated[bool, OpenBBCustomParameter(description='Whether to search by ticker symbol.')] = False, provider: Union[Literal['cboe'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def index_snapshots(self, region: typing_extensions.Annotated[Union[Literal['US', 'EU'], None], OpenBBCustomParameter(description='The region to return. Currently supports US and EU.')] = 'US', provider: Union[Literal['cboe'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
    ...
    @validate
    def risk(self, provider: Union[Literal['fmp'], None] = None, **kwargs) -> OBBject[List[Data]]:
...
"""  # noqa: E501
        ...
        inputs = filter_inputs(
            provider_choices={"provider": provider, },
            standard_params={"series_name": series_name, "start_date": start_date, "end_date": end_date, "collapse": collapse, "transform": transform, },
            extra_params=kwargs,
        )
