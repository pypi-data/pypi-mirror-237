...
def get_version(dist: str = "docstrings2pep727") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["docstrings2pep727"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("DOCSTRINGS2PEP727")]]
    return Environment(
